    ...
    internal class Program : ContentIntegrationTest
    {
        ...
        private int Run()
        {
            ...
            foreach (var (file, errorHashset) in errors)
            {
                ...
                {
                    Console.WriteLine($"::error file=Resources/{file},line={errorNode.Node.Start.Line},col={errorNode.Node.Start.Column}::{file}({errorNode.Node.Start.Line},{errorNode.Node.Start.Column})  {errorNode.ErrorReason}");
                }
            }
