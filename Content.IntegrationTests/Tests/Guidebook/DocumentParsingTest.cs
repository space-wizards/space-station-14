...
<TestControl >
  <TestControl  k=""<\>\\>=\""=<-_?*3.0//"">
    ...
    [Test]
    [Description($"Checks that an example document string properly gets parsed by the {nameof(DocumentParsingManager)}.")]
