    ...
    public class DestructibleDamageTypeTest : ContentIntegrationTest
    {
        ...
        public async Task Test()
        {
            ...
            await server.WaitAssertion(() =>
            {
                ...
                sEntityManager.EventBus.RaiseLocalEvent(sDestructibleEntity.Uid, new TryChangeDamageEvent(slashDamage * 2, true), false);
                ...
                sEntityManager.EventBus.RaiseLocalEvent(sDestructibleEntity.Uid, new TryChangeDamageEvent(bluntDamage * 2, true), false);
                ...
                sEntityManager.EventBus.RaiseLocalEvent(sDestructibleEntity.Uid, new TryChangeDamageEvent(bluntDamage * -4, true), false);
                ...
                sEntityManager.EventBus.RaiseLocalEvent(sDestructibleEntity.Uid, new TryChangeDamageEvent(bluntDamage * -2, true), false);
                sEntityManager.EventBus.RaiseLocalEvent(sDestructibleEntity.Uid, new TryChangeDamageEvent(slashDamage * -4, true), false);
