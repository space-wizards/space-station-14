...
public sealed class RetractableItemActionTest : InteractionTest
{
    ...
    public async Task ArmBladeActivateDeactivateTest()
    {
        ...
        await Server.WaitAssertion(() =>
        {
            ...
            var heldItem = handsSystem.GetActiveItem((SPlayer, Hands));
            ...
            var actionUid = actionsSystem.AddAction(SPlayer, ArmBladeActionProtoId);
            ...
            heldItem = handsSystem.GetActiveItem((SPlayer, Hands));
            ...
            actionsSystem.PerformAction(SPlayer, actionEnt!.Value);
