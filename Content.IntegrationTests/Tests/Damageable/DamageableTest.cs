...
namespace Content.IntegrationTests.Tests.Damageable
{
    ...
    {
        private const string FullyDamageableEntityId = "TestFullyDamageableEntityId";
        ...
        /// <summary>
        ///     Test Standard Damageable Components
        /// </summary>
        /// <remarks>
        ///     Only test scenarios where each damage type is a member of exactly one group, and all damageable components support whole groups.
        /// </remarks>
        [Test]
...
"
            ...
            await server.WaitPost(() =>
            {
                ...
                // Make sure we load the allDamage = true container after loading all other damage types. There is
                // probably a way to just stop loading the normal damage.yml but I don't how to do that, and this works
...
# create entities
- type: entity
  id: {FullyDamageableEntityId}
  name: {FullyDamageableEntityId}
  components:
  - type: Damageable
    damageContainer: testAllDamageContainer
");

                sFullyDamageableEntity = sEntityManager.SpawnEntity(FullyDamageableEntityId, coordinates);
            ...
            {
                // Test that the all damage container works supports everything
                ...
                // Check that the correct groups are supported for the other container
