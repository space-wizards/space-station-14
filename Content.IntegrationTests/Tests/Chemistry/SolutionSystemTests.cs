...
";
    ...
    public async Task TryMixAndOverflowTooMuchReagent()
    {
        ...
        await server.WaitAssertion((System.Action)(() =>
        {
            ...
            Assert.That((FixedPoint2) solution.CurrentVolume, Is.EqualTo(FixedPoint2.New(threshold)));
            ...
            Assert.That((FixedPoint2) overflowingSolution.CurrentVolume, Is.EqualTo(FixedPoint2.New(80)));
