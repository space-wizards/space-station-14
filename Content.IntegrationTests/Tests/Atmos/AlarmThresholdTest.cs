...
{
    [SidedDependency(Side.Server)] private readonly IPrototypeManager _prototypeManager = default!;
...
";
    ...
    {
        var proto = _prototypeManager.Index<AtmosAlarmThresholdPrototype>(AlarmThresholdTestDummyId);
        var threshold = new AtmosAlarmThreshold(proto);
