...
public sealed partial class CrewMonitoringWindow : FancyWindow
{
    ...
    public void ShowSensors(List<SuitSensorStatus> sensors, EntityUid monitor, EntityCoordinates? monitorCoords)
    {
        ...
        var alertsSensors = orderedSensors.Where(d => d.IsAlive != true || (d.DamagePercentage != null && d.DamagePercentage.Value > 0.625));
        if (alertsSensors != null && alertsSensors.Any())
        {
            ...
            PopulateSensorList(alertsSensors);
        }
        ...
        foreach (var department in departments)
        {
            ...
            PopulateSensorList(departmentSensors);
        }
        ...
        if (remainingSensors.Any())
        {
            ...
            PopulateSensorList(remainingSensors);
        }
    ...
    private void PopulateSensorList(IEnumerable<SuitSensorStatus> sensors)
    {
        ...
        foreach (var sensor in sensors)
        {
            ...
            if (!sensor.IsAlive)
                blipColor = Color.DarkRed;
            else if (sensor.DamagePercentage != null)
            {
                if (sensor.DamagePercentage.Value >= 1.0)
                    blipColor = new Color(255, 32, 32, 255);
                
                else if (sensor.DamagePercentage.Value >= 0.625)
            ...
            if (coordinates != null && NavMap.Visible && _blipTexture != null)
            {
                NavMap.TrackedEntities.TryAdd(sensor.SuitSensorUid,
                    ...
                    _blipTexture,
                    (_trackedEntity == null || sensor.SuitSensorUid == _trackedEntity) ? sensorButton.BlipColor : sensorButton.BlipColor * Color.DimGray,
        ...
        foreach (var sensor in SensorsTable.Children)
        {
            ...
            if (NavMap.TrackedEntities.TryGetValue(castSensor.SuitSensorUid, out var data))
            {
                data = new NavMapBlip
                    ...
                    data.Texture,
                    (currTrackedEntity == null || castSensor.SuitSensorUid == currTrackedEntity) ? castSensor.BlipColor : castSensor.BlipColor * Color.DimGray,
