...
{
    [UsedImplicitly]
    public sealed class StrippableClientBoundUserInterface : ClientBoundUserInterface
    {
        ...
        public StrippableClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
