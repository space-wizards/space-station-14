...
{
    [UsedImplicitly]
    public sealed class NewsWriteClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public NewsWriteClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
