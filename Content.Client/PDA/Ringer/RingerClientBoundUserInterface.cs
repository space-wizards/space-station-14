...
{
    [UsedImplicitly]
    public sealed class RingerClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private RingtoneMenu? _menu;

        public RingerClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
