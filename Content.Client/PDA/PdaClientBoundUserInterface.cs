...
{
    [UsedImplicitly]
    public sealed class PdaClientBoundUserInterface : CartridgeLoaderClientBoundUserInterface
    {
        [ViewVariables]
        private PdaMenu? _menu;

        public PdaClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
