...
{
    public sealed class CommunicationsConsoleClientBoundUserInterface : ClientBoundUserInterface
    {
        ...
        public CommunicationsConsoleClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
