...
namespace Content.Client.Communications.UI
{
    ...
    public sealed partial class CommunicationsConsoleMenu : BaseWindow
    {
        ...
        public CommunicationsConsoleMenu()
        {
            ...
            RadioMessageInput.OnTextChanged += (args) =>
            {
            ...
            AnnounceButton.OnPressed += _ => OnAnnounce?.Invoke(Rope.Collapse(RadioMessageInput.TextRope));
            AnnounceButton.Disabled = !CanAnnounce;
            ...
            ScreenMessageInput.OnTextChanged += args =>
            {
                ...
                {
                    _appearanceSystem.SetData(_broadcastDisplayEntity, TextScreenVisuals.ScreenText, args.Text);
                }
            };

            BroadcastButton.OnPressed += _ => OnBroadcast?.Invoke(ScreenMessageInput.Text);
