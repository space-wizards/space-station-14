...
{
    public sealed class ForensicScannerClientBoundUserInterface : ClientBoundUserInterface
    {
        ...
        public ForensicScannerClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
