...
namespace Content.Client.Disposal.UI
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class DisposalUnitClientBoundUserInterface : ClientBoundUserInterface
    {
        ...
        public DisposalUnitClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
