...
namespace Content.Client.Disposal.UI
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class DisposalTaggerClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private DisposalTaggerWindow? _window;

        public DisposalTaggerClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
