...
namespace Content.Client.Disposal.UI
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class DisposalRouterClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private DisposalRouterWindow? _window;

        public DisposalRouterClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
