...
namespace Content.Client.Construction.UI
{
    ...
    public interface IConstructionMenuView : IDisposable
    {
        ...
        void SetRecipeInfo(ConstructionPrototype prototype);
        void ResetPlacement();
    ...
    public sealed partial class ConstructionMenu : DefaultWindow, IConstructionMenuView
    {
        ...
        public void SetRecipeInfo(ConstructionPrototype prototype)
        {
            BuildButton.Disabled = false;
            BuildButton.Text = Loc.GetString(prototype.Type != ConstructionType.Item ? "construction-menu-place-ghost" : "construction-menu-craft");
            TargetName.SetMessage(prototype.Name);
            TargetDesc.SetMessage(prototype.Description);
            TargetTexture.Texture = _spriteSystem?.Frame0(prototype.Icon);
        }
