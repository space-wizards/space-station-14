...
{
    [UsedImplicitly]
    public sealed class GravityGeneratorClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private GravityGeneratorWindow? _window;

        public GravityGeneratorClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
