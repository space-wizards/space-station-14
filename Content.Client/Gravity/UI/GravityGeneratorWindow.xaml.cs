...
namespace Content.Client.Gravity.UI
{
    ...
    public sealed partial class GravityGeneratorWindow : FancyWindow
    {
        ...
        public void UpdateState(SharedGravityGeneratorComponent.GeneratorState state)
        {
            ...
            {
                GravityGeneratorPowerStatus.Off => "negative",
                GravityGeneratorPowerStatus.Discharging => "highlight",
                GravityGeneratorPowerStatus.Charging => "highlight",
                GravityGeneratorPowerStatus.FullyCharged => "positive",
                _ => throw new ArgumentOutOfRangeException()
            });
            ...
            EtaLabel.SetOnlyStyleClass(state.EtaSeconds >= 0 ? StyleClass.Highlight : StyleClass.LabelWeak);
        }
    }
}
