...
[UsedImplicitly]
public sealed class AnomalyScannerClientBoundUserInterface : ClientBoundUserInterface
{
    private AnomalyScannerMenu? _menu;

    public AnomalyScannerClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
