...
namespace Content.Client.Labels.UI
{
    ...
    /// </summary>
    public sealed class HandLabelerClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private HandLabelerWindow? _window;

        public HandLabelerClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
