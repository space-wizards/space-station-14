...
{
    [UsedImplicitly]
    public sealed class StorageClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public StorageClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
