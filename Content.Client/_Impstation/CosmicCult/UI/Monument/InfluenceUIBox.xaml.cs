    ...
    public InfluenceUIBox(InfluencePrototype influenceProto, InfluenceUIBoxState state, MonumentBuiState monumentState)
    {
        ...
        switch (state)
        {
            ...
            case InfluenceUIBoxState.UnlockedAndNotEnoughEntropy:
                ...
                GainButton.ToolTip = Loc.GetString("monument-interface-influences-unlocked-not-enough-entropy-tooltip", ("entropy", influenceProto.Cost - monumentState.AvailableEntropy));
                break;
