...
public sealed partial class SeparatedChatGameScreen : InGameScreen
{
    public SeparatedChatGameScreen()
    {
        ...
        // This just means we don't need 2 entirely separate top bar classes and can just override this for separated view.
        TopBar.GridCont.Rows = 2;
        TopBar.EscapeButton.RemoveStyleClass(StyleBase.ButtonOpenRight);
        TopBar.EscapeButton.AddStyleClass("ButtonSquare");

        TopBar.AHelpButton.RemoveStyleClass(StyleBase.ButtonOpenLeft);
        TopBar.AHelpButton.AddStyleClass("ButtonSquare");
