...
{
    [UsedImplicitly]
    public sealed class GasTankClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private GasTankWindow? _window;

        public GasTankClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
