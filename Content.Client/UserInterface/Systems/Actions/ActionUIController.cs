...
public sealed class ActionUIController : UIController, IOnStateChanged<GameplayState>, IOnSystemChanged<ActionsSystem>
{
    ...
    [UISystemDependency] private readonly ActionChargesSystem _charges = default!;
    ...
    private bool TargetingOnUse(in PointerInputCmdArgs args)
    {
        ...
        if (!action.Enabled
            || (_charges.GetCurrentCharges(actionId) == 0
            && !EntityManager.HasComponent<ResetActionChargesComponent>(actionId))
