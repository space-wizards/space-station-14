...
namespace Content.Client.UserInterface.AdminMenu
{
    public class AdminMenuWindow : SS14Window
    {
        ...
        private class DirectCommandButton : CommandButton
        {
            ...
            public override void ButtonPressed(ButtonEventArgs args)
            {
                IoCManager.Resolve<IClientConsoleHost>().ProcessCommand(RequiredCommand);
            }
        }
        #endregion
        ...
        private class StationEventsCommandButton : UICommandButton
        {
            ...
            public override List<CommandUIControl> UI => new()
            {
                ...
                new CommandUIButton
                {
                    ...
                    Handler = () =>
                    {
                        IoCManager.Resolve<IClientConsoleHost>().ProcessCommand("events pause");
                    },
                },
                new CommandUIButton
                {
                    ...
                    Handler = () =>
                    {
                        IoCManager.Resolve<IClientConsoleHost>().ProcessCommand("events resume");
                    },
                },
            };
            ...
            {
                IoCManager.Resolve<IClientConsoleHost>().ProcessCommand($"events run \"{_eventsDropDown.GetValue()}\"");
            }
        }
        ...
        private class KickCommandButton : UICommandButton
        {
            ...
            public override void Submit()
            {
                IoCManager.Resolve<IClientConsoleHost>().ProcessCommand($"kick \"{_playerDropDown.GetValue()}\" \"{CommandParsing.Escape(_reason.GetValue())}\"");
            }
        }
        ...
        private class TeleportCommandButton : UICommandButton
        {
            ...
            public override void Submit()
            {
                IoCManager.Resolve<IClientConsoleHost>().ProcessCommand($"tpto \"{_playerDropDown.GetValue()}\"");
            }
        }
        ...
        private class AddAtmosCommandButton : UICommandButton
        {
            ...
            public override void Submit()
            {
                IoCManager.Resolve<IClientConsoleHost>().ProcessCommand($"addatmos {_grid.GetValue()}");
            }
        }
        ...
        private class FillGasCommandButton : UICommandButton
        {
            ...
            public override void Submit()
            {
                IoCManager.Resolve<IClientConsoleHost>().ProcessCommand($"fillgas {_grid.GetValue()} {_gas.GetValue()} {_amount.GetValue()}");
            }
        }
        #endregion
