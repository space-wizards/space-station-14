...
namespace Content.Client.UserInterface.AdminMenu.Tabs
{
    ...
    public partial class TicketTab : Control
    {
        ...
        [Dependency] private readonly IPlayerManager _playManager = default!;
        ...
        public void RefreshTicketList(IEnumerable<AdminMenuTicketListMessage.TicketInfo> tickets)
        {
            ...
            foreach (var ticket in tickets)
            {
                ...
                if (ticket.Status == TicketStatus.Claimed && !string.IsNullOrEmpty(ticket.Admin) &&
                    ticket.Admin == _playManager.LocalPlayer?.UserId.ToString())
                {
                    statusLabel.SetMessage("Active");
                }
                else
                {
