...
namespace Content.Client.UserInterface.AdminMenu
{
    ...
    public partial class AdminMenuWindow : SS14Window
    {
        ...
        public event TicketTab.TicketListRefresh? OnTicketListRefresh
        {
            add => TicketTabControl.OnTicketListRefresh += value;
            remove => TicketTabControl.OnTicketListRefresh -= value;
        }
        ...
        public AdminMenuWindow()
        {
            ...
            MasterTabContainer.SetTabTitle(6, Loc.GetString("Tickets"));
        }
        ...
        {
            TicketTabControl.RefreshTicketList(tickets);
        }
    }
}
