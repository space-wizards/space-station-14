...
{
    public sealed class WiresClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private WiresMenu? _menu;

        public WiresClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
