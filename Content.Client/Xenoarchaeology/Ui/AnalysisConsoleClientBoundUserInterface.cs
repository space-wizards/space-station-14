...
[UsedImplicitly]
public sealed class AnalysisConsoleClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private AnalysisConsoleMenu? _consoleMenu;

    public AnalysisConsoleClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
