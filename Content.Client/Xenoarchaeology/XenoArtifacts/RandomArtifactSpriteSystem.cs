...
public sealed class RandomArtifactSpriteSystem : VisualizerSystem<RandomArtifactSpriteComponent>
{
    protected override void OnAppearanceChange(EntityUid uid, RandomArtifactSpriteComponent component, ref AppearanceChangeEvent args)
    {
        ...
        if (args.Sprite.LayerMapTryGet(SharedArtifactsVisualLayers.Effect, out var layer))
        {
            var spriteState = "ano" + spriteIndexStr + "_on";
        ...
        else
        {
            ...
            args.Sprite.LayerSetState(SharedArtifactsVisualLayers.Base, spriteState);
        }

    }
}

public enum SharedArtifactsVisualLayers
{
    Base,
