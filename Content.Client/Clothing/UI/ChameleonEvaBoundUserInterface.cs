...
[UsedImplicitly]
public sealed class ChameleonEvaBoundUserInterface : BoundUserInterface
{
    ...
    public ChameleonEvaBoundUserInterface(ClientUserInterfaceComponent owner, Enum uiKey) : base(owner, uiKey)
    {
    ...
    protected override void UpdateState(BoundUserInterfaceState state)
    {
        ...
        if (state is not ChameleonEvaBoundUserInterfaceState st)
            return;

        var targets = _chameleon.GetValidEVATargets(st.Slot);
