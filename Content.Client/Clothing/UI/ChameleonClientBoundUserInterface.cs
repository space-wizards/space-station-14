...
[UsedImplicitly]
public sealed class ChameleonClientBoundUserInterface : ClientBoundUserInterface
{
    ...
    public ChameleonClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
