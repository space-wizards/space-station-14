...
namespace Content.Client.Chemistry.UI
{
    ...
    public sealed partial class ChemMasterWindow : FancyWindow
    {
        ...
        private ReagentButton MakeReagentButton(string text, ChemMasterReagentAmount amount,
            ReagentDef id, bool isBuffer, string styleClass)
        {
                ...
                BufferInfo.Children.Add(new BoxContainer
                    {
                        ...
                        Children =
                        {
                            ...
                            MakeReagentButton("1",
                                ChemMasterReagentAmount.U1,
                                reagent,
                                true,
                                StyleBase.ButtonOpenRight),
                            MakeReagentButton("5", ChemMasterReagentAmount.U5, reagent, true, StyleBase.ButtonOpenBoth),
                            MakeReagentButton("10",
                                ChemMasterReagentAmount.U10,
                                reagent,
                                true,
                                StyleBase.ButtonOpenBoth),
                            MakeReagentButton("25",
                                ChemMasterReagentAmount.U25,
                                reagent,
                                true,
                                StyleBase.ButtonOpenBoth),
                            MakeReagentButton("50",
                                ChemMasterReagentAmount.U50,
                                reagent,
                                true,
                                StyleBase.ButtonOpenBoth),
                            MakeReagentButton("100",
                                ChemMasterReagentAmount.U100,
                                reagent,
                                true,
                                StyleBase.ButtonOpenBoth),
                            MakeReagentButton(Loc.GetString("chem-master-window-buffer-all-amount"),
        ...
        private void BuildContainerUI(Control control, ContainerInfo? info, bool addReagentButtons)
        {
            ...
            else
            {
                ...
                IEnumerable<(string Name, ReagentDef Reagent, FixedPoint2 Quantity)> contents;
    ...
    public sealed class ReagentButton : Button
    {
        ...
        public ReagentDef Reagent { get; set; }
        public ReagentButton(string text, ChemMasterReagentAmount amount, ReagentDef reagent, bool isBuffer, string styleClass)
        {
