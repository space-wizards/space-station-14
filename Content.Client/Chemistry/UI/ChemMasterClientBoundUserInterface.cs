...
namespace Content.Client.Chemistry.UI
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class ChemMasterClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private ChemMasterWindow? _window;

        public ChemMasterClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
