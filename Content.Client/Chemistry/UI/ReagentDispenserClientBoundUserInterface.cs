...
namespace Content.Client.Chemistry.UI
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class ReagentDispenserClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public ReagentDispenserClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
