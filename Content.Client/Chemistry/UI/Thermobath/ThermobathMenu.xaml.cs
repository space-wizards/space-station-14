...
public sealed partial class ThermobathMenu : FancyWindow
{
    ...
    public event Action<ThermobathMode>? OnModeChanged;
    ...
    public ThermobathMenu()
    {
        ...
        ModeSlider.OnValueChanged += value => OnModeChanged?.Invoke((ThermobathMode) value.Value);
    ...
    public void SetMode(ThermobathMode mode)
    {
