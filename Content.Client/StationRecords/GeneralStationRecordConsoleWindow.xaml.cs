...
public sealed partial class GeneralStationRecordConsoleWindow : DefaultWindow
{
    ...
    public Action<BaseButton.ButtonEventArgs>? OnArrestButtonPressed;
    ...
    public GeneralStationRecordConsoleWindow()
    {
        ...
        butt.OnPressed += e => OnArrestButtonPressed?.Invoke(e);
    }
    ...
    public void UpdateState(GeneralStationRecordConsoleState state)
    {
        ...
        // lineee.Visible = state.SelectedKey != null;
        // osion.Visible = state.SelectedKey != null;
        // butt.Visible = state.SelectedKey != null;
        // lowwdivvv.Visible = state.SelectedKey != null;
        Arrest.Visible = state.SelectedKey != null;
