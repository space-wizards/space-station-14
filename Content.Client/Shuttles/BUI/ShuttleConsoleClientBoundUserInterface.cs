...
[UsedImplicitly]
public sealed class ShuttleConsoleClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private ShuttleConsoleWindow? _window;

    public ShuttleConsoleClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
