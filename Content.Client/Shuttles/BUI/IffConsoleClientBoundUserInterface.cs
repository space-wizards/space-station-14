...
[UsedImplicitly]
public sealed class IffConsoleClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private IFFConsoleWindow? _window;

    public IffConsoleClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
