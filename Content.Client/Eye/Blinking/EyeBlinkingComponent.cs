...
/// <summary>
/// A client component that manages eyelid states (e.g., when they need to be opened, closed, etc.).
/// Attached to an entity after the <see cref="EyeBlinkingComponent"/> component is initialized.
/// </summary>
