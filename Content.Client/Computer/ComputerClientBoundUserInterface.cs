...
namespace Content.Client.Computer
{
    ...
    /// </summary>
    [Virtual]
    public class ComputerClientBoundUserInterface<TWindow, TState> : ComputerClientBoundUserInterfaceBase where TWindow : BaseWindow, IComputerWindow<TState>, new() where TState : BoundUserInterfaceState
    {
        ...
        public ComputerClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
    ...
    /// </summary>
    [Virtual]
    public class ComputerClientBoundUserInterfaceBase : ClientBoundUserInterface
    {
        public ComputerClientBoundUserInterfaceBase(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
    ...
    {
        void SetupComputerWindow(ComputerClientBoundUserInterfaceBase cb)
        {
        }
