...
internal sealed class BuckleSystem : SharedBuckleSystem
{
    ...
    {
        if (!AppearanceSystem.TryGetData(uid, StrapVisuals.RotationAngle, out var angle, args.Component) ||
            !AppearanceSystem.TryGetData(uid, BuckleVisuals.Buckled, out var buckled, args.Component) ||
            args.Sprite == null)
        {
            return;
        }
        ...
        EntityManager.System<RotationVisualizerSystem>()
            .AnimateSpriteRotation(args.Sprite, Angle.FromDegrees((int) angle), 0.125f);
    }
}
