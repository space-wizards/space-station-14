...
using Serilog;
using static Content.Shared._EinsteinEngine.Language.Systems.SharedLanguageSystem;
...
public sealed partial class LanguageMenuWindow : DefaultWindow
{
    ...
    public void UpdateState(string currentLanguage, List<string> spokenLanguages)
    {
        ...
        //These errors are fine i do not know why it is erroring but it runs fine???? It's ok
