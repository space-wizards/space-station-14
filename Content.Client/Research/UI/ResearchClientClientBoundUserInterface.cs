...
{
    public sealed class ResearchClientClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private ResearchClientServerSelectionMenu? _menu;

        public ResearchClientClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
