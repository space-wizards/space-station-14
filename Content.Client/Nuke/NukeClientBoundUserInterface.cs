...
{
    [UsedImplicitly]
    public sealed class NukeClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private NukeMenu? _menu;

        public NukeClientBoundUserInterface([NotNull] EntityUid owner, [NotNull] Enum uiKey) : base(owner, uiKey)
        {
        }
