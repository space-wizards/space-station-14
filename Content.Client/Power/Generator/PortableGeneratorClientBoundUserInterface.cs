...
[UsedImplicitly]
public sealed class PortableGeneratorClientBoundUserInterface : ClientBoundUserInterface
{
    private GeneratorWindow? _window;

    public PortableGeneratorClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
