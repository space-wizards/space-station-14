...
public sealed partial class PowerMonitoringWindow : FancyWindow, IComputerWindow<PowerMonitoringBoundInterfaceState>
{
    ...
    public void SetupComputerWindow(PowerMonitoringBoundUserInterface owner)
    {
