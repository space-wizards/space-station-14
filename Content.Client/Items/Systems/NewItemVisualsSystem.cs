...
public sealed class NewItemVisualsSystem : NewSharedItemSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<NewItemComponent, GetInhandVisualsEvent>(OnGetVisuals);
    }
    ...
    /// </summary>
    public override void VisualsChanged(EntityUid uid, NewItemComponent? item = null)
    {
    ...
    /// </summary>
    private void OnGetVisuals(EntityUid uid, NewItemComponent item, GetInhandVisualsEvent args)
    {
    ...
    /// </remarks>
    private bool TryGetDefaultVisuals(EntityUid uid, NewItemComponent item, string defaultKey, [NotNullWhen(true)] out List<PrototypeLayerData>? result)
    {
        result = null;
