...
public abstract class CartridgeLoaderClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    ...
    protected CartridgeLoaderClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
