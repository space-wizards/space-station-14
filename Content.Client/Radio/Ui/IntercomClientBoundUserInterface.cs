...
[UsedImplicitly]
public sealed class IntercomClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private IntercomMenu? _menu;

    public IntercomClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
