    ...
    public sealed partial class IdCardConsoleWindow : DefaultWindow
    {
            ...
            List<string> accessLevels)
        {
            ...
            foreach (var access in accessLevels)
            {
                ...
                {
                    Text = accessLevel.Value.Name,
                    ToggleMode = true,
                };
                AccessLevelGrid.AddChild(newButton);
                _accessButtons.Add(accessLevel.Value.ID, newButton);
        ...
        private void SelectJobPreset(OptionButton.ItemSelectedEventArgs args)
        {
            ...
            JobTitleLineEdit.Text = Loc.GetString(job.Value.Name);
            args.Button.SelectId(args.Id);

            ClearAllAccess();

            // this is a sussy way to do this
            foreach (var access in job.Value.Access)
            {
            ...
            foreach (var group in job.Value.AccessGroups)
            {
                ...
                foreach (var access in groupPrototype.Value.Tags)
                {
                    if (_accessButtons.TryGetValue(access, out var button))
                    {
                        button.Pressed = true;
