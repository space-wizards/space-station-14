...
namespace Content.Client.Access.UI
{
    ...
    public sealed partial class IdCardConsoleWindow : DefaultWindow
    {
        ...
        public void SetOwner(EntityUid owner)
        {
            ...
            Title = _entManager.GetComponent<MetaDataComponent>(_owner).EntityName;

            List<ProtoId<AccessLevelPrototype>> accessLevels;
            if (_entManager.TryGetComponent<IdCardConsoleComponent>(owner, out var idCard))
            {
            ...
            {
                accessLevels = new();
                Log.Error($"No IdCardConsole component found for {_entManager.ToPrettyString(_owner)}!");
            }
