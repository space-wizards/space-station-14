...
/// <summary>
/// All ID card data that can be changed through <see cref="IdCardConsoleWindow"/> .
/// </summary>
/// <param name="FullName">The full name of the card holder.</param>
/// <param name="JobTitle">The job title of the card holder.</param>
/// <param name="Accesses">The list of access levels this card provides.</param>
/// <param name="JobPrototype">The JobPrototype being assigned, or null if there is no change.</param>
public record struct IdCardData(
    string FullName,
    string JobTitle,
