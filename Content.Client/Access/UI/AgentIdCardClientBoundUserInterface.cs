...
namespace Content.Client.Access.UI
{
    ...
    /// </summary>
    public sealed class AgentIdCardClientBoundUserInterface : ClientBoundUserInterface
    {
        private AgentIDCardWindow? _window;

        public AgentIdCardClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
