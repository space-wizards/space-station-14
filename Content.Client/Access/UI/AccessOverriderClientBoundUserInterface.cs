...
{
    public sealed class AccessOverriderClientBoundUserInterface : ClientBoundUserInterface
    {
        ...
        public AccessOverriderClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
