...
{
    public sealed class IdCardConsoleClientBoundUserInterface : ClientBoundUserInterface
    {
        ...
        public IdCardConsoleClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
