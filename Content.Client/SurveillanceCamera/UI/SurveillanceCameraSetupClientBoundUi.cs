...
public sealed class SurveillanceCameraSetupClientBoundUi : ClientBoundUserInterface
{
    [ViewVariables]
    ...
    public SurveillanceCameraSetupClientBoundUi(EntityUid component, Enum uiKey) : base(component, uiKey)
    {
