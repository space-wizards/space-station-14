...
public sealed partial class SurveillanceCameraMonitorWindow : DefaultWindow
{
    ...
    public void UpdateState(IEye? eye, HashSet<(string Name, DeviceFrequency Frequency)> subnets, DeviceAddress activeAddress, DeviceAddress activeSubnet, Dictionary<DeviceAddress, string> cameras)
    {
    ...
    private int AddSubnet(string subnetName)
    {
        SubnetSelector.AddItem(subnetName);
        SubnetSelector.SetItemMetadata(SubnetSelector.ItemCount - 1, subnetName);
