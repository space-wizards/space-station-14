...
namespace Content.Client.GameObjects.Components.Weapons.Ranged
{
    /*
    [RegisterComponent]
    public class RangedWeaponAmmoCounterComponent : Component, IItemStatus
    {
        ...
        public override string Name => "RangedWeaponAmmoCounter";
        ...
        {
            private readonly RangedWeaponAmmoCounterComponent _parent;
            private readonly HBoxContainer _bulletsListTop;
            private readonly HBoxContainer _bulletsListBottom;
            private readonly TextureRect _chamberedBullet;
            private readonly Label _noMagazineLabel;

            public StatusControl(RangedWeaponAmmoCounterComponent parent)
            {
                _parent = parent;
