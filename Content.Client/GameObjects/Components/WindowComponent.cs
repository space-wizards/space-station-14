...
namespace Content.Client.GameObjects.Components
{
    ...
    public sealed class WindowComponent : SharedWindowComponent
    {
        ...
        protected override void Startup()
        {
            ...
            _sprite.LayerMapSet(WindowDamageLayers.DamageSE, _sprite.AddLayerState("0", cracksRSIPath));
            ...
            _sprite.LayerMapSet(WindowDamageLayers.DamageNE, _sprite.AddLayerState("0", cracksRSIPath));
            ...
            _sprite.LayerMapSet(WindowDamageLayers.DamageNW, _sprite.AddLayerState("0", cracksRSIPath));
            ...
            _sprite.LayerMapSet(WindowDamageLayers.DamageSW, _sprite.AddLayerState("0", cracksRSIPath));
