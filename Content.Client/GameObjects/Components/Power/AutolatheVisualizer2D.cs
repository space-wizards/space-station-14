...
namespace Content.Client.GameObjects.Components.Power
{
    public class AutolatheVisualizer2D : AppearanceVisualizer
    {
        ...
        private Animation _insertingLasagnaAnimation;
        ...
        public override void LoadData(YamlMappingNode node)
        {
            ...
            _insertingLasagnaAnimation = PopulateAnimation("autolathe_inserting_lasagna", "autolathe_inserting_unlit", 0.9f);
        }
        ...
        public override void OnChangeData(AppearanceComponent component)
        {
            ...
            switch (state)
            {
                ...
                case LatheVisualState.InsertingGlass:
                    ...
                    break;
                case LatheVisualState.InsertingLasagna:
                    if (!animPlayer.HasRunningAnimation(AnimationKey))
                    {
                        animPlayer.Play(_insertingLasagnaAnimation, AnimationKey);
                    }
                    break;
                default:
