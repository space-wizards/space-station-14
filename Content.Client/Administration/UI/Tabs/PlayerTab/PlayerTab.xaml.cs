...
namespace Content.Client.Administration.UI.Tabs.PlayerTab
{
    ...
    public sealed partial class PlayerTab : Control
    {
        ...
        private void RefreshPlayerList(IReadOnlyList<PlayerInfo> players)
        {
            ...
            var filteredPlayers = _players.Where(p =>
                p.Username.Contains(_searchText, StringComparison.OrdinalIgnoreCase) ||
                p.CharacterName.Contains(_searchText, StringComparison.OrdinalIgnoreCase) ||
                p.IdentityName.Contains(_searchText, StringComparison.OrdinalIgnoreCase) ||
                p.StartingJob.Contains(_searchText, StringComparison.OrdinalIgnoreCase)).ToList();
