...
namespace Content.Client.Administration.UI.Tabs.AdminTab
{
    ...
    public sealed partial class BanWindow : DefaultWindow
    {
        public BanWindow()
        {
            ...
            RoundID.SetText(EntitySystem.Get<ClientGameTicker>().RoundId.ToString());
        }
        ...
        private void SubmitButtonOnOnPressed(BaseButton.ButtonEventArgs obj)
        {
            ...
            IoCManager.Resolve<IClientConsoleHost>().ExecuteCommand(
                $"ban \"{PlayerNameLine.Text}\" \"{CommandParsing.Escape(ReasonLine.Text)}\" {MinutesLine.Text} \"{RoundID.Text}\"");
        }
    }
}
