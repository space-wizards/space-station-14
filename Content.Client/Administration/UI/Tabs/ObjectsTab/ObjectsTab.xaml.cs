...
public sealed partial class ObjectsTab : Control
{
            ...
            case ObjectsTabSelection.Stations:
                {
                    ...
                    if (!_entityManager.TryGetEntity(nent, out var station))
                        break;
                    var largestGrid = _entityManager.EntitySysManager.GetEntitySystem<ClientStationSystem>().GetLargestGrid(station.Value);
                    if (largestGrid == null)
                        break;
    ...
    private void RefreshObjectList(ObjectsTabSelection selection)
    {
        ...
        {
            case ObjectsTabSelection.Stations:
                entities.AddRange(_entityManager.EntitySysManager.GetEntitySystem<ClientStationSystem>().GetStationNames());
                break;
            case ObjectsTabSelection.Grids:
                {
