...
namespace Content.Client.Administration.UI.Bwoink
{
    ...
    public sealed partial class BwoinkControl : Control
    {
        ...
        public BwoinkControl()
        {
            ...
            AdminFaxEuiMsg.Follow.OnPressed += _ =>
            {
                if (_currentPlayer is not null)
        ...
        public void UpdateButtons()
        {
            ...
            AdminFaxEuiMsg.Follow.Visible = _adminManager.CanCommand("follow");
            AdminFaxEuiMsg.Follow.Disabled = !AdminFaxEuiMsg.Follow.Visible || disabled;
        }
