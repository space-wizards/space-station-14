...
public sealed class BlockGameClientBoundUserInterface : ClientBoundUserInterface
{
    private BlockGameMenu? _menu;

    public BlockGameClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
