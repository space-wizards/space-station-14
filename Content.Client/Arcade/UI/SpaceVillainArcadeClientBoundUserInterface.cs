...
public sealed class SpaceVillainArcadeClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables] private SpaceVillainArcadeMenu? _menu;

    //public SharedSpaceVillainArcadeComponent SpaceVillainArcade;

    public SpaceVillainArcadeClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
