...
public sealed class SignalTimerClientBoundUserInterface : ClientBoundUserInterface
{
    ...
    public SignalTimerClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
