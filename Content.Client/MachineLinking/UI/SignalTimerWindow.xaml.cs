...
public sealed partial class SignalTimerWindow : DefaultWindow
{
    ...
    private const int MaxTextLength = 16;
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        {
            var displayValue = TextScreenSystem.ConvertTimeToDisplayValue(_triggerTime.Value - _timing.CurTime, true);
            StartTimer.Text = TextScreenSystem.GetString(displayValue);
        }
        else
        {
            SetTimerStarted(false);
    ...
    public void OnCurrentTextChange(string text)
    {
        if (CurrentTextEdit.Text.Length > MaxTextLength)
        {
            ...
            CurrentTextEdit.CursorPosition = int.Min(CurrentTextEdit.CursorPosition, MaxTextLength);
        }
