...
{
    [UsedImplicitly]
    public sealed class CloningConsoleClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private CloningConsoleWindow? _window;

        public CloningConsoleClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
