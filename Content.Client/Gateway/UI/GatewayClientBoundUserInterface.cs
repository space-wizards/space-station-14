...
[UsedImplicitly]
public sealed class GatewayClientBoundUserInterface : ClientBoundUserInterface
{
    private GatewayWindow? _window;

    public GatewayClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
