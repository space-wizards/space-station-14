...
public sealed class ClientGlobalSoundSystem : SharedGlobalSoundSystem
{
    ...
    private void PlayAdminSound(AdminSoundEvent soundEvent)
    {
        ...
        var stream = _audio.PlayGlobal(soundEvent.Specifier, Filter.Local(), false, FunAudioParams.WithUniformPitch(soundEvent.AudioParams));
    ...
    {
        _audio.PlayGlobal(soundEvent.Specifier, Filter.Local(), false, FunAudioParams.WithUniformPitch(soundEvent.AudioParams));
    }
