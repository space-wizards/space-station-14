...
public sealed class ClientGlobalSoundSystem : SharedGlobalSoundSystem
{
    ...
    private void PlayAdminSound(AdminSoundEvent soundEvent)
    {
        ...
        var stream = _audio.PlayGlobal(soundEvent.Filename, Filter.Local(), false, AudioFun.FunAudioParams(soundEvent.AudioParams));
    ...
    {
        _audio.PlayGlobal(soundEvent.Filename, Filter.Local(), false, AudioFun.FunAudioParams(soundEvent.AudioParams));
    }
