...
public sealed class AmbientOverlayCommand : LocalizedEntityCommands
{
    ...
    public override string Description => Loc.GetString($"cmd-show-ambient-overlay-desc");
    public override string Help => $"{Command}";
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        _ambient.OverlayEnabled ^= true;
        shell.WriteLine(Loc.GetString($"cmd-ambient-overlay-status", ("status", _ambient.OverlayEnabled)));
    }
}
