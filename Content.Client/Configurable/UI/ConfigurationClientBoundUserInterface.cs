...
{
    public sealed class ConfigurationClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public ConfigurationClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
