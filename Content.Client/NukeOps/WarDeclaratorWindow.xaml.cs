...
public sealed partial class WarDeclaratorWindow : DefaultWindow
{
    ...
    public WarDeclaratorWindow()
    {
        ...
        MessageEdit.Placeholder = new Rope.Leaf(_loc.GetString("war-declarator-message-placeholder"));
        MessageEdit.OnTextChanged += HandleTextChanged;
    }
    ...
    {
        var length = MessageEdit.TextLength;
        ...
        MessageLengthLabel.ToolTip = remaining < 0
            ? _loc.GetString("war-declarator-message-length-too-long-tooltip")
            : _loc.GetString("war-declarator-message-length-remaining-tooltip", ("remaining", remaining));
    }
}
