...
[UsedImplicitly]
public sealed class WarDeclaratorClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private WarDeclaratorWindow? _window;

    public WarDeclaratorClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey) {}
