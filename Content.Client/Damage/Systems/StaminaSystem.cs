...
public sealed partial class StaminaSystem : SharedStaminaSystem
{
    ...
    {
        DebugTools.Assert(entity.Comp1.AnimationThreshold < entity.Comp1.CritThreshold,
            $"Animation threshold on {ToPrettyString(entity)} was not less than the crit threshold. This will cause errors.");
