...
{
    public sealed class InstrumentClientBoundUserInterface : ClientBoundUserInterface
    {
        ...
        public InstrumentClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
