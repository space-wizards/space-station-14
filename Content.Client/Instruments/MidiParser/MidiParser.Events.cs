...
public static partial class MidiParser
{
    ...
    private static readonly Dictionary<ushort, Action<MidiStreamWrapper, int, int, MidiTrackInfo>>
        MidiMetaEventHandlers = new()
        {
    ...
    private static readonly Dictionary<ushort, Action<MidiStreamWrapper, int, int, MidiTrackInfo>> MidiEventHandlers =
        new()
        {
    ...
    // Meta-Event methods
    private static void ReadTextMetaEvent(MidiStreamWrapper stream,
        int eventLength,
        int currentTick,
    ...
    private static void ReadCopyrightMetaEvent(MidiStreamWrapper stream,
        int eventLength,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
    ...
    private static void ReadTrackNameMetaEvent(MidiStreamWrapper stream,
        int eventLength,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
    ...
    private static void ReadInstrumentNameMetaEvent(MidiStreamWrapper stream,
        int eventLength,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
    ...
    private static void ReadTempoMetaEvent(MidiStreamWrapper stream,
        int eventLength,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
    ...
    private static void ReadEndOfTrackEvent(MidiStreamWrapper stream,
        int eventLength,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
    ...
    private static void ReadNotImplementedEvent(MidiStreamWrapper stream,
        int eventLength,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
    ...
    // Midi-Event methods
    private static void ReadProgramChangeEvent(MidiStreamWrapper stream,
        int channel,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
    ...
    private static void ReadGenericSingleByteMidiEvent(MidiStreamWrapper stream,
        int channel,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
    ...
    private static void ReadGenericDoubleByteMidiEvent(MidiStreamWrapper stream,
        int channel,
        int currentTick,
        MidiTrackInfo trackInfo)
    {
