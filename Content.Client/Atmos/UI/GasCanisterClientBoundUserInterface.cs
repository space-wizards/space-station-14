...
namespace Content.Client.Atmos.UI
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class GasCanisterClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private GasCanisterWindow? _window;

        public GasCanisterClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
