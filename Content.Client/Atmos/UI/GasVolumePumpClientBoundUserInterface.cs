...
namespace Content.Client.Atmos.UI
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class GasVolumePumpClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public GasVolumePumpClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
