...
namespace Content.Client.Atmos.UI
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed class GasFilterClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public GasFilterClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
