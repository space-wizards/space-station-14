...
namespace Content.Client.Atmos.UI
{
    ...
    {
        private readonly ButtonGroup ClogButtonGroup = new();

        public event Action<GasFilterClogMode>? ClogModeChanged;
        ...
        public GasFilterWindow()
        {
            ...
            ClogButtonBlock.Group = ClogButtonGroup;
            ClogButtonPass.Group = ClogButtonGroup;
            ClogButtonBlock.OnPressed += _ => ClogModeChanged?.Invoke(GasFilterClogMode.Block);
            ClogButtonPass.OnPressed += _ => ClogModeChanged?.Invoke(GasFilterClogMode.Pass);
        ...
        public void SetClogMode(GasFilterClogMode clogMode)
        {
            switch (clogMode)
            {
                case GasFilterClogMode.Block:
                    ClogButtonBlock.Pressed = true;
                    break;
                case GasFilterClogMode.Pass:
                    ClogButtonPass.Pressed = true;
                    break;
            }
        }
