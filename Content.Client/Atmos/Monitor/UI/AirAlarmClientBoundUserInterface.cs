...
public sealed class AirAlarmClientBoundUserInterface : ClientBoundUserInterface
{
    private AirAlarmWindow? _window;

    public AirAlarmClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
