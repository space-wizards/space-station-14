...
public sealed partial class SensorInfo : BoxContainer
{
    ...
    public Action<LocDeviceAddress, AtmosMonitorThresholdType, AtmosAlarmThreshold, Gas?>? OnThresholdUpdate;
    public event Action<AtmosMonitorData>? SensorDataCopied;
    private LocDeviceAddress _address;
    ...
    public SensorInfo(AtmosMonitorData dataPayload, LocDeviceAddress address)
    {
