...
namespace Content.Client.EscapeMenu.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        [Dependency] private readonly IFileDialogManager _fileDialogMan = default!;
        [Dependency] private readonly IMidiManager _midiManager = default!;

        private string _selectedSoundfont = default!;
        private string SelectedSoundfont
        {
            get => _selectedSoundfont;
            set
            {
                _selectedSoundfont = value;
                MidiSoundfontSelection.Text = value;
            }
        }
        ...
        public AudioTab()
        {
            ...
            MidiSoundfontButton.OnPressed += OnMidiSoundfontPressed;
        ...
        private async void OnMidiSoundfontPressed(BaseButton.ButtonEventArgs args)
        {
            var filters = new FileDialogFilters(new FileDialogFilters.Group("sf2", "dls"));
            var file = await _fileDialogMan.GetOpenFileName(filters);
            ...
            if (!_midiManager.IsSoundFont(file))
                return;

            SelectedSoundfont = file;
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CVars.MidiSoundfont, SelectedSoundfont);
        ...
        private void Reset()
        {
            ...
            SelectedSoundfont = _cfg.GetCVar(CVars.MidiSoundfont);
        ...
        private void UpdateChanges()
        {
            ...
            var isMidiSoundfontSame = _selectedSoundfont == _cfg.GetCVar(CVars.MidiSoundfont);
            ...
            var isEverythingSame = isMasterVolumeSame && isMidiVolumeSame && isAmbientVolumeSame && isAmbientSoundsSame && isLobbySame && isMidiSoundfontSame;
