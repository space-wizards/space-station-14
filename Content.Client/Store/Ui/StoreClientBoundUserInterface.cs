...
[UsedImplicitly]
public sealed class StoreClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    ...
    public StoreClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
