...
public sealed partial class StoreMenu : DefaultWindow
{
    ...
    public StoreMenu()
    {
        ...
        _entityTable = _entitySystem.GetEntitySystem<EntityTableSystem>();
    ...
    private void AddListingGui(ListingDataWithCostModifiers listing)
    {
        ...
        else if (listing.ProductEntityTable != null)
        {
            if (texture == null)
            {
                var products = _entityTable.GetSpawns(listing.ProductEntityTable).ToList();
                texture = spriteSys.GetPrototypeIcon(products[0]).Default;
            }
        }
