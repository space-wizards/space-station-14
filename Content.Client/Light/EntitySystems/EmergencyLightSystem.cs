...
public sealed class EmergencyLightSystem : VisualizerSystem<EmergencyLightComponent>
{
    protected override void OnAppearanceChange(EntityUid uid, EmergencyLightComponent comp, ref AppearanceChangeEvent args)
    {
        ...
        if (!AppearanceSystem.TryGetData<bool>(uid, EmergencyLightVisuals.On, out bool on, args.Component))
            on = false;
        ...
        if (AppearanceSystem.TryGetData<Color>(uid, EmergencyLightVisuals.Color, out Color color, args.Component))
        {
