...
public sealed partial class StationAiCustomizationMenu : FancyWindow
{
    ...
    /// <summary>
    /// Sets the console this window represents; populates the set of acceptable customizations.
    /// </summary>
    public void SetConsole(EntityUid console)
    {
        // Load customization data
        _entManager.TryGetComponent<StationAiCoreComponent>(console, out var stationAiCore);
        _stationAiSystem.TryGetHeld((console, stationAiCore), out var insertedAi);
