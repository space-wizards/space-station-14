...
public sealed partial class BorgMenu : FancyWindow
{
    ...
    private readonly SharedBorgSystem _borg;
    ...
    public BorgMenu()
    {
        ...
        _borg = _entity.System<SharedBorgSystem>();
    ...
    public void UpdateModulePanel()
    {
        ...
        foreach (var module in chassis.ModuleContainer.ContainedEntities)
        {
            ...
            var control = new BorgModuleControl(
                module,
                _entity,
                !moduleComponent.Required,
                _borg.GetBorgModuleRequirementReason((module, moduleComponent))
            );
