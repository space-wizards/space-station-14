...
[UsedImplicitly]
public sealed class BorgClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private BorgMenu? _menu;

    public BorgClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
