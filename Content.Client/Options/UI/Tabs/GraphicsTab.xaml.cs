...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class GraphicsTab : Control
    {
        ...
        public GraphicsTab()
        {
            ...
            ShowGunCrosshair.OnToggled += OnCheckBoxToggled;
            ...
            ShowGunCrosshair.Pressed = _cfg.GetCVar(CCVars.GunCrosshairShow);
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCVars.GunCrosshairShow, ShowGunCrosshair.Pressed);
        ...
        private void UpdateApplyButton()
        {
            ...
            var isGunCrosshairShow = ShowGunCrosshair.Pressed == _cfg.GetCVar(CCVars.GunCrosshairShow);
