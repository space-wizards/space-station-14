...
public sealed partial class MiscTab : Control
{
    ...
    public MiscTab()
    {
        ...
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote1, GlobalCustomEmote1);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote2, GlobalCustomEmote2);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote3, GlobalCustomEmote3);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote4, GlobalCustomEmote4);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote5, GlobalCustomEmote5);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote6, GlobalCustomEmote6);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote7, GlobalCustomEmote7);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote8, GlobalCustomEmote8);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote9, GlobalCustomEmote9);
        Control.AddOptionLineEdit(CVars.GlobalCustomEmote10, GlobalCustomEmote10);
