...
public sealed partial class AudioTab : Control
{
    ...
    public AudioTab()
    {
        ...
        Control.AddOptionPercentSlider(
            StarlightCVar.TTSVolume,
            SliderTts,
            scale: ContentAudioSystem.TtsMultiplier);

        Control.AddOptionPercentSlider(
            StarlightCVar.TTSRadioVolume,
            SliderTtsRadio,
            scale: ContentAudioSystem.TtsMultiplier);

        Control.AddOptionPercentSlider(
            StarlightCVar.TTSAnnounceVolume,
            SliderTtsAnnounce,
            scale: ContentAudioSystem.TtsMultiplier);
        ...
        Control.AddOptionCheckBox(StarlightCVar.TTSClientEnabled, TtsClientCheckBox);
