...
public sealed partial class AudioTab : Control
{
    ...
    public AudioTab()
    {
        ...
        var ambienceVolume = Control.AddOptionPercentSlider(
            CCVars.AmbienceVolume,
            SliderVolumeAmbience,
            scale: ContentAudioSystem.AmbienceMultiplier);
        ambienceVolume.ImmediateValueChanged += OnAmbienceVolumeSliderChanged;
    ...
    private void OnAmbienceVolumeSliderChanged(float value)
    {
        _entManager.System<AmbientSoundSystem>().SetAmbienceGain(value);
        _entManager.System<WeatherSystem>().SetAmbienceGain(value);
    }
}
