...
[UsedImplicitly]
public sealed class MechClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private MechMenu? _menu;

    public MechClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
