...
{
    [UsedImplicitly]
    public sealed class LatheClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private LatheMenu? _menu;
        public LatheClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
