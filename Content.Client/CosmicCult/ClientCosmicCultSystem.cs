...
public sealed partial class ClientCosmicCultSystem : CosmicCultSystem
{
    ...
    [SubscribeLocalEvent]
    private void OnCultistMove(Entity<CosmicBrandComponent> ent, ref MoveEvent args)
    {
    ...
    [SubscribeLocalEvent]
    private void OnAnimationCompleted(EntityUid uid, CosmicBrandComponent component, AnimationCompletedEvent args)
    {
    ...
    [SubscribeLocalEvent]
    private void OnCosmicStarMarkAdded(Entity<CosmicBrandComponent> uid, ref ComponentStartup args)
    {
