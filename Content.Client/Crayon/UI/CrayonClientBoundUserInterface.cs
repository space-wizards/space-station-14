...
{
    public sealed class CrayonClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        private CrayonWindow? _menu;

        public CrayonClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
