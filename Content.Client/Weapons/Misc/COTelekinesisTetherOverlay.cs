...
public sealed class COTelekinesisTetherOverlay : Overlay
{
    public override OverlaySpace Space => OverlaySpace.WorldSpaceBelowFOV;

    private IEntityManager _entManager;

    public COTelekinesisTetherOverlay(IEntityManager entManager)
    {
    ...
    {
        var query = _entManager.EntityQueryEnumerator<COTelekinesisTetherComponent>();
        var xformQuery = _entManager.GetEntityQuery<TransformComponent>();
        var tetherQuery = _entManager.GetEntityQuery<COTelekinesisHandComponent>();
        ...
        while (query.MoveNext(out var uid, out var tethered))
        {
            ...
            if (tetherQuery.TryGetComponent(tethered.Tetherer, out var tether))
            {
