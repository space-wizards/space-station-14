...
public sealed partial class GrinderMenu : FancyWindow
{
    ...
    public void UpdateUi()
    {
        ...
        var hasInput = chamberEntities.Any();
        ...
        BeakerEjectButton.Disabled = active || !beaker.HasValue;
        ChamberEjectButton.Disabled = active || !hasInput;
        ChamberDisabledOverlay.Visible = active;
    ...
    private void UpdateBeaker(EntityUid? beaker)
    {
        if (beaker is not { } beakerEnt)
        {
            ...
            BeakerVolumeLabel.Text = string.Empty;
        ...
        ReagentListHelper.PopulateReagentList(BeakerContents, solution.Contents, _prototypeManager);
    }
