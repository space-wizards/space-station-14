...
{
    [UsedImplicitly]
    public sealed class MicrowaveClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public MicrowaveClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
