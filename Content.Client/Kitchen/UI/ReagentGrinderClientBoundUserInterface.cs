...
{
    public sealed class ReagentGrinderClientBoundUserInterface : ClientBoundUserInterface
    {
        ...
        public ReagentGrinderClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
