...
[UsedImplicitly]
public sealed class PaperClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private PaperWindow? _window;

    public PaperClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
