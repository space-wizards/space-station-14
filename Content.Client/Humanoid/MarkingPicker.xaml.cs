...
public sealed partial class MarkingPicker : Control
{
    ...
    public void Populate()
    {
        ...
        foreach (var marking in markings.Values)
        {
            ...
            var item = CMarkingsUnused.AddItem(
                ...
                _systemManager.GetEntitySystem<SpriteSystem>().Frame0(marking.Sprites[0])
            );
    ...
    public void PopulateUsed()
    {
        ...
        foreach (var marking in _currentMarkings.GetReverseEnumerator(_selectedMarkingCategory))
        {
            ...
            {
                Text = text,
                Icon = _systemManager.GetEntitySystem<SpriteSystem>().Frame0(newMarking.Sprites[0]),
                Selectable = true,
                Metadata = newMarking,
    ...
    private void MarkingAdd()
    {
        ...
        var item = new ItemList.Item(CMarkingsUsed)
        {
            ...
            Icon = _systemManager.GetEntitySystem<SpriteSystem>().Frame0(marking.Sprites[0]),
            Selectable = true,
            Metadata = marking,
        };
