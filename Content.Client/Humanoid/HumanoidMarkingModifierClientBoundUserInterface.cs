...
public sealed class HumanoidMarkingModifierClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private HumanoidMarkingModifierWindow? _window;

    public HumanoidMarkingModifierClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
