...
{
    public sealed class VendingMachineClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public VendingMachineClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
