...
public sealed partial class VendingMachineControl : Control
{
    ...
    /// </summary>
    public void Populate(List<VendingMachineInventoryEntry> inventory, bool enabled, out Vector2 newWindowSize)
    {
        _enabled = enabled;
        _listItems.Clear();
        _amounts.Clear();
        ...
        if (inventory.Count == 0 && VendingContents.Visible)
        {
            ...
            newWindowSize = new Vector2(Math.Clamp((outOfStockLabel.Text.Length + 2) * 12, 250, 400),
            150);
            return;
        }
        ...
        newWindowSize = new Vector2(Math.Clamp((longestEntry.Length + 2) * 12, 250, 400),
            Math.Clamp(inventory.Count * 50, 150, 350));
    }
