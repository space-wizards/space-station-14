...
{
    public sealed class CargoOrderConsoleClientBoundUserInterface : ClientBoundUserInterface
    {
        [ViewVariables]
        ...
        public CargoOrderConsoleClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
        {
        }
