...
[UsedImplicitly]
public sealed class CargoShuttleConsoleClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    private CargoShuttleMenu? _menu;

    public CargoShuttleConsoleClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
