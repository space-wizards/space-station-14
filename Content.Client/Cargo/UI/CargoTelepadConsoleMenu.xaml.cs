...
namespace Content.Client.Cargo.UI
{
    ...
    public sealed partial class CargoTelepadConsoleMenu : DefaultWindow
    {
        [Dependency]
        private IPrototypeManager _prototypeManager = default!;

        public CargoTelepadConsoleBoundUserInterface Owner { get; private set; }
        ...
        public CargoTelepadConsoleMenu(CargoTelepadConsoleBoundUserInterface owner)
        {
