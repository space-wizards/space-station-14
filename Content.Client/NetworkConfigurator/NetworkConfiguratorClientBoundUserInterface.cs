...
public sealed class NetworkConfiguratorClientBoundUserInterface : ClientBoundUserInterface
{
    ...
    public NetworkConfiguratorClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
