...
public sealed class SprayPainterClientBoundUserInterface : ClientBoundUserInterface
{
    [ViewVariables]
    ...
    public SprayPainterClientBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
