...
namespace Content.Client.ContextMenu.UI
{
    public class ContextMenuPresenter : IDisposable
    {
        ...
        private void OnKeyBindDownStack(object? sender, (GUIBoundKeyEventArgs, StackContextElement) e)
        {
            ...
            if (args.Function == EngineKeyFunctions.Use || args.Function == ContentKeyFunctions.AltUse || args.Function == ContentKeyFunctions.TryPullObject || args.Function == ContentKeyFunctions.MovePulledObject)
            {
        ...
        private void OnKeyBindDownSingle(object? sender, (GUIBoundKeyEventArgs, SingleContextElement) valueTuple)
        {
            ...
            var entity = single.ContextEntity;
             ...
             if (args.Function == EngineKeyFunctions.Use || args.Function == ContentKeyFunctions.AltUse || args.Function == ContentKeyFunctions.Point ||
