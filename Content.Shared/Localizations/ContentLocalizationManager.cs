...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        {
            var culture = new CultureInfo(_cfg.GetCVar(CCVars.Locale));
            _cfg.OnValueChanged(CCVars.Locale, LocaleCVarChanged);
            LoadCulture(culture);
        }
        ...
        private void LocaleCVarChanged(string locName)
        {
