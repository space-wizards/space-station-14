...
namespace Content.Shared.Containers.ItemSlots
{
    ...
    public sealed partial class ItemSlot
    {
        ...
        [DataField]
        public SoundSpecifier InsertSound = new SoundCollectionSpecifier("RevolverMagazineInjectSound");

        [DataField]
        public SoundSpecifier EjectSound = new SoundCollectionSpecifier("RevolverMagazineEjectSound");
