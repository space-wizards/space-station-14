...
namespace Content.Shared.Containers.ItemSlots
{
    ...
    public class ItemSlotsSystem : EntitySystem
    {
        ...
        /// </summary>
        private void Insert(EntityUid uid, ItemSlot slot, IEntity item, EntityUid? user, bool userAudio = false)
        {
            slot.ContainerSlot.Insert(item);
        ...
        public bool TryInsert(EntityUid uid, string id, IEntity item, EntityUid? user, ItemSlotsComponent? itemSlots = null)
        {
        ...
        /// </summary>
        /// <returns>False if failed to insert item</returns>
        public bool TryInsert(EntityUid uid, ItemSlot slot, IEntity item, EntityUid? user)
        {
        ...
        /// </summary>
        private void Eject(EntityUid uid, ItemSlot slot, IEntity item, EntityUid? user)
        {
        ...
        public bool TryEject(EntityUid uid, ItemSlot slot, EntityUid? user, [NotNullWhen(true)] out IEntity? item)
        {
            item = null;
        ...
        public bool TryEject(EntityUid uid, string id, EntityUid user,
            [NotNullWhen(true)] out IEntity? item, ItemSlotsComponent? itemSlots = null)
        {
            item = null;
        ...
        private void AddInteractionVerbsVerbs(EntityUid uid, ItemSlotsComponent itemSlots, GetInteractionVerbsEvent args)
        {
            ...
            foreach (var slot in itemSlots.Slots.Values)
            {
                ...
                Verb insertVerb = new();
                insertVerb.Act = () => Insert(uid, slot, args.Using, args.UserUid);
