...
/// </summary>
/// <param name="MindRoleId">The mind role entity which was added.</param>
/// <param name="MindRole">The mind role component associated with the mind role entity.</param>
...
public sealed record RoleAddedEvent(EntityUid MindRoleId, MindRoleComponent MindRole, EntityUid MindId, MindComponent Mind, bool RoleTypeUpdate, bool Silent = false) : RoleEvent(MindId, Mind, RoleTypeUpdate);
