...
{
    [DataField("devourActionId", customTypeSerializer: typeof(PrototypeIdSerializer<EntityPrototype>))]
    public string? DevourActionId = "ActionDevour";

    [DataField("devourAction")]
    public EntityUid? DevourAction;
