...
public sealed partial class DoorComponent : Component
{
    ...
    public TimeSpan CloseTimeOne { get; private set; } = TimeSpan.FromSeconds(0.4f);

    /// <summary>
    /// Closing time until fully closed. Total time is this plus <see cref="CloseTimeOne"/>.
    /// </summary>
    [DataField("closeTimeTwo")]
    public TimeSpan CloseTimeTwo { get; private set; } = TimeSpan.FromSeconds(0.2f);

    /// <summary>
    /// Opening time until passable. Total time is this plus <see cref="OpenTimeTwo"/>.
    /// </summary>
    [DataField("openTimeOne")]
    public TimeSpan OpenTimeOne { get; private set; } = TimeSpan.FromSeconds(0.4f);

    /// <summary>
    /// Opening time until fully open. Total time is this plus <see cref="OpenTimeOne"/>.
    /// </summary>
    [DataField("openTimeTwo")]
    public TimeSpan OpenTimeTwo { get; private set; } = TimeSpan.FromSeconds(0.2f);

    /// <summary>
    ///     Interval between deny sounds & visuals;
    /// </summary>
    [DataField("denyDuration")]
    public TimeSpan DenyDuration { get; private set; } = TimeSpan.FromSeconds(0.45f);

    [DataField("emagDuration")]
    public TimeSpan EmagDuration { get; private set; } = TimeSpan.FromSeconds(0.8f);
    ...
    public TimeSpan DoorStunTime { get; private set; } = TimeSpan.FromSeconds(2f);
    ...
    /// </summary>
    [DataField("canCrush")]
    public bool CanCrush { get; private set; } = true;
    ...
    public bool PerformCollisionCheck { get; private set; } = true;
