...
public sealed partial class ClampWoundsEntityEffectSystem : EntityEffectSystem<WoundableBodyComponent, ClampWounds>
{
    ...
    {
        _woundableBody.ClampWounds(ent, args.Effect.Chance);
    }
}
