...
public sealed partial class SatiationComponent : Component
{
    ...
    [AutoNetworkedField]
    private Dictionary<ProtoId<SatiationTypePrototype>, Satiation> _satiations = new();

    /// <inheritdoc cref="_satiations"/>
    public Dictionary<ProtoId<SatiationTypePrototype>, Satiation> Satiations => _satiations;
