...
namespace Content.Shared.GameObjects.Components.Inventory
{
    ...
    public abstract class SharedInventoryComponent : Component
    {
        ...
        public sealed override uint? NetID => NetIDs.STORAGE;
        ...
        protected class InventoryComponentState : ComponentState
        {
            ...
            public InventoryComponentState(List<KeyValuePair<Slots, EntityUid>> entities, KeyValuePair<Slots, (EntityUid entity, bool fits)>? hoverEntity = null) : base(NetIDs.STORAGE)
            {
                Entities = entities;
