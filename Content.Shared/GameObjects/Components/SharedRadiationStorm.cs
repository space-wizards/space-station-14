...
namespace Content.Shared.GameObjects.Components
{
    ...
    public class RadiationPulseState : ComponentState
    {
        ...
        public RadiationPulseState(float radsPerSecond, float range, bool draw, bool decay, TimeSpan endTime) : base(NetIDs.RADIATION_PULSE)
        {
