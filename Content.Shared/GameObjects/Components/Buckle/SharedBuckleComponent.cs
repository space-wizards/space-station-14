...
namespace Content.Shared.GameObjects.Components.Buckle
{
    ...
    public abstract class SharedBuckleComponent : Component, IActionBlocker, IEffectBlocker, IDraggable, ICollideSpecial
    {
        ...
        public sealed override uint? NetID => NetIDs.BUCKLE;
        /// <summary>
    ...
    {
        public BuckleComponentState(bool buckled, int? drawDepth, EntityUid? lastEntityBuckledTo, bool dontCollide) : base(NetIDs.BUCKLE)
        {
            Buckled = buckled;
            DrawDepth = drawDepth;
