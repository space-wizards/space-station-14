...
namespace Content.Shared.GameObjects.Components.Instruments
{
    ...
    public class SharedInstrumentComponent : Component
    {
        ...
        public override uint? NetID => NetIDs.INSTRUMENTS;
    ...
    public class InstrumentState : ComponentState
    {
        ...
        public InstrumentState(bool playing, byte instrumentProgram, byte instrumentBank, bool allowPercussion, bool allowProgramChange, bool respectMidiLimits, uint sequencerTick = 0) : base(NetIDs.INSTRUMENTS)
        {
            Playing = playing;
