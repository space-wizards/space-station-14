...
namespace Content.Shared.GameObjects.Components.Mobs
{
    ...
    public abstract class SharedStunnableComponent : Component, IMoveSpeedModifier, IActionBlocker, IInteractHand
    {
        ...
        public override uint? NetID => NetIDs.STUNNABLE;
        ...
        protected sealed class StunnableComponentState : ComponentState
        {
            ...
            public StunnableComponentState(float stunnedTimer, float knockdownTimer, float slowdownTimer, float walkModifierOverride, float runModifierOverride) : base(NetIDs.STUNNABLE)
            {
