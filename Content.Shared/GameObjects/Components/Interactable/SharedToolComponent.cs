...
namespace Content.Shared.GameObjects.Components.Interactable
{
    ...
    public class MultiToolComponentState : ComponentState
    {
        ...
        public MultiToolComponentState(ToolQuality quality) : base(NetIDs.MULTITOOLS)
        {
            Quality = quality;
        }
    }
    ...
    public class WelderComponentState : ComponentState
    {
        ...
        public WelderComponentState(float fuelCapacity, float fuel, bool activated) : base(NetIDs.WELDER)
        {
