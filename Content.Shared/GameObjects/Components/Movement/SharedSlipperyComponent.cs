...
namespace Content.Shared.GameObjects.Components.Movement
{
    ...
    public class SlipperyComponentState : ComponentState
    {
        ...
        public SlipperyComponentState(float paralyzeTime, float intersectPercentage, float requiredSlipSpeed, float launchForwardsMultiplier, bool slippery) : base(NetIDs.SLIP)
        {
