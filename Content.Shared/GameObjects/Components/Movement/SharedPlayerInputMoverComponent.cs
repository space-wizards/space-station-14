...
namespace Content.Shared.GameObjects.Components.Movement
{
    ...
    public abstract class SharedPlayerInputMoverComponent : Component, IMoverComponent, ICollideSpecial
    {
        ...
        public sealed override uint? NetID => NetIDs.PLAYER_INPUT_MOVER;
        ...
        private sealed class MoverComponentState : ComponentState
        {
            ...
            public MoverComponentState(MoveButtons buttons) : base(NetIDs.PLAYER_INPUT_MOVER)
            {
                Buttons = buttons;
            }
        }
