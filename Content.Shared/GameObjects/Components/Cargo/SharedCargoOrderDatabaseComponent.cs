...
namespace Content.Shared.GameObjects.Components.Cargo
{
    ...
    public class CargoOrderDatabaseState : ComponentState
    {
        ...
        public CargoOrderDatabaseState(List<CargoOrderData> orders) : base(NetIDs.CARGO_ORDER_DATABASE)
        {
            Orders = orders;
        }
    }
