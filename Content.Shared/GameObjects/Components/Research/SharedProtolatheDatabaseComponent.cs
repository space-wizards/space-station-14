...
namespace Content.Shared.GameObjects.Components.Research
{
    ...
    [NetID("PROTOLATHE_DATABASE")]
    public class SharedProtolatheDatabaseComponent : SharedLatheDatabaseComponent
    {
        public override string Name => "ProtolatheDatabase";
        public sealed override uint? NetID => NetIDs.PROTOLATHE_DATABASE;
    ...
    public class ProtolatheDatabaseState : ComponentState
    {
        ...
        public ProtolatheDatabaseState(List<string> recipes) : base(NetIDs.PROTOLATHE_DATABASE)
        {
            Recipes = recipes;
        }
    }
