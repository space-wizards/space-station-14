...
namespace Content.Shared.GameObjects.Components.Research
{
    ...
    public class SharedMaterialStorageComponent : Component, IEnumerable<KeyValuePair<string, int>>
    {
        ...
        public sealed override uint? NetID => NetIDs.MATERIAL_STORAGE;
    ...
    public class MaterialStorageState : ComponentState
    {
        ...
        public MaterialStorageState(Dictionary<string, int> storage) : base(NetIDs.MATERIAL_STORAGE)
        {
            Storage = storage;
        }
    }
