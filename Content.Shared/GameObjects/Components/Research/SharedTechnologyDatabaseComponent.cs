...
namespace Content.Shared.GameObjects.Components.Research
{
    ...
    public class SharedTechnologyDatabaseComponent : Component, IEnumerable<TechnologyPrototype>
    {
        ...
        public override uint? NetID => NetIDs.TECHNOLOGY_DATABASE;
    ...
    public class TechnologyDatabaseState : ComponentState
    {
        ...
        public TechnologyDatabaseState(List<string> technologies) : base(NetIDs.TECHNOLOGY_DATABASE)
        {
            Technologies = technologies;
        }

        public TechnologyDatabaseState(List<TechnologyPrototype> technologies) : base(NetIDs.TECHNOLOGY_DATABASE)
        {
