...
public abstract partial class BaseTargetActionComponent : BaseActionComponent
{
    ...
    /// </remarks>
    [DataField] public bool CheckCanAccess = true;
    ...
    /// </remarks>
    [DataField] public bool InteractOnMiss = false;
    ...
    /// </summary>
    [DataField] public bool TargetingIndicator = true;
}
