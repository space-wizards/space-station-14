...
namespace Content.Shared.Kitchen
{
    ...
    public sealed class ReagentGrinderInterfaceState : BoundUserInterfaceState
    {
        ...
        public Dictionary<string, FixedPoint2>? ReagentQuantities;
        public ReagentGrinderInterfaceState(bool isBusy, bool hasBeaker, bool powered, bool canJuice, bool canGrind, EntityUid[] chamberContents, Dictionary<string, FixedPoint2>? heldBeakerContents)
        {
            IsBusy = isBusy;
