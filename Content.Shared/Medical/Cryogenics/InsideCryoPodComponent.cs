...
public sealed partial class InsideCryoPodComponent: Component
{
    ...
    /// </summary>
    [DataField]
    public float ConductanceMod = 10f; // Arbitrary number. Likely cryopods will have to be heat containers with special blue raspberry juice in the future, or use Frezon...
}
