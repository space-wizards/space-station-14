...
public sealed class CombatDefibrillatorComponent : Component
{
...
public enum CombatDefibrillatorVisuals : byte
{
    Ready
}

[Serializable, NetSerializable]
public sealed class CombatDefibrillatorZapDoAfterEvent : SimpleDoAfterEvent
{
