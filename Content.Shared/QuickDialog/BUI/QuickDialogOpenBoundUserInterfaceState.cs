...
public sealed class QuickDialogOpenBoundUserInterfaceState(string title, IQuickDialogEntry[] prompts, QuickDialogButtonFlag buttons) : BoundUserInterfaceState
{
    /// <summary>
