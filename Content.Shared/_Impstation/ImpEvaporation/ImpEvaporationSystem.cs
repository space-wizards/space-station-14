...
public abstract partial class SharedImpEvaporationSystem : EntitySystem
{
    ...
    /*
        ...
        public override void Update(float frameTime)
        {
            ...
            List<(EntityUid, Solution?, List<ReagentQuantity>)> puddlesToOperate = [];
            ...
            while (enumerator.MoveNext(out var uid, out var comp))
            {
                ...
                puddlesToOperate.Add((uid, solution, reagentQuantities));
            ...
            foreach (var (puddle, solution, reagents) in puddlesToOperate)
            {
