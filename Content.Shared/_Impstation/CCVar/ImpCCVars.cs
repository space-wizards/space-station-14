...
public sealed class ImpCCVars : CVars
{
    ...
    public static readonly CVarDef<int> CosmicCultT2RevealDelaySeconds =
        CVarDef.Create<int>("cosmiccult.t2_reveal_delay_seconds", 5, CVar.SERVER, "The delay between the monument getting upgraded to tier 2 and the crew learning of that fact. the monument cannot be upgraded again in this time.");

    public static readonly CVarDef<int> CosmicCultT3RevealDelaySeconds =
        CVarDef.Create<int>("cosmiccult.t3_reveal_delay_seconds", 5, CVar.SERVER, "The delay between the monument getting upgraded to tier 3 and the crew learning of that fact. the monument cannot be upgraded again in this time.");
