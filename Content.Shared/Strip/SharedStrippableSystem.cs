...
public abstract class SharedStrippableSystem : EntitySystem
{
        ...
        string slot)
    {
        ...
        var targetIdentity = Identity.Entity(target, EntityManager, user);
        ...
        string slot)
    {
        ...
        if (!stealth)
            _popupSystem.PopupEntity(Loc.GetString("strippable-component-alert-owner-insert", ("user", Identity.Entity(user, EntityManager, user)), ("item", user.Comp.ActiveHandEntity!.Value)), target, target, PopupType.Large);
        ...
        string slot)
    {
        ...
        if (!stealth)
        {
            if (IsStripHidden(slotDef, user))
                ...
                _popupSystem.PopupEntity(Loc.GetString("strippable-component-alert-owner", ("user", Identity.Entity(user, EntityManager, user)), ("item", item)), target, target, PopupType.Large);
        }
        ...
        StrippableComponent? targetStrippable = null)
    {
        ...
        if (!stealth)
            _popupSystem.PopupEntity(Loc.GetString("strippable-component-alert-owner-insert-hand", ("user", Identity.Entity(user, EntityManager, user)), ("item", user.Comp.ActiveHandEntity!.Value)), target, target, PopupType.Large);
        ...
        StrippableComponent? targetStrippable = null)
    {
        ...
        if (!stealth)
            _popupSystem.PopupEntity(Loc.GetString("strippable-component-alert-owner", ("user", Identity.Entity(user, EntityManager, user)), ("item", item)), target, target);
