...
public abstract class SharedDisposalUnitSystem : EntitySystem
{
    ...
    public abstract void DoInsertDisposalUnit(EntityUid uid, EntityUid toInsert, EntityUid user, SharedDisposalUnitComponent? disposal = null, bool doAfterInsert = true);
