...
namespace Content.Shared.Explosion.Components
{
    ...
    public sealed partial class OnUseTimerTriggerComponent : Component
    {
        ...
        /// </summary>
        [DataField("delayOptions")] public List<float>? DelayOptions = null;
        ...
        /// </summary>
        [DataField("initialBeepDelay")] public float? InitialBeepDelay;
        ...
        /// </summary>
        [DataField("useVerbInstead")] public bool UseVerbInstead = false;

        /// <summary>
        ///     Should timer be started when it was stuck to another entity.
        ///     Used for C4 charges and similar behaviour.
        /// </summary>
        [DataField("startOnStick")] public bool StartOnStick;
        ...
        /// </summary>
        [DataField("examinable")] public bool Examinable = true;
    }
}
