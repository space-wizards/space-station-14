...
public sealed partial class SolutionContainerManagerComponent : Component
{
    ...
    /// </remarks>
    [DataField, AutoNetworkedField] // Needs to be serverOnly or these will get loaded on the client and never cleared. Can be reworked when entity spawning is predicted.
