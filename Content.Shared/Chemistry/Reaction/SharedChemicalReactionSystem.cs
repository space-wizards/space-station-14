...
namespace Content.Shared.Chemistry.Reaction
{
    public abstract class SharedChemicalReactionSystem : EntitySystem
    {
        ...
        /// <returns></returns>
        private static bool CanReact(Components.Solution solution, ReactionPrototype reaction, out ReagentUnit lowestUnitReactions)
        {
        ...
        /// </summary>
        private Components.Solution PerformReaction(Components.Solution solution, IEntity owner, ReactionPrototype reaction, ReagentUnit unitReactions)
        {
            //Remove reactants
            ...
            //Create products
            var products = new Components.Solution();
        ...
        /// </summary>
        private Components.Solution ProcessReactions(Components.Solution solution, IEntity owner)
        {
            //TODO: make a hashmap at startup and then look up reagents in the contents for a reaction
            var overallProducts = new Components.Solution();
        ...
        /// </summary>
        public void FullyReactSolution(Components.Solution solution, IEntity owner)
        {
            ...
            Logger.Error($"{nameof(Components.Solution)} on {owner} (Uid: {owner.Uid}) could not finish reacting in under {MaxReactionIterations} loops.");
        }
        ...
        /// </summary>
        public void FullyReactSolution(Components.Solution solution, IEntity owner, ReagentUnit maxVolume)
        {
            for (var i = 0; i < MaxReactionIterations; i++)
            {
                var products = ProcessReactions(solution, owner);
