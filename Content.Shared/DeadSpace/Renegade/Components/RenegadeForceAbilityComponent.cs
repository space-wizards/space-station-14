...
public sealed partial class RenegadeForceAbilityComponent : Component
{
    [DataField]
    public EntProtoId ActionRenegadeForce = "ActionRenegadeForce";

    [DataField, AutoNetworkedField]
    public EntityUid? ActionRenegadeForceEntity;

    [DataField]
    public EntProtoId ActionRenegadeForceOnce = "ActionRenegadeForceOne";

    [DataField, AutoNetworkedField]
    public EntityUid? ActionRenegadeForceOneEntity;
