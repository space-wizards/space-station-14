...
namespace Content.Shared.Physics
{
    ...
    public enum CollisionGroup
    {
        ...
        GhostImpassable = 1 <<  5, // 64 Things impassible by ghosts/observers, ie blessed tiles or forcefields
        Underplating    = 1 <<  6, // 128 Things that are under plating
        Passable        = 1 <<  7, // 256 Things that are passable
