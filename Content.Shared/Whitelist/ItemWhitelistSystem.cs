...
public sealed class ItemWhitelistSystem : EntitySystem
{
    ...
    /// <inheritdoc cref="IsValid(ItemWhitelist,Robust.Shared.GameObjects.EntityUid)"/>
    public bool IsValid(ItemWhitelist list, [NotNullWhen(true)] EntityUid? uid)
    {
    ...
    /// </summary>
    public bool CheckBoth([NotNullWhen(true)] EntityUid? uid, ItemWhitelist? blacklist = null, ItemWhitelist? whitelist = null)
    {
        if (uid == null)
            return false;
    ...
    /// </summary>
    public bool IsValid(ItemWhitelist list, EntityUid uid)
    {
    ...
    public bool IsPrototypeValid(ItemWhitelist list, EntityPrototype prototype)
    {
        if (list.Components != null)
            EnsureRegistrations(list);
    ...
    /// to help make code that uses ItemWhitelist a bit more readable because at the moment
    ...
    public bool IsPrototypeWhitelistPass(ItemWhitelist? whitelist, EntityPrototype prototype)
    {
    ...
    public bool IsPrototypeWhitelistFail(ItemWhitelist? whitelist, EntityPrototype prototype)
    {
        return whitelist != null && !IsPrototypeValid(whitelist, prototype);
    }
    ...
    public bool IsPrototypeBlacklistPass(ItemWhitelist? blacklist, EntityPrototype prototype)
    {
    ...
    public bool IsPrototypeBlacklistFail(ItemWhitelist? blacklist, EntityPrototype prototype)
    {
    ...
    /// </summary>
    public bool IsWhitelistPass(ItemWhitelist? whitelist, EntityUid uid)
    {
        if (whitelist == null)
            return false;
    ...
    /// </summary>
    public bool IsWhitelistFail(ItemWhitelist? whitelist, EntityUid uid)
    {
        if (whitelist == null)
            return false;
    ...
    /// </summary>
    public bool IsWhitelistPassOrNull(ItemWhitelist? whitelist, EntityUid uid)
    {
        if (whitelist == null)
            return true;
    ...
    /// </summary>
    public bool IsWhitelistFailOrNull(ItemWhitelist? whitelist, EntityUid uid)
    {
        if (whitelist == null)
            return true;
    ...
    /// </summary>
    public bool IsBlacklistPass(ItemWhitelist? blacklist, EntityUid uid)
    {
    ...
    /// Duplicate of equivalent Whitelist function
    /// </summary>
    public bool IsBlacklistFail(ItemWhitelist? blacklist, EntityUid uid)
    {
    ...
    /// Duplicate of equivalent Whitelist function
    /// </summary>
    public bool IsBlacklistPassOrNull(ItemWhitelist? blacklist, EntityUid uid)
    {
    ...
    /// Duplicate of equivalent Whitelist function
    /// </summary>
    public bool IsBlacklistFailOrNull(ItemWhitelist? blacklist, EntityUid uid)
    {
        return IsWhitelistFailOrNull(blacklist, uid);
    }

    private void EnsureRegistrations(ItemWhitelist list)
    {
        if (list.Components == null)
            return;
        ...
        foreach (var name in list.Components)
        {
            ...
            {
                Log.Warning($"Unknown component name {name} passed to ItemWhitelist!");
            }
        }
    }
}
