...
public sealed partial class HitscanBasicRaycastSystem : EntitySystem
{
    ...
    [Dependency] private HitscanBasicEffectsSystem _hitscanBasicEffects = default!;
    ...
    private void OnHitscanFired(Entity<HitscanBasicRaycastComponent> ent, ref HitscanTraceEvent args)
    {
        ...
        _hitscanBasicEffects.FireEffects(args.FromCoordinates, distanceTried, args.ShotDirection.ToAngle(), ent.Owner);
