...
namespace Content.Shared.Maps
{
    public static class TurfHelpers
    {
        ...
        public static IEnumerable<IEntity> GetEntitiesInTile(this TileRef turf, LookupFlags flags = LookupFlags.Contained, IEntityLookup? lookupSystem = null)
        {
        ...
        ///     Helper that returns all entities in a turf.
        /// </summary>
        public static IEnumerable<IEntity> GetEntitiesInTile(this EntityCoordinates coordinates, LookupFlags flags = LookupFlags.Contained, IEntityLookup? lookupSystem = null)
        {
        ...
        ///     Helper that returns all entities in a turf.
        /// </summary>
        public static IEnumerable<IEntity> GetEntitiesInTile(this Vector2i indices, GridId gridId, LookupFlags flags = LookupFlags.Contained, IEntityLookup? lookupSystem = null)
        {
