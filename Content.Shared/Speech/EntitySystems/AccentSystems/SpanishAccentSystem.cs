...
public sealed class SpanishAccentSystem : AccentSystem<SpanishAccentComponent>
{
    public override string Accentuate(Entity<SpanishAccentComponent>? entity, string message)
    {
