...
public sealed class MobsterAccentSystem : AccentSystem<MobsterAccentComponent>
{
    ...
    public override string Accentuate(Entity<MobsterAccentComponent>? entity, string message)
    {
        // Order:
        ...
        if (_random.Prob(0.4f))
        {
            ...
            var suffix = "";
            if (entity != null && entity.Value.Comp.IsBoss)
            {
