...
public sealed class GermanAccentSystem : AccentSystem<GermanAccentComponent>
{
    ...
    public override string Accentuate(Entity<GermanAccentComponent>? entity, string message)
    {
        var msg = message;
