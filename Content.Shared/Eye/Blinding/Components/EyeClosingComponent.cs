...
public sealed partial class EyeClosingComponent : Component
{
    ...
    public SoundSpecifier EyeOpenSound = new SoundCollectionSpecifier("EyeOpenSound");

    /// <summary>
    /// Path to sound to play when closing eyes
    /// </summary>
    [ViewVariables(VVAccess.ReadWrite), DataField, AutoNetworkedField]
    public SoundSpecifier EyeCloseSound = new SoundCollectionSpecifier("EyeCloseSound");
