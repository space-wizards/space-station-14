...
public sealed partial class GeigerComponent : Component
{
    ...
    {
        {GeigerDangerLevel.Low, new SoundCollectionSpecifier("GeigerLowSound")},
        {GeigerDangerLevel.Med, new SoundCollectionSpecifier("GeigerMediumSound")},
        {GeigerDangerLevel.High, new SoundCollectionSpecifier("GeigerHighSound")},
        {GeigerDangerLevel.Extreme, new SoundCollectionSpecifier("GeigerExtremeSound")}
    };
