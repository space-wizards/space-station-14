...
public abstract partial class SharedHandsSystem : EntitySystem
{
    ...
    private bool DropPressed(ICommonSession? session, NetCoordinates coords, NetEntity netEntity)
    {
        if (TryComp(session?.AttachedEntity, out HandsComponent? hands) && hands.ActiveHand != null)
            TryDrop(session.AttachedEntity.Value, hands.ActiveHand, ToCoordinates(coords), handsComp: hands);
