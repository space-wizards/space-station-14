...
public sealed partial class CCVars
{
    ...
    /// <summary>
    /// When true enables clock at the corner of the screen.
    /// </summary>
    public static readonly CVarDef<bool> ClockEnabled =
        CVarDef.Create("ui.clock.enabled", false, CVar.CLIENTONLY | CVar.ARCHIVE);
