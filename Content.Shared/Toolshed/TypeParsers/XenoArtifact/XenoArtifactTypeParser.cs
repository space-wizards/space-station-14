...
public sealed partial class XenoArtifactTypeParser : CustomCompletionParser<ProtoId<EntityPrototype>>
{
    ...
    private static readonly EntProtoId ArtifactDummyShard = "XenoArtifactShardEmpty";
    ...
    public override CompletionResult TryAutocomplete(ParserContext ctx, CommandArgument? arg)
    {
        return CompletionResult.FromHintOptions(
            [
                ...
                new CompletionOption(ArtifactDummyShard, Loc.GetString("command-spawnartifactwithnode-spawn-artifact-shard-hint")),
            ],
