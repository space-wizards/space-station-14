...
/// <summary>
/// A type of <see cref="EntityEffect"/> which modifies the attribute of a Seed in a PlantHolder.
...
public abstract partial class BasePlantAdjustAttribute<T> : EntityEffect where T : BasePlantAdjustAttribute<T>
{
    /// <summary>
