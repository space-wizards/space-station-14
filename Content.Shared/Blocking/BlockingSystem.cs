...
public sealed partial class BlockingSystem : EntitySystem
{
    ...
    private void OnVerbExamine(EntityUid uid, BlockingComponent component, GetVerbsEvent<ExamineVerb> args)
    {
        ...
        msg.AddMarkupPermissive(Loc.GetString("blocking-fraction", ("value", MathF.Round(fraction * 100, 1))));
    ...
    private void AppendCoefficients(DamageModifierSet modifiers, FormattedMessage msg)
    {
        ...
        {
            msg.PushNewline();
            msg.AddMarkupPermissive(Robust.Shared.Localization.Loc.GetString("blocking-coefficient-value",
        ...
        {
            msg.PushNewline();
            msg.AddMarkupPermissive(Robust.Shared.Localization.Loc.GetString("blocking-reduction-value",
                ("type", flat.Key),
                ("value", flat.Value)
            ));
        }
