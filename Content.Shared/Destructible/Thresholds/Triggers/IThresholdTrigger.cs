...
public interface IThresholdTrigger : IComparable<IThresholdTrigger>, IEquatable<IThresholdTrigger>
{
    ...
    /// <param name="system">
    /// An instance of <see cref="DestructibleSystem"/> to pull dependencies from, if any.
    /// </param>
    /// <returns>true if this trigger has been reached, false otherwise.</returns>
    bool Reached(Entity<DamageableComponent> damageable, DestructibleSystem system);
}
