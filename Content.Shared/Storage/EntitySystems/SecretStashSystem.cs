...
public sealed class SecretStashSystem : EntitySystem
{
    ...
    private bool TryStashItem(Entity<SecretStashComponent> entity, EntityUid userUid, EntityUid itemToHideUid)
    {
        ...
        _audio.PlayPredicted(entity.Comp.TryInsertItemSound, entity, userUid, AudioFun.FunAudioParams(AudioParams.Default.WithVariation(0.25f)));
    ...
    private bool TryGetItem(Entity<SecretStashComponent> entity, EntityUid userUid)
    {
        ...
        _audio.PlayPredicted(entity.Comp.TryRemoveItemSound, entity, userUid, AudioFun.FunAudioParams(AudioParams.Default.WithVariation(0.25f)));
