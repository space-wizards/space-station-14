...
public sealed class StorageFillVisualizerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<StorageFillVisualizerComponent, EntInsertedIntoContainerMessage>(OnInserted, after: [typeof(SharedStorageSystem)]);
        SubscribeLocalEvent<StorageFillVisualizerComponent, EntRemovedFromContainerMessage>(OnRemoved, after: [typeof(SharedStorageSystem)]);
    }
