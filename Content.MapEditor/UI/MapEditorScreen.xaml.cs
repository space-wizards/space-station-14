...
public sealed partial class MapEditorScreen : UIScreen
{
    ...
    // Entity prototypes cached for filtering. Display = "Name [ID]" or just ID.
    private readonly List<(string Display, string ProtoId)> _allEntityProtos = new();
    ...
    public MapEditorScreen()
    {
        ...
        AddToolButton("entityplace", "EP");
        AddToolButton("entityselect", "ES");
    ...
    public void PopulateEntityPalette(IPrototypeManager protoManager)
    {
        ...
        foreach (var proto in protoManager.EnumeratePrototypes<EntityPrototype>())
        {
            ...
            _allEntityProtos.Add((display, proto.ID));
        }
    ...
    private void RefreshEntityList(string filter)
    {
        ...
        foreach (var (display, protoId) in _allEntityProtos)
        {
            if (!string.IsNullOrEmpty(filter) &&
            ...
            EntityList.AddItem(display, metadata: protoId);
            count++;
