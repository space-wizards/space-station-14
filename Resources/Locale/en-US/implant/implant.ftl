...
implanter-component-implanting-target = {$user} { CONJUGATE-BE($userEnt) } trying to implant you with something!
...
implanter-component-implant-already = {$target} already { CONJUGATE-HAVE($targetEnt) } the {$implant}!
