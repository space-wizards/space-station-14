...
reagent-name-ice = juice that makes you hydrated but cold
reagent-desc-ice = Frozen water.

reagent-name-dry-ramen = juice that is cheap food
reagent-desc-dry-ramen = Dry noodles and salt.

reagent-name-hot-ramen = juice that you can believe in
reagent-desc-hot-ramen = Hot noodles.

reagent-name-pilk = juice that makes you question life choices
reagent-desc-pilk = A sickening mixture of milk and cola.

reagent-name-posca = juice that the romans drank or something like that
reagent-desc-posca = Poor warriors' drink from a forgotten era.

reagent-name-mopwata = juice that janitors love the most
