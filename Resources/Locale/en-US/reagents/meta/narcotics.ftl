...
reagent-desc-ephedrine = A caffeinated adrenaline stimulator chemical that makes you faster and harder to push down. Also helps combat narcolepsy at dosages over thirty, at the cost of severe nerval stress.
...
reagent-desc-thc-oil = Pure THC oil, extracted from the leaves of the cannabis plant. Much stronger than its natural form.
...
reagent-desc-impedrezene = A narcotic that impedes one's ability by slowing down the higher brain cell functions - that is if someone bothered coding that.
