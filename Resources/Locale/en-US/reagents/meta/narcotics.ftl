...
reagent-name-t-h-c = THC
reagent-desc-t-h-c = The main psychoactive compound in cannabis.
reagent-name-t-h-c-oil = THC oil
reagent-desc-t-h-c-oil = Pure THC oil, extracted from the leaves of the cannabis plant. Much stronger than in it's natural form and can be used to numb chronic pain in patients.
