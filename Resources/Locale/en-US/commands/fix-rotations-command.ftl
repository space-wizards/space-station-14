...
cmd-fixrotations-grid-no-entity = Grid {$gridId} doesn't have an associated grid entity.
cmd-fixrotations-changed = Changed {$changed} entities. If things seem wrong, reconnect.
