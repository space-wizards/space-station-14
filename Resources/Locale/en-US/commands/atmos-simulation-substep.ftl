...
cmd-substepatmos-help = Usage: substepatmos <EntityUid>
...
completion-grid-substep = EntityUid of the grid you want to substep. Automatically uses the grid you're standing on if empty.
