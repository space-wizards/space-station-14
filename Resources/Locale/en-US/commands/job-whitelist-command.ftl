...
cmd-jobwhitelistadd-help = Usage: {$command} <username> <job>
...
cmd-jobwhitelistget-help = Usage: {$command} <username>
...
cmd-jobwhitelistget-whitelisted-for = "Player {$player} is whitelisted for:
    {$jobs}"
cmd-jobwhitelistget-invalid-args = Invalid amount of arguments.

cmd-jobwhitelistremove-desc = Removes a player's ability to play a whitelisted job.
cmd-jobwhitelistremove-help = Usage: {$command} <username> <job>
