...
cmd-xenoartifact-commands-failed-to-find-artifact = Provided uid {$uid} does not reference valid artifact entity (either does not exist or doesn't have XenoArtifactComponent)
cmd-xenoartifact-commands-failed-to-find-node = Provided uid {$uid} does not reference valid artifact node entity (either does not exist or doesn't have XenoArtifactNodeComponent)
cmd-xenoartifact-commands-artifact-hint = <artifact uid>
cmd-xenoartifact-commands-node-hint = <node uid>
cmd-xenoartifact-commands-effect-type-hint = <ent proto id for xeno artifact effect>
cmd-xenoartifact-commands-trigger-type-hint = <proto id for xeno artifact trigger>
