...
atmos-debug-command-range-help = {$command} <start> <end>
...
atmos-debug-command-mode-help = {$command} <TotalMoles/GasMoles/Temperature> [<gas ID (for GasMoles)>]
...
atmos-debug-command-mode-error-oor = Gas ID not parsable or out of range.
...
atmos-debug-command-cbm-help = {$command} <true/false>
