guidebook-space-station-14-1 = [head=2]Station and Shifts[/head]
...
guidebook-space-station-14-2 = [color=cyan]Station maps[/color] give you an overview of the entire station with colored markers denoting locations of different things.
        Regular [color=cyan]signs[/color] on walls can point you to different departments.

        {"[head=3]Leaving the Station[/head]"}
...
guidebook-space-station-14-3 = If you need to leave a round early, you can do so through a [color=lime]cryogenic sleep unit[/color].
        Simply going inside and leaving the game will store your belongings and ensure that they are not stolen or misused.

        {"[head=3]More Info[/head]"}
