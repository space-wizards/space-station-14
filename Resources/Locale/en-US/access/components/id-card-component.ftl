...
access-id-card-component-owner-name-job-title-text = ID card{$jobSuffix}{$jobSpecSuffix}
access-id-card-component-owner-full-name-job-title-text = {$fullName}'s ID card{$jobSuffix}{$jobSpecSuffix}
