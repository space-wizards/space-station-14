# imp edit - several of these files were renamed to meet our namespace standards

marking-DionaThornsHead-thorns = Diona Head (Thorns)
marking-DionaThornsHead = Diona Head (Thorns)

marking-DionaThornsBody-thorns = Diona Chest (Thorns)
marking-DionaThornsBody = Diona Chest (Thorns)

marking-DionaFlowersHead-flowers = Diona Head (Flowers)
marking-DionaFlowersHead = Diona Head (Flowers)

marking-DionaFlowersBody-flowers = Diona Chest (Flowers)
marking-DionaFlowersBody = Diona Chest (Flowers)

marking-DionaLeafCover-leafcover = Diona Chest (Leaf)
