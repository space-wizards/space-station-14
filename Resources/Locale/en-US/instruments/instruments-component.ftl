...
instruments-component-channels-single = Channel {$channel}: {$name}
instruments-component-channels-multi = Channel {$channel}: {$name} - ({$other})

swappable-instrument-component-style-set = Style set to "{$style}"

instruments-component-menu-midi-channel-default = Unknown Instrument
...
instruments-unknown-channel = UNKNOWN CHANNEL
