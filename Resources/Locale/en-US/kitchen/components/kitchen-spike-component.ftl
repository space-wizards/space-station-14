...
comp-kitchen-spike-kill = { CAPITALIZE(THE($user)) } { CONJUGATE-HAVE($userEnt) } forced { THE($victim) } onto { THE($this) }, killing { OBJECT($victimEnt)} instantly!

comp-kitchen-spike-suicide-other = { CAPITALIZE(THE($victim)) } { CONJUGATE-HAVE($victimEnt) } thrown { REFLEXIVE($victimEnt) } on { THE($this) }!
