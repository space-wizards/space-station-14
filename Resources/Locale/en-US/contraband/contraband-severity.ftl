...
contraband-examine-text-GrandTheftSpiderClan = [color=red]This item is a highly valuable target for Spider Clan agents![/color]
contraband-examine-text-Syndicate = [color=crimson]This item is highly illegal Syndicate contraband![/color]
contraband-examine-text-SpiderClan = [color=#33cc00]This item is highly illegal Spider Clan contraband![/color]
