...
contraband-examine-text-Highly-Illegal = [color={$color}]This item is highly illegal contraband![/color]
contraband-examine-text-Syndicate = [color={$color}]This item is highly illegal Syndicate contraband![/color]
contraband-examine-text-Magical = [color={$color}]This item is highly illegal magical contraband![/color]
