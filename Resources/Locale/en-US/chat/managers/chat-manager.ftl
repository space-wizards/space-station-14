...
chat-manager-entity-whisper-wrap-message = [font size=11][BubbleHeader][Name]{$entityName}[/Name][/BubbleHeader] whispers [italic]"[BubbleContent]{$message}[/BubbleContent]"[/italic][/font]
