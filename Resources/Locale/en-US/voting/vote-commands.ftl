...
cmd-createvote-help = Usage: {$command} <'restart'|'preset'|'map'>
...
cmd-customvote-help = Usage: {$command} <title> <option1> <option2> [option3...]
...
cmd-vote-help = Usage: {$command} <voteId> <option>
...
cmd-listvotes-help = Usage: {$command}

## 'cancelvote' command

cmd-cancelvote-desc = Cancels an active vote.
cmd-cancelvote-help = Usage: {$command} <id>
