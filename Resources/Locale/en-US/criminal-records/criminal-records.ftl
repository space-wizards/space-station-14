...
criminal-records-console-not-suspected = {$name} has been cleared as a suspect by {$officer_name}.
...
criminal-records-console-not-wanted = {$name} is no longer wanted, according to {$officer_name}.
criminal-records-console-paroled = {$name} has been released on parole by {$officer}.
criminal-records-console-not-parole = {$name}'s parole status has been lifted by {$officer_name}.
