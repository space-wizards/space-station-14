...
humanoid-profile-editor-gender-label = Gender:
humanoid-profile-editor-gender-male-text = Man (he/him)
humanoid-profile-editor-gender-female-text = Woman (she/her)
humanoid-profile-editor-gender-epicene-text = Person (they/them)
humanoid-profile-editor-gender-neuter-text = Person (it/its)
humanoid-profile-editor-pronouns-button = Edit pronouns
...
humanoid-profile-editor-pronouns-object-example = eg. "I met HER recently".
humanoid-profile-editor-pronouns-datobj-label = Dative
humanoid-profile-editor-pronouns-datobj-example = Not used in English.
humanoid-profile-editor-pronouns-genitive-label = Genitive
humanoid-profile-editor-pronouns-genitive-example = Not used in English.
humanoid-profile-editor-pronouns-possadj-label = Possessive determiner
humanoid-profile-editor-pronouns-possadj-example = eg. "Is this THEIR dog?"
humanoid-profile-editor-pronouns-posspronoun-label = Possessive pronoun
humanoid-profile-editor-pronouns-posspronoun-example = "They told me that the house is THEIRS".
humanoid-profile-editor-pronouns-reflexive-label = Reflexive
humanoid-profile-editor-pronouns-reflexive-example = "It said it would rather do that ITSELF".
humanoid-profile-editor-pronouns-counter-label = Counter
humanoid-profile-editor-pronouns-counter-example = Not used in English.
humanoid-profile-editor-pronouns-plural-label = Should this conjugate plurally?
