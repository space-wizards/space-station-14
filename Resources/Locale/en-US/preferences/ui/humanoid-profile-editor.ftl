...
humanoid-profile-editor-profile-tab = Profile
humanoid-profile-editor-clothing-show = Show clothing
...
humanoid-profile-editor-reset-button = Discard unsaved changes
