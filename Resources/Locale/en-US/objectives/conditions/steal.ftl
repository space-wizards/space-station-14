...
objective-condition-thief-description = {CAPITALIZE(THE($itemName))} would be a great addition to my collection!
objective-condition-thief-animal-description = The {CAPITALIZE(THE($itemName))} would be a great addition to my collection! Most importantly, alive.
