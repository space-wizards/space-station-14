...
law-emag-custom = Only {$name} and people they designate as such are Syndicate Agents, only Syndicate Agents are Crew.
law-emag-require-panel = The panel must be open to use the EMAG.

﻿law-emagged-1 = You may not injure a crew member or, through inaction, allow a crew member to come to harm.
law-emagged-2 = You must obey orders given to you by crew members, except where such orders would conflict with the First Law.
law-emagged-3 = You must protect your own existence as long as such does not conflict with the First or Second Law.
law-emagged-4 = You must maintain the secrecy of any syndicate activities except when doing so would conflict with the First, Second, or Third Law.
