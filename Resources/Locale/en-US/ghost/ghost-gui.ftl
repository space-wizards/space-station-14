...
ghost-role-groups-window-state-text-label-editing = Being Edited
ghost-role-groups-window-state-text-label-released = Released
ghost-role-groups-window-release-button = Release
ghost-role-groups-window-released-button = Released
ghost-role-groups-start-window-title = Start Role Group
...
ghost-role-groups-delete-window-title = Delete Role Group
