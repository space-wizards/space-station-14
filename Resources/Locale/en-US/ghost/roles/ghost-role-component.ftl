...
ghost-role-information-terminator-description = You been been sent back in time to terminate a target with high importance to the future. You are an antagonist and may kill anyone that gets in your way, but the target is always top priority.
