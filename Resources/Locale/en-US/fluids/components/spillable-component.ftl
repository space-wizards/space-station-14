...
spill-melee-hit-attacker = You spill {$amount}u of {THE($spillable)} onto {$target}!
spill-melee-hit-others = {CAPITALIZE(THE($attacker))} spills some of {THE($spillable)} onto {$target}!

spill-land-spilled-on-other = {CAPITALIZE(THE($spillable))} spills some of its solution onto {$target}!
