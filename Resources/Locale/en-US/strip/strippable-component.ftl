...
strippable-component-alert-owner = {$user} { CONJUGATE-BE($userEnt) } removing your {$item}!
strippable-component-alert-owner-hidden = You feel someone fumbling in your {$slot}!
strippable-component-alert-owner-insert = {$user} { CONJUGATE-BE($userEnt) } putting {$item} on you!
strippable-component-alert-owner-insert-hand = {$user} { CONJUGATE-BE($userEnt) } putting {$item} in your hand!
