...
chat-radio-message-wrap = [color={$color}]{$channel} [bold][Name]{$name}[/Name][/bold] {$verb}, [font={$fontType} size={$fontSize}]"{$message}"[/font][/color]
chat-radio-message-wrap-bold = [color={$color}]{$channel} [bold][Name]{$name}[/Name][/bold] {$verb}, [font={$fontType} size={$fontSize}][bold]"{$message}"[/bold][/font][/color]
