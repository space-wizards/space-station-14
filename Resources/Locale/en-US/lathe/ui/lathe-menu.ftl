...
lathe-menu-delete-fabricating-tooltip = Delete the currently printing job.
lathe-menu-delete-item-tooltip = Delete the job from the queue.
lathe-menu-move-up-tooltip = Move the job ahead in the queue.
lathe-menu-move-down-tooltip = Move the job back in the queue.
