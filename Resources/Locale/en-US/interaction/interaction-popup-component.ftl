...
petting-success-bearfoot = You pet {THE($target)} on {POSS-ADJ($target)} fluffy and silly head.
...
petting-failure-bearfoot = You try to pet {THE($target)}, but he jumped from your hands.
