...
petting-success-securitron = You pet {THE($target)} on {POSS-ADJ($target)} polished chassis.
...
petting-failure-securitron = You reach out to pet {THE($target)}, but {SUBJECT($target)} {CONJUGATE-BASIC($target, "order", "orders")} you to keep your distance!
