...
petting-success-holocarp = You pet {THE($target)} on {POSS-ADJ($target)} shimmering little fishy head.
...
petting-failure-holocarp = You reach out to pet {THE($target)}, but {POSS-ADJ($target)} holographic teeth shimmer and almost solidfy in your fingers!
