...
petting-success-boombot = You pet {THE($target)} on {POSS-ADJ($target)} warm metal head.
...
petting-failure-boombot = You reach out to pet {THE($target)}, but {SUBJECT($target)} {CONJUGATE-BE($target)} grooving too hard!
