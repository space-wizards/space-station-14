...
connecting-fallback-connect = Connect
connecting-fallback-recommended = Recommended
connecting-fallback-players = Players: {$players}/{$maxPlayers}
connecting-fallback-label = Consider one of these servers:
connecting-fallback-label-full = Fallback servers are also currently full.
