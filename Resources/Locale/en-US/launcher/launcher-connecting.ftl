...
connecting-available = Connect
connecting-available-recommended = Recommended
connecting-available-player-count = Players: {$players}/{$maxPlayers}
connecting-available-ping = Ping: {$ping}
connecting-available-label = Fallback servers available:
connecting-available-label-unavailable = All fallback servers are currently full.
connecting-switching = Switching to {$target}
