...
uplink-esword-desc = A very dangerous energy sword that can reflect energy projectiles. Can be stored in pockets when turned off. Makes a lot of noise when used or turned on.

uplink-esword-double-name = Double Bladed Energy Sword
uplink-esword-double-desc = A much more expensive counter part to the normal energy sword: with a guaranteed reflection of energy projectiles, larger attack angle, higher attack damage, and higher attack speed. Makes a lot of noise when used or turned on.
