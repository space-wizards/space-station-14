...
uplink-esword-desc = A very dangerous energy sword that can reflect most shots. Can be stored in pockets when turned off. Makes a lot of noise when used or turned on.
