...
uplink-reinforcement-syndiebot-desc =  The latest development of the syndicate's roboticists! It teleports to you SyndieBot. It is equipped with an advanced laser gun and an energy dagger. It also has a built-in weak stealth function.. Maybe it is a NinjaBot after all?
