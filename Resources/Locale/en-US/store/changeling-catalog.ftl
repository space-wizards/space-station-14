...
changeling-catalog-stimulant-sting-name = Stimulant Sting
changeling-catalog-stimulant-sting-desc = Causes the target to be filled with adrenaline. Can be and should be used on self.
