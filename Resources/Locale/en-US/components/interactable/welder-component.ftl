...
welder-component-suicide-lit-others-message = {$victim:theName} welds {$victim:their} every orifice closed! It looks like {$victim:theyre} trying to commit suicide!
welder-component-suicide-lit-message = You weld your every orifice closed!
welder-component-suicide-unlit-others-message = {$victim:theName} bashes themselves with the unlit welding torch!
