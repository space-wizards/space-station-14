crematorium-entity-storage-component-on-examine-details-is-burning = The {$owner:theName} is [color=red]active[/color]!
...
crematorium-entity-storage-component-suicide-message-others = {$victim:theName} is cremating {$victim:themself}!
