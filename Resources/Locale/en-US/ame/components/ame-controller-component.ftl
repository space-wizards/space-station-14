...
ame-window-engine-injection-status-overloaded-label = Overload warning! Reduce injection immediately!
ame-window-engine-injection-status-underloaded-label = Injection levels low! AME operating at reduced efficiency!
