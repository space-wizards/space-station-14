...
ame-window-engine-injection-status-safetyLock-label = SAFETY PROTOCOL ACTIVE:
ame-window-engine-injection-status-safetyLock-description = Injection temporarily capped to prevent overload.
ame-window-engine-injection-status-overload-label = Overload detected!
ame-window-engine-injection-status-overload-description = Monitor systems immediately.
