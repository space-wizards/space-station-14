# Antag role names and objectives (character setup screen)
...
# Briefing
adventurer-role-greeting =
    You are a member of an adventuring party!
    A mighty dungeon full of loot drifts through this sector, its halls ruled by tyrannical bosses.
    Gather your party, venture forth, slay the "heads of staff", and take everything that isn't nailed down.
    The dice decide your fate: attacks against you must beat your armor class or they are naught but a scratch.

# Round end
adventurer-round-end-agent-name = adventurer

# Game preset
adventurers-title = Adventurers
adventurers-description = A party of four heroes from a bygone age descends upon the station to clear it like the dungeon it is.
