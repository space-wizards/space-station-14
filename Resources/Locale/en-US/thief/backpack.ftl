...
thief-backpack-category-chameleon-description =
    ...
    Includes: A full set of chameleon clothing with Agent ID, a chameleon projector, and a fake mindshield implant. Disguise as anyone and anything.
...
thief-backpack-category-tools-description =
    ...
    Includes: Two C4, a multitool, remote signaller, jaws of life, advanced welder, engineering goggles, and insulated gloves.
...
thief-backpack-category-chemistry-description =
    ...
    Includes: Storage implanter, DNA scrambler implanter, ephedrine bottle, syringe, empty shaker, and omega soap.
...
thief-backpack-category-syndie-description =
    ...
    Includes: An Emag, Access Breaker, Interdyne cigs, a Syndicate codeword, a Radio Jammer, a lighter, and some strange red crystals.

thief-backpack-category-sleeper-name = Sleeper Kit
thief-backpack-category-sleeper-description =
    Until we close our eyes for good, use your illegal prescriptions to keep others asleep.
    Includes: Sleepy nitrous oxide tank, two nocturine bottles, and a hypopen.

thief-backpack-category-communicator-name = Communicator Kit
thief-backpack-category-communicator-description =
    Money is power, and secrets are money. Use your silver tongue and wealth to subvert the station.
    Includes: Master key for all station channels, a CyberSun pen, voice mask implanter, and 20k spesos inside a briefcase.

thief-backpack-category-smuggler-name = Smuggler Kit
thief-backpack-category-smuggler-description =
    All thieves need somewhere to stash their goods in the dark. Don't forget to link your fulton.
    Includes: Fulton beacon, 10 fultons, 3 smoke grenades, and an invisible crate to hide valuable loot.
