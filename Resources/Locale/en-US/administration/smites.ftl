...
admin-trick-rename-description = Renames the given object. This is equivalent to the `rename` command and will change their ID as well.
...
admin-trick-rename-character-description = Renames the given character and saves it to their character profile.
