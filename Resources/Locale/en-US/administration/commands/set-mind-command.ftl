...
cmd-setmind-target-has-no-content-data-message = Target player does not have content data (wtf?)
cmd-setmind-target-has-no-mind-message = Target entity does not have a mind (did you forget to make sentient?)
