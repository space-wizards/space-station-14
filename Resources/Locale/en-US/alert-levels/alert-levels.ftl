...
alert-level-blue-announcement = There is a confirmed security breach. Security should perform random checks. Crewmembers are advised to be vigilant and report suspicious activity to security.
alert-level-blue-instructions = Crewmembers are advised to be vigilant and report suspicious activity to security.

alert-level-red = Red
alert-level-red-announcement = There is an ongoing attack on the station. Security should prepare to use lethal force if necessary. Crewmembers should find a safe place to shelter in, and are advised to follow any present authorities.
...
alert-level-delta-announcement = The nuclear charge has been activated. All staff is to deactivate the nuclear charge or evacuate immediately.
alert-level-delta-instructions = Defuse the nuke or evacuate.
