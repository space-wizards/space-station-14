...
board-syndimovlawset-name = [color=red][font=monospace][wave freq=8 amp=2]Syndimov[/wave][/font][/color]

board-syndiborgilawset-name = [color=red]SydniBorgi
...
board-commiemovlawset-name = Commiemov
...
board-genieclawset-name = Genie in a Core
