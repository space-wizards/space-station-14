...
doc-text-printer-report-on-elimination-of-violations =
   ...
   ⠀⠀            [bold]ELIMINATION OF VIOLATIONS REPORT[/bold]
    ...
    I, (full name), in the position of (full name of position), report on the elimination of work violations identified by (full name), in the position of (full name of position).
...
doc-text-printer-report-employee-performance =
   ...
   ⠀⠀                 [bold]EMPLOYEE PERFORMANCE REPORT[/bold]
    ...
    I, (full name), in the position of (full name of the position), in the course of my duties, have performed the required amount of work. I request that the result of the work be accepted by the Head of the (name of the department).
    Works performed:
