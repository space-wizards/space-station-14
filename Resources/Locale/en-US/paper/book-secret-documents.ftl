book-text-sec-doc-1 = Only the Head of Security has the right to read these documents, if you are not, close them immediately, or you will be sentenced to execution on the spot.

    The Emergency Security Orders listed here are only executed by direct order of Central Command, properly executed, and using all necessary codes. If the conditions are not met, the orders are considered invalid Secret documents must not be seen by ANYONE but the Head of Security, and they must NEVER fall into the wrong hands.
    ...
    ORDER №13: Arrest the RD and take them to the Central Command.
    ORDER №14: Arrest the CMO and take them to the Central Command.
    ORDER №15: Arrest the HoP and take them to the Central Command.
    ORDER №16: Arrest the CE and take them to the Central Command.
    ORDER №17: Arrest the QM and take them to the Central Command.
    ORDER №20: Arrest the Captain and take them to the Central Command.
    ORDER №25: Carry out the arrest of all non-employees of the NanoTrasen.
    ...
    ORDER №44: Carry out complete isolation of departments, take away ID cards from all NanoTrasen employees below the heads.
    ORDER №45: Conduct a complete isolation of departments, take away the ID cards of all NanoTrasen employees.
    ...
    ORDER №56: Eliminate all non-NanoTrasen alien species on detection.
    ORDER №59: Arrest all non-NanoTrasen alien species.
