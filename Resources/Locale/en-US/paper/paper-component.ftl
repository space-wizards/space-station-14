...
paper-component-action-sign-paper-other = {CAPITALIZE(THE($user))} signs {THE($target)} with {THE($stamp)}.
paper-component-action-sign-paper-self = You sign {THE($target)} with {THE($stamp)}.
...
paper-protected-modified-message = This page cannot be modified without special means.
paper-locked-modified-message = This page was written using tamper-proof ink.

paper-verb-sign = Sign
