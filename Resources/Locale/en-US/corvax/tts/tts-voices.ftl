...
tts-voice-name-illidan_f = Иллидан Ф (Warcraft 3)
tts-voice-name-dread_bm = Повелитель ужаса БМ (Warcraft 3)
tts-voice-name-dread_t = Повелитель ужаса Т (Warcraft 3)
tts-voice-name-vort_e2 = Вортигонт Э2 (Half-life 2)
tts-voice-name-gman_e2 = Джи-Мэн Э2 (Half-life 2)
tts-voice-name-sniper_tf = Снайпер ТФ (Team Fortress 2)
tts-voice-name-elf_eng = Эльф Инж (Warcraft 3)
tts-voice-name-naga_m = Нага М (Warcraft 3)
tts-voice-name-naga_rg = Нага РГ (Warcraft 3)
tts-voice-name-peasant_w = Крестьянин В (Warcraft 3)
tts-voice-name-sylvanas_w = Сильвана В (Warcraft 3)
tts-voice-name-dr_mundo = Док. Мундо (LoL)
tts-voice-name-renata_glasc = Рената Гласк (LoL)
tts-voice-name-soldier_76 = Солдат 76 (Overwatch)
tts-voice-name-training_robot = Тренировочный робот (Overwatch)
tts-voice-name-m_darkelf = Тёмный эльф (Skyrim)
tts-voice-name-m_argo = Мужчина надменный (Skyrim)
tts-voice-name-m_khajiit = Каджит (Skyrim)
tts-voice-name-m_coward = Мужчина трусливый (Skyrim)
tts-voice-name-m_drunk = Мужчина пьяный (Skyrim)
tts-voice-name-f_khajiit = Каджитка (Skyrim)
tts-voice-name-m_citizen = Горожанин (Skyrim)
tts-voice-name-m_orc = Орк (Skyrim)
tts-voice-name-m_child = Мальчик (Skyrim)
tts-voice-name-witchdoctor_h = Знахарь (Heroes of the Storm)
tts-voice-name-dr_boom = Доктор Бум (Hearthstone)
tts-voice-name-ol_toomba = Старина Тумба (Hearthstone)
tts-voice-name-maiev_hs = Майев (Hearthstone)
tts-voice-name-tekahn_boss = Текан (Hearthstone)
tts-voice-name-olaf_lol = Олаф (LoL)
tts-voice-name-lucio_ov = Лусио (Overwatch)
tts-voice-name-dva_ov = Д.Ва (Overwatch)
tts-voice-name-junker_queen = Королева Юнкеров (Overwatch)
tts-voice-name-f_shrill = Женщина пронзительная (Skyrim)
tts-voice-name-m_haughty = Мужчина высокомерный (Skyrim)
tts-voice-name-m_soldier = Солдат (Skyrim)
tts-voice-name-f_sultry = Женщина томная (Skyrim)
tts-voice-name-m_commander = Командир (Skyrim)
tts-voice-name-f_nord = Нордка (Skyrim)
tts-voice-name-f_haughty = Женщина высокомерная (Skyrim)
tts-voice-name-m_nord = Норд (Skyrim)
tts-voice-name-f_commander = Командирша (Skyrim)
tts-voice-name-f_argo = Женщина надменная (Skyrim)
tts-voice-name-f_coward = Женщина трусливая (Skyrim)
tts-voice-name-m_guard = Стражник (Skyrim)
tts-voice-name-m_commoner = Простолюдин (Skyrim)
tts-voice-name-f_commoner = Простолюдинка (Skyrim)
tts-voice-name-f_child = Девочка (Skyrim)
tts-voice-name-f_orc = Орчиха (Skyrim)
tts-voice-name-f_darkelf = Тёмная эльфийка (Skyrim)
tts-voice-name-m_bandit = Бандит (Skyrim)
tts-voice-name-m_forsworn = Изгой (Skyrim)
tts-voice-name-malfurion_h = Малфурион (Heroes of the Storm)
tts-voice-name-kerrigan_h = Керриган (Heroes of the Storm)
tts-voice-name-greymane_h = Седогрив (Heroes of the Storm)
tts-voice-name-valeera_hs = Валира (Hearthstone)
tts-voice-name-dr_sezavo = Доктор Сезаво (Hearthstone)
tts-voice-name-yrel_hs = Ирэль (Hearthstone)
tts-voice-name-tyrande_hs = Тиранда (Hearthstone)
tts-voice-name-lady_vashj = Леди Вайш (Hearthstone)
tts-voice-name-Cyberpunk_male_v = Ви (муж.) (Cyberpunk 2077)
tts-voice-name-Cyberpunk_johny = Джонни Сильверхенд (Cyberpunk 2077)
tts-voice-name-Cyberpunk_takemura = Такэмура (Cyberpunk 2077)
tts-voice-name-Cyberpunk_sobchak = Собчак (Cyberpunk 2077)
tts-voice-name-Cyberpunk_jackie = Джеки Уэллс (Cyberpunk 2077)
tts-voice-name-Cyberpunk_kerry = Керри Евродин (Cyberpunk 2077)
tts-voice-name-Cyberpunk_mitch = Митч (Cyberpunk 2077)
tts-voice-name-Cyberpunk_saul = Сол (Cyberpunk 2077)
tts-voice-name-Cyberpunk_haru = Хару (Cyberpunk 2077)
tts-voice-name-Cyberpunk_victor = Виктор Вектор (Cyberpunk 2077)
tts-voice-name-Cyberpunk_placide = Пласид (Cyberpunk 2077)
tts-voice-name-Cyberpunk_dexter = Декстер ДеШон (Cyberpunk 2077)
tts-voice-name-Cyberpunk_sebastian = Себастьян (Cyberpunk 2077)
tts-voice-name-Cyberpunk_jefferson = Джефферсон (Cyberpunk 2077)
tts-voice-name-Cyberpunk_joshua = Джошуа (Cyberpunk 2077)
tts-voice-name-tlou_ellie = Элли (The Last of Us)
tts-voice-name-tlou_joel = Джоэл (The Last of Us)
tts-voice-name-tlou_tess = Тесс (The Last of Us)
tts-voice-name-Deep_rock_galactic_mission_control = Центр управления (Deep Rock Galactic)
tts-voice-name-Deep_rock_galactic_dwarves = Гномы (Deep Rock Galactic)
tts-voice-name-an_alt_girl_inner = Санбой внутренний (AltGirl)
tts-voice-name-an_alt_girl_sunboy_s = Санбой грустный (AltGirl)
tts-voice-name-an_alt_girl_dlc_sunboy_n = Санбой воспитанный (AltGirl)
tts-voice-name-an_alt_girl_dlc_sunboy_k = Санбой спокойный (AltGirl)
tts-voice-name-marine2_titus = Титус (Warhammer)
tts-voice-name-marine2_berserk = Берсерк (Warhammer)
tts-voice-name-marine2_gadriel = Гадриэль (Warhammer)
tts-voice-name-marine2_chairon = Хайрон (Warhammer)
tts-voice-name-marine2_acheran = Ахеран (Warhammer)
tts-voice-name-marine2_machine_spirit_4 = Дух Машины (Warhammer)
tts-voice-name-marine2_magos_galeo = Магос Галео (Warhammer)
tts-voice-name-marine2_servo-skull = Серво-череп (Warhammer)
tts-voice-name-marine2_balthazar = Бальтазар (Warhammer)
tts-voice-name-garrosh = Гаррош
tts-voice-name-deathwing = Смертокрыл
tts-voice-name-b_kalmyk = Калмыцкий
tts-voice-name-b_nog = Ногайский
