...
nuke-component-announcement-armed = Attention! The station's nuclear charge has been armed {$location}. {$time} seconds until detonation. If this was made in error, the nuclear charge may still be disarmed.
nuke-component-announcement-unarmed = The station's nuclear charge was deactivated! Have a nice day!
