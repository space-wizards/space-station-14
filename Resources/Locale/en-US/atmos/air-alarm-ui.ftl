...
air-alarm-ui-thresholds-toggle = Toggle all thresholds
air-alarm-ui-thresholds-toggle-tooltip = Toggles whether each threshold for this sensor is enabled or disabled.
