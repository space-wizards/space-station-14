...
bounty-description-salvage-scrap = We are researching the effects of deep space on station materails, and we need some samples. Find some old junk off of debris and bring it to us.
bounty-description-salvage-ore-gold = We are engaging in an experimental new electronics manufacturing process. Deliver us a large sum of unrefined gold ore. This can be sourced from any kind of geological formation.
...
bounty-description-salvage-ore-plasma = We need a shipment of plasma ore to send over to the research station. Please provide us with some so that we can continue our testing.
bounty-description-salvage-ore-uranium = We need a sample of uranium ore for our ongoing experiments on nuclear devices. Be aware that while the uranium does glow slightly, it will probably not harm you.
