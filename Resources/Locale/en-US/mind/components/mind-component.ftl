...
comp-mind-ai-examined-dead-and-irrecoverable = { CAPITALIZE(SUBJECT($ent)) }'s systems have suffered irreparable damage. Full functionality is impossible, and reactivation is not feasible.
