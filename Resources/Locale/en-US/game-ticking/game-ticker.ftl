...
latejoin-arrival-announcement = {$character} ({$job}) has arrived at the Platform!
latejoin-arrival-sender = Platform
latejoin-arrivals-direction = The diving bell to Trieste will arrive shortly.
latejoin-arrivals-direction-time = The diving bell will arrive in {$time} seconds.
