...
latejoin-arrival-announcement = {$character} ({$job}) { CONJUGATE-HAVE($gender) } arrived at the station!
latejoin-arrival-announcement-special = {$character}, The {$job}, { CONJUGATE-HAVE($gender) } stepped aboard the station!
