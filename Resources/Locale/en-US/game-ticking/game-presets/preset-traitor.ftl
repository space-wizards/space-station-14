...
# TraitorRole
traitor-role-greeting = You are an agent sent by [color=red]{$corporation} on behalf of [color=red]The Syndicate[/color].
    Your objectives and codewords are listed in the character menu.
    Use the uplink loaded into your PDA to buy the tools you'll need for this mission. [bolditalic][color=red]
    Death to Nanotrasen![/color][/bolditalic]
traitor-role-codewords = [color=yellow]The codewords are:
    {$codewords}.[/color]
...
traitor-role-codewords-short =
    The codewords are:
    {$codewords}.
traitor-role-uplink-code-short = [color=yellow][italic]Your uplink code is {$code}. Set it as your PDA ringtone to access uplink.[/italic][/color]
