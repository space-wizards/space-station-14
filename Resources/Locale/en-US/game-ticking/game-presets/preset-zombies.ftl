...
cburn-welcome = You are a CentComm Quarantine Officer, a member of one of Nanotransen's elite CBURN squads. A highly contagious pathogen has appeared on station <insert station name>, and an evacuation shuttle has been called. The infected must not make it to Central Command. You may recover any remaining healthy personnel. Glory to Nanotransen.
cburn-briefing = The infected must not make it to Central Command. You may recover any remaining healthy personnel. Glory to Nanotransen.