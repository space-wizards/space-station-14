...
cloning-console-window-no-scanner-detected-label = Link a genetic scanner with a network configurator.
cloning-console-window-no-clone-pod-detected-label = Link a cloning pod with a network configurator.
