...
ui-options-disable-blurry-vision-tooltip = Replaces the movement in the blurry shader for a static effect.
ui-options-disable-drunk-overlay = Drunk overlay
ui-options-disable-drunk-overlay-tooltip = Replaces the movement in the drunk shader for a static offset.
ui-options-disable-flash-effect = Flash
ui-options-disable-flash-effect-tooltip = Replaces 'flash' effect with a reduced movement equivalent.
...
ui-options-disable-rainbow-overlay-tooltip = Completely disables the rainbow overlay used for the 'high' effect.
