...
ent-WaterVaporCanisterBroken = broken water vapor canister
    .desc = { ent-GasCanisterBrokenBase.desc }
    .suffix = { "" }
ent-MiasmaCanisterBroken = broken miasma canister
    .desc = { ent-GasCanisterBrokenBase.desc }
    .suffix = { "" }
ent-NitrousOxideCanisterBroken = broken nitrous oxide canister
    .desc = { ent-GasCanisterBrokenBase.desc }
    .suffix = { "" }
ent-FrezonCanisterBroken = broken frezon canister
    .desc = { ent-GasCanisterBrokenBase.desc }
    .suffix = { "" }
