...
bounty-item-donk-pockets = Donk Pockets
bounty-item-jugs = Jugs
bounty-item-crushers = Crushers
...
bounty-item-crystals = Crystals
bounty-item-mime-hardsuit = Mime Hardsuit
bounty-item-mime-hardsuit = Telecrystal
...
bounty-description-donk-pockets = URGENT MESSAGE FROM Donk Co: Consumer Safety Recall on DONK-POCKETS products issued within the last (50) years. Contents contain lizard biomatter. Please return for a full refund.
