...
bounty-description-ring = On this EXTRAORDINARY day there will be a wedding between [LINE REMOVE] and [LINE REMOVE], but Mr. [LINE REMOVE] has lost the rings, send a pair of rings.
bounty-description-remains = TWO.REMAINS, please.
bounty-description-plates = Our club is interested in trophies of majestic creatures such as Goliath, send a couple of plates, the reward will not be long in coming.
