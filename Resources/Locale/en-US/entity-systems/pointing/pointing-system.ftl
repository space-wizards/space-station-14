...
pointing-system-point-in-your-inventory-self = You point at your {$item}.
pointing-system-point-in-your-inventory-others = {CAPITALIZE(THE($pointer))} points at {POSS-ADJ($pointer)} {$item}.
pointing-system-point-in-other-inventory-self = You point at {POSS-NOUN(THE($wearer))} {$item}.
pointing-system-point-in-other-inventory-target = {CAPITALIZE(THE($pointer))} points at your {$item}.
pointing-system-point-in-other-inventory-others = {CAPITALIZE(THE($pointer))} points at {POSS-NOUN(THE($wearer))} {$item}.
