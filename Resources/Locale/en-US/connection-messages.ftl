...
ipintel-region-blacklist = This server is region locked, and your connection has been blocked. The following countries are blocked from connecting to this server: {$regions}. If you believe this to be a mistake, contact the server's administration team for assistance.
ipintel-region-whitelist = This server is region locked, and your connection has been blocked. Only the following countries are allowed to connect to this server: {$regions}. If you believe this to be a mistake, contact the server's administration team for assistance.
