...
job-name-ert-leader = ERT Company Commander
job-name-ert-chaplain = ERT Soul Officer
job-name-ert-engineer = ERT Field Engineer
job-name-ert-janitor = ERT Custodian
job-name-ert-security = ERT Field Officer
job-name-ert-medic = ERT Medical Doctor
