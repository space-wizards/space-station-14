...
role-timer-role-job = [color={$departmentColor}]{$job}[/color]
role-timer-role-job-separator = /
role-timer-role-insufficient = You require [color=yellow]{$time}[/color] more playtime with {$jobs} to unlock this.
role-timer-role-too-high = You require[color=yellow] {$time}[/color] less playtime with {$jobs} to select this. (Are you trying to play a trainee role?)
