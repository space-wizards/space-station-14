...
job-description-salvagespec = use the salvage ship to then travel to new planets, while fighting off any space fauna along the way to enrich the station.
job-description-miningspec = Use the salvage magnet to draw in detatched scraps & asteroids to loot and enrich the station with materials.
