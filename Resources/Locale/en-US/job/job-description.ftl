...
job-description-hop = Handle access reassignment fairly using your ID console, manage demotions, change crews jobs on their request with other heads permissions, manage the service department, and keep Ian safe.
...
job-description-intern = Learn the basics of administering medicine, learning basic chemicals and using basic medical tools.
...
job-description-reporter = Entertain & inform the crew with your vibrant journalism through wireless cameras, the radio and the news. Currently available on Bagel Station and Core.
job-description-salvagespec = Use the salvage magnet to draw in detatched scraps & asteroids to loot and enrich the station, build a salvage ship, and then travel to new planets. and fight off any space fauna along the way.
