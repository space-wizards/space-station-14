...
job-description-magistrate = You are the highest legal authority on the station, independent from the chain of command.
...
job-description-nanorep = You are an NT representative and link between CentComm and the station. Make sure, the station works efficient and follows corporate policies, report issues to CentComm.
