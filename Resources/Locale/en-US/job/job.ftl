...
job-greet-supervisors-warning = As the [color=gray]{$jobName}[/color] you answer directly to [color=gray]{$supervisors}[/color]. Special circumstances may change this.
