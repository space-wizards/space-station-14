role-timer-department-insufficient = You require {TOSTRING($time, "0")} more minutes in the {$department} department to play this role.
role-timer-department-too-high = You require {TOSTRING($time, "0")} fewer minutes in the {$department} department to play this role. (Are you trying to play a trainee role?)
