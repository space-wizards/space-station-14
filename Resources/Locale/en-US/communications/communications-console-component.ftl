...
comms-console-menu-broadcast-top-placeholder = Screen top line (max 32 characters)
...
comms-console-menu-broadcast-button-tooltip = Broadcast your message to wall-mounted screens around the station.
