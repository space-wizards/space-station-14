...
alerts-rooted-name = Пустить корни
alerts-rooted-desc = Вы закрепились корнями под собой. Вы не можете подскользнуться, но теперь вы впитываете жидкости под собой.
