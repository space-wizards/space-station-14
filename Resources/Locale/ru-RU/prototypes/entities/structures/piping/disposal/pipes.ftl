...
ent-DisposalSignaller = сигнализатор утилизации
    .desc = Труба, которая издает сигнал, когда через нее проходит какой-либо предмет.
...
.desc = Четырёхстороннее разветвление. Стрелка указывает, куда выходят элементы.
