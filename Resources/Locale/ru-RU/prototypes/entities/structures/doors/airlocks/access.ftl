...
ent-HighSecArmoryLocked = { ent-HighSecDoor }
    .suffix = Оружейная, Закрыт
    .desc = { ent-HighSecDoor.desc }
ent-AirlockNuclearOperativeGlassLocked = { ent-AirlockGlass }
    .suffix = Ядерные Оперативники, Закрыт
    .desc = { ent-AirlockGlass.desc }
ent-AirlockNuclearOperativeGlassLockedExternal = { ent-AirlockExternal }
    .suffix = Ядерные Оперативники, Закрыт, Стеклянный, Внешний
    .desc = { ent-AirlockExternal.desc }
ent-AirlockDetectiveLocked = { ent-HighSecDoor }
    .suffix = Детектив, Закрыт
    .desc = { ent-HighSecDoor.desc }
ent-AirlockDetectiveGlassLocked = { ent-HighSecDoor }
    .suffix = Детектив, Закрыт
    .desc = { ent-HighSecDoor.desc }
ent-AirlockMaintDetectiveLocked = технический шлюз
    .suffix = Детектив, Закрыт
