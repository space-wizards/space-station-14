...
ent-PosterContrabandRouny = Вы его не видели?
    .desc = Старый плакат с объявлением о пропаже инопланетянина. Куда он сбежал?
...
ent-PosterContrabandExoAcid = Предупреждение об экзоморфе: кислотная слюна!
...
ent-PosterContrabandExoRun = Предупреждение об экзоморфе: беги!
    .desc = Этот плакат предупреждает вас о ловком экзоморфе, способном утащить за собой любого, кого поймает, так что не попадайтесь ему!
ent-PosterContrabandExoChomp = Предупреждение об экзоморфах: опасные укусы!
    .desc = Этот плакат предупреждает о смертельных укусах экзоморфов. Не становитесь закуской для пришельцев!
ent-PosterContrabandWaffleCorp = Корпорация Вафель: Отличные винтовки, доступные цены
    .desc = Старая реклама винтовок от Корпорации Вафель. 'Пушки лучше, цены ниже!'
...
ent-PosterLegitCohibaRobustoAd = Реклама Кохибо Робусто
    .desc = Кохиба Робусто, первоклассная  сигара.
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвященного 50-летию компании Мануфактуры Нанопостеров, дочерней компании НаноТрейзен.
