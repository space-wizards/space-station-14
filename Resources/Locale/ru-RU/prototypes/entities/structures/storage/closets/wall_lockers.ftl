...
ent-LockerWallEvacRepair = эвакуационный аварийный настенный шкафчик
    .desc = Везде преследуют чрезвычайные ситуации.
ent-LockerWallBasePrisoner = тюремный настенный шкафчик
