...
ent-LiquidNitrogenCanister = Канистра с жидким азотом
    .desc = Канистра, которая может содержать любой тип газа. Предполагается, что он содержит жидкий азот. Его можно прикрепить к портам разъема с помощью гаечного ключа.
ent-LiquidOxygenCanister = Канистра с жидким кислородом
    .desc = Канистра, которая может содержать любой тип газа. Предполагается, что он содержит жидкий кислород. Его можно прикрепить к портам разъема с помощью гаечного ключа.
ent-LiquidCarbonDioxyCanister = Канистра с жидким углекислым газом
    .desc = Канистра, которая может содержать любой тип газа. Предполагается, что он содержит жидкий углекислый газ. Его можно прикрепить к портам разъема с помощью гаечного ключа.
