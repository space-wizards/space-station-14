...
ent-ShellShotgunImprovised = импровизированный патрон для дробовика
    .desc = Самодельный патрон для дробовика, стреляющий болезненными металлическими шрапнелью. Разлёт настолько велико, что не может поразить широкую стену сарая.
    .suffix = { "" }
