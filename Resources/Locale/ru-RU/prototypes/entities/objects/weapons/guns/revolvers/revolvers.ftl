...
ent-WeaponRevolverPirate = пиратский револьвер
    ...
    .suffix = Револьвер
ent-WeaponPistolCHIMP = Р.И.Ч.
    .desc = Просто маленький Р.И.Ч. это не значит, что он не может бить как И.А.Ч.
ent-WeaponRevolverPythonAP = питон
    .desc = Надежный револьвер, излюбленный агентами Синдиката. Использует патроны "Магнум" 45-го калибра.
