...
ent-WardrobeGeneticsFilled = { ent-WardrobeGenetics }
    .desc = Гладкие синие нити, содержащиеся внутри, значительно снижают вероятность того, что вас вышвырнут из генетической лаборатории.
    .suffix = Заполненный
ent-WardrobeAtmosphericsFilled = { ent-WardrobeAtmospherics}
    .desc = В этом шкафчике находится униформа атмосферных техников.
    .suffix = Заполненный
