...
ent-CrateSecurityBiosuit = ящик биокостюмов для СБ
    .desc = Содержит 2 костюма биологической опасности, чтобы никакая болезнь не отвлекала вас от выполнения своих обязанностей. Для открытия требуется доступ службы безопасности.
