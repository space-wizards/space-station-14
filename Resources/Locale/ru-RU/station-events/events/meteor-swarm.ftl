...
station-event-space-dust-start-announcement = Станция проходит через пояс астероидов, ожидается незначительный ущерб элементам конструкции и внешнему оборудованию.
