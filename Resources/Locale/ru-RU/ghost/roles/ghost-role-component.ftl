...
ghost-role-information-BreadDog-name = Хлебец
...
ghost-role-information-salvage-shark-name = Толстолобик на обломке
ghost-role-information-salvage-shark-description = Помогите младшим родственникам захватить добычу. Кровь в воздухе!
...
ghost-role-information-closet-skeleton-description = Сотворите хаос! Вы - первородная сила, непокорная никому. Живите счастливо с экипажем или же объявите вели-костную войну.
ghost-role-information-onestar-mecha-name = Омнистар
...
ghost-role-information-centcom-official-description = Выполняйте работу Центрального Командования. В частности, инспектируйте станцию, пишите служебные характеристики на руководителей, разжалуйте капитана.
ghost-role-information-Death-Squad-name = Оперативник Эскадрона Смерти
ghost-role-information-Death-Squad-description = Один из лучших активов штаба специальных операций. Ожидайте указаний от ЦентКома или его представителя.
ghost-role-information-Cak-name = Чизкейк
ghost-role-information-Cak-description = Золотой ребёнок шефа, живой котовый торт.  
ghost-role-information-Cak-rules = Вы - оживший сладкий и съедобный кот. Ваша задача - найти своё место в мире, где все хотят вас съесть.
ghost-role-information-nukeop-rules = Вы - оперативник Синдиката, которому поручено уничтожение станции. Как антагонист, делайте всё возможное, чтобы выполнить эту задачу.
ghost-role-information-loneop-name = Одинокий Оперативник
ghost-role-information-loneop-description = Вы - одинокий оперативник Синдиката. Уничтожьте станцию!
ghost-role-information-loneop-rules = Вы - оперативник Синдиката, которому поручено уничтожение станции. Как антагонист, делайте всё возможное, чтобы выполнить эту задачу.
...
ghost-role-information-supplybot-name = ПоставБот
ghost-role-information-supplybot-description = Развозите товар по станции.
...
ghost-role-information-syndicate-monkey-reinforcement-rules = Действуют обычные правила
...
ghost-role-information-space-ninja-rules = Вы элитный наёмник Клана паука. От вас не требуется следовать поставленным целям, но ваша ЧЕСТЬ НИНДЗЯ требует хотя бы попытаться. антагонистов Синдиката. Работайте с тем, кто вас вызвал, и не причиняйте ему вреда.
