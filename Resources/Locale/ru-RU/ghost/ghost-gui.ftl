...
ent-ActionGhostGuiToggleGhostVisibility = Переключить призраков
...
ent-ActionGhostGuiToggleLightingManager = Переключить освещение
...
ent-ActionGhostGuiToggleFov = Переключить поле зрения
