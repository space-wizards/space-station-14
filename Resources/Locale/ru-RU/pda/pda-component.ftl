...
comp-pda-ui-station-alert-level = Уровень угрозы: [color={ $ColorLevel }]{ $AlertLevel }[/color]
comp-pda-ui-station-acceses-levels = Доступы: [color=white]{ $AccessLevels }[/color]
comp-pda-ui-station-alert-level-instructions = Инструкции: [color=white]{ $AlertLevelInstructions }[/color]

comp-pda-ui-station-time =
    Длительность смены: [color=white]{ $hours } { $hours ->
    [one] ч
    [few] ч
    *[other] ч
                } и { $minutes } { $minutes ->
...
comp-pda-ui-station-time-unknown = Продолжительность смены: Неизвестно
