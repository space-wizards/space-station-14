...
petting-success-bingus = Вы гладите {THE($target)} по {POSS-ADJ($target)} мозолистой маленькой голове.
...
petting-success-kangaroo = Вы гладите { $target } по {POSS-ADJ($target)} маленькой кенгуриной голове.
...
petting-success-raccoon = Вы гладите {THE($target)} по {POSS-ADJ($target)} маленькой мусороедской голове.
...
petting-failure-goose = Вы тянетесь погладить { $target }, но { $target } оказывается слишком австралийским!
...
petting-success-pig = Вы тянетесь погладить { $target }, но слышите лишь раздражённое хрюканье и повизгивание.
petting-failure-raccoon = Вы тянетесь погладить { $target }, но  { $target } имеет слишком много своих енотских дел.
