...
chat-manager-admin-ooc-chat-enabled-message = Административный OOC-чат был включен.
chat-manager-admin-ooc-chat-disabled-message = Административный OOC-чат был отключен.
...
chat-manager-sender-announcement-wrap-message = {$sender} Объявляет:
                                                {"{0}"}
...
chat-manager-dead-channel-name = МЁРТВЫЙ
chat-manager-admin-channel-name = АДМИНИСТРАТОР
