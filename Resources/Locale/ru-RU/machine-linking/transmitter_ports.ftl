...
signal-port-description-decaying = Этот порт задействуется, когда связанная аномалия начинает процесс распада.
signal-port-name-stabilize = Стабилизация
signal-port-description-stabilize = Этот порт задействуется, когда связанная аномалия нормализована.
signal-port-name-growing = Рост
signal-port-description-growing = Этот порт задействуется, когда связанная аномалия начинает процесс роста.
signal-port-name-pulse = Пульсация
signal-port-description-pulse = Этот порт задействуется, когда связанная аномалия начинает пульсацию.
signal-port-name-supercrit = Сверхкритический
signal-port-description-supercrit = Этот порт задействуется, когда связанная аномалия входит в сверхкритическое состояние.
