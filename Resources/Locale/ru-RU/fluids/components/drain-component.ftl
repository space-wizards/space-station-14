...
drain-component-empty-verb-inhand = В {$object} пусто.
drain-component-examine-hint-full = [color="blue"]Наполнено до краёв. Возможно, вантуз поможет?[/color]
drain-component-examine-volume = [color="blue"]Осталось места - {$volume}u.[/color]
drain-component-unclog-fail = { CAPITALIZE(THE($object)) } всё еще заполнен.
