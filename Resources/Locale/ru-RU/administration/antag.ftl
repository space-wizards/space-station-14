...
admin-verb-text-make-traitor = Сделать цель предателем
admin-verb-text-make-zombie = Сделать цель зомби
admin-verb-text-make-nuclear-operative = Сделать цель ядерным оперативником
admin-verb-text-make-pirate = Сделать цель пиратом\капером
