...
research-technology-portable-fission = Переносное расщепление
...
research-technology-advanced-anomaly-research = Продвинутая аномалистика
...
research-technology-quantum-fiber-weaving = Квантоволоконное плетение
