...
marking-ArachnidRArmStripes = Полосы (Правая)
marking-ArachnidRArmStripes-stripes_right = Полосы

marking-ArachnidLArmStripes = Полосы (Левая)
marking-ArachnidLArmStripes-stripes_left = Полосы

marking-ArachnidRLegStripes = Полосы (Правая)
marking-ArachnidRLegStripes-stripes_right = Полосы

marking-ArachnidLLegStripes = Полосы (Левая)
