...
corvax-hidden-desc-MicroBombImplanter-syndicate = [color=#e31735]Это имплант микробомбы. Взорвется в момент смерти, дав последний шанс отомстить убийце.[/color]
...
corvax-hidden-desc-PowerSink-engineering = [color=#EFB341]Это энергоустройство напоминает черную дыру, бесконечно поглощая огромное количество энергии из электросети. Для этого его в принципе и создали.[/color]
