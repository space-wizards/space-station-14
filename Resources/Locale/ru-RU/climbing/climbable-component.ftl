...
comp-climbable-verb-climb = Свод

### Interaction Messages

# Shown to you when your character climbs on $climbable
comp-climbable-user-climbs = Вы прыгаете на { $climbable }!

# Shown to others when $user climbs on $climbable
comp-climbable-user-climbs-other  = { CAPITALIZE($user) } прыгает на { $climbable }!
...
comp-climbable-cant-climb = Вы не способны подняться!
