...
uplink-dna-scrambler-implanter-desc = Одноразовый имплант, который можно активировать для перемешивания ДНК и приобретения совершенно нового облика. Невозможно изменить уже перемешанную ДНК.
...
uplink-death-acidifier-implant-name = Имплантер Разжижение
uplink-death-acidifier-implant-desc = Бесповоротно растворяет пользователя и всё его снаряжение при использовании или посмертно.
uplink-micro-bomb-implanter-name = Имплантер Микробомба
uplink-micro-bomb-implanter-desc = Взорвитесь посмертно или после активации вручную с этим имплантом. Уничтожает тело и всё оборудование.
# Bundles
