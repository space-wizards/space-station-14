...
uplink-esword-name = Энергетический мечь
...
uplink-edagger-name = Энергетический кинджал
uplink-edagger-desc = Маленькое энергетический кинджал спрятанный под форму ручки.
