...
uplink-radio-jammer-desc = При активации это устройство блокирует любую исходящую поблизости радиосвязь. Замаскирован под оценочный инструмент.
# Implants
...
uplink-l6-saw-bundle-desc = Еще больше дакки: культовый лёгкий пулемет L6 в комплекте с 2 коробами патронов.
uplink-zombie-bundle-name = зомби набор синдиката
uplink-zombie-bundle-desc = Универсальный набор для создания зомби на станции. Снабжен револьвером, который вы можете направить себе в лоб, если все пойдет не по плану.
...
uplink-power-sink-name = Устройство поглощения энергии
...
# Job Specific
uplink-gatfruit-seeds-name = семена Гатфрукта
...
uplink-eva-syndie-name = EVA Синдиката
uplink-eva-syndie-desc = Стильный EVA-скафандр, который не даёт никакой защиты, кроме той, что необходима для выживания в космосе.
...
uplink-nocturine-chemistry-bottle-name = баночка с ноктюрином
