advertisement-discount-1 = Дискаунт Дэн, он — мужик!
...
advertisement-discount-6 = Дискаунт Дэн: Мы полезны вам! Не-а, не могу произнести это без смеха.
advertisement-discount-7 = Дискаунт Дэн: Только высококачественная проду-*БЗзз
advertisement-discount-8 = Дискаунт Дэн(ТМ) не несёт ответственности за любой ущерб, вызванный неправильным использованием его продукции.
