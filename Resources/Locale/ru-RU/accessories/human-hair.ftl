...
marking-HumanHairClassicBigAfro = Большое классическое афро
...
marking-HumanHairShoulderLengthOverEye = Волосы до плеч (Чёлка)
marking-HumanHairTwoStrands = Две косы
