...
ent-ClothingBackpackDuffelSyndicateCostumeCentcom = вещмешок с костюмом представителя Центкома
    .desc = Содержит полный комплект униформы представителя Центкома, гарнитуру и планшет. Ключи шифрования и доступ в комплект не входят.
	.suffix = НЕ МАППИТЬ
...
ent-ClothingBackpackDuffelSyndicateCarpSuit = набор с костюмом из карпа
    .desc = Содержит костюм карпа и несколько ваших новых друзей.