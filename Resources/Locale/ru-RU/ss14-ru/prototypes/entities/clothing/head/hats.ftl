...
ent-ClothingHeadHatBeretHoS = берет главы службы безопасности
    .desc = Чёрный берет с вышитой командирской эмблемой. Имеет кевларовую вставку для сохранности головы носителя.
ent-ClothingHeadHatBeretWarden = берет смотрителя
    .desc = Фирменный красный берет с эмблемой смотрителя. Имеет кевларовую вставку для сохранности головы носителя.
