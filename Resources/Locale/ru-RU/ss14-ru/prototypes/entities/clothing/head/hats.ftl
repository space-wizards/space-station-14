...
ent-ClothingHeadHatBeretSeniorPhysician = берет заведующего
    .desc = С цветами медицины и химии, заведующий - лицо своего отдела.
ent-ClothingHeadHatCentcomcap = фуражка ЦентКом
    .desc = Экстравагантная, изысканная фуражка офицера командования.
