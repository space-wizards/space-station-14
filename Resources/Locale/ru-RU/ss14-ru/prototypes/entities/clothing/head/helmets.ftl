...
ent-ClothingHeadHelmetJanitorBombSuit = сапёрный шлем уборщика
    .desc = Тяжелый шлем, предназначенный для защиты от осколков и давления, создаваемого реакциями.
    .suffix = НЕ МАППИТЬ
ent-ClothingHeadHelmetSwat = шлем спецназа
    .desc = Очень прочный шлем, широко используемый военизированными организациями. На его верхней части выгравирован логотип НаноТразен.
...
ent-ClothingHeadHelmetERTLeader = шлем лидера ОБР
    .desc = Атмосферный шлем, который носят лидеры отрядов быстрого реагирования НаноТразен. Имеет голубой фонарь.
ent-ClothingHeadHelmetERTSecurity = шлем офицера безопасности ОБР
    .desc = Атмосферный шлем, который носят офицеры безопасности отрядов быстрого реагирования НаноТразен. Имеет красный фонарь.
ent-ClothingHeadHelmetERTMedic = шлем медика ОБР
    .desc = Атмосферный шлем, который носят медики отрядов быстрого реагирования НаноТразен. Имеет белый фонарь.
ent-ClothingHeadHelmetERTEngineer = шлем инженера ОБР
    .desc = Атмосферный шлем, который носят инженеры отрядов быстрого реагирования НаноТразен. Имеет оранжевый фонарь.
ent-ClothingHeadHelmetERTJanitor = шлем уборщика ОБР
    .desc = Атмосферный шлем, который носят уборщики отрядов быстрого реагирования НаноТразен. Имеет тёмно-фиолетовый фонарь.
