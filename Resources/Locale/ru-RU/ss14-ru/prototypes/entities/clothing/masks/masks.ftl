...
ent-ClothingMaskGasCaptain = противогаз капитана
    .desc = В НаноТразен решили срезать углы и перекрасить запасной атмос-противогаз, только никому об этом не говорите.
...
ent-ClothingMaskClownBanana = парик банана-клоуна
