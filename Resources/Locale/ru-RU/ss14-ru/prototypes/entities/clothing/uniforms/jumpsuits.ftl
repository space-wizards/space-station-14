...
ent-ClothingUniformJumpsuitChaplain = комбинезон священника
    ...
    .suffix = { "" }
ent-ClothingUniformJumpsuitCentcomOfficial = комбинезон представителя Центком
...
ent-ClothingUniformJumpsuitCentcomOfficer = комбинезон офицера Центком
    .desc = Этот комбинезон носят офицеры Центком.
    .suffix = { "" }
...
ent-ClothingUniformJumpsuitCapFormal = торжественный костюм капитана
    ...
    .suffix = { "" }
ent-ClothingUniformJumpsuitCentcomFormal = торжественный костюм центкома
    .desc = Костюм для особых случаев.
    .suffix = { "" }
...
ent-ClothingUniformJumpsuitMonasticRobeLight = светлая монашеская ряса
    ...
    .suffix = { "" }
ent-ClothingUniformJumpsuitMusician = костюм музыканта
    .desc = Модный смокинг для любителей музыки. Идеально подходит для любого концерта в стиле лаунж!
    .suffix = { "" }
