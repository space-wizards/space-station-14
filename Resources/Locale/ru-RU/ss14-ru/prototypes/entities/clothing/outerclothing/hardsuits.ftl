...
ent-ClothingOuterHardsuitSyndieMedic = кроваво-красный скафандр медика
    .desc = Тяжелобронированная и высокомобильная версия продвинутого защитного скафандра, предназначенная для ведения действий в полевых медицинский условий. 
...
ent-ClothingOuterHardsuitLuxury = роскошный скафандр шахтёра
    .desc = Переработанный скафандр шахтёра, выполненный в цветах Квартирмейстера. Графеновое напыление предоставляет меньше защиты, но значительно повышает мобильность.
