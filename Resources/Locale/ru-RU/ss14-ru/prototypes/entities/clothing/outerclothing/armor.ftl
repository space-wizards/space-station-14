...
ent-ClothingOuterArmorBone = костяной панцирь
    .desc = Сидит как вторая кожа!
ent-ClothingOuterArmorPodWars = панцирь Кованый-II
    .desc = Перепрофилированный набор доспехов Кованый-II, реликвия ложевых войн.