...
ent-ClothingEyesHudMedSec = медико-охранный визор
    .desc = Окуляр с индикаторм на стекле, совмещает в себе лучшее из интерфейсов обоих отделов. Предоставляет точные данные о состоянии здоровья гуманоидов и отображает записи в системе безопасности.
