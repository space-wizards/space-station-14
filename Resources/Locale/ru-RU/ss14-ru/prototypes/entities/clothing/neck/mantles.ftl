...
ent-ClothingNeckMantleQM = мантия квартермейстера
    .desc = Мантия властителя припасов и правителя поставок, чтобы править своим отделом. В действительности, мантия превосходства.
