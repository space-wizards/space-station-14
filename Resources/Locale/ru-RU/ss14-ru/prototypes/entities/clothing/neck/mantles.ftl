...
ent-ClothingNeckMantleQM = аксельбант квартирмейстера
    .desc = Для властителя припасов и правителя поставок, чтобы править своим отделом. В действительности, мантия превосходства.
