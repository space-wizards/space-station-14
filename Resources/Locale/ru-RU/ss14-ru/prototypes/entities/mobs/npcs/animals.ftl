...
ent-MobKobold = кобольд
    .desc = Дальние родственники разумной расы унатхов, кобольды сливаются со своей средой обитания и ведут себя не лучше обезьян: всегда готовы вырвать ваши волосы и затыкать ручкой до смерти.
...
ent-MobPossum = Опоссум
    .desc = "О поссум! Мой опоссум!" -- Уолт Уитмен, 1865
ent-MobRaccoon = енот
    .desc = Мусорная панда!
ent-MobCorgi = корги
...
ent-MobCockroach = таракан
    .desc = Станция ими просто кишит.
ent-MobGlockroach = пистолетаракан
    .desc = Станция ими просто-- О БОЖЕ ОН ВООРУЖЁН!
    .suffix = Адмемы
ent-MobMothroach = моль-таракан
    .desc = Очаровательный результат генетического совмещения тараканов и мотыльков.
