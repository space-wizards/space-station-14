...
ent-SyndicateComputerComms = консоль связи Синдиката
    .desc = Компьютер, используемый для взлома систем объявления станции. Использование обязательно обратит на вас общее внимание.
...
ent-ComputerSensorMonitoring = консоль мониторинга сенсоров
    .desc = Гибкая консоль для наблюдения за всевозможными сенсорами.
