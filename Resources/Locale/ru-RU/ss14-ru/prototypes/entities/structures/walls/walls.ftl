...
ent-WallNecropolis = каменная стена
    .desc = Удерживает воздух внутри, а пеплоходцев снаружи.
ent-WallMining = стена
    .desc = { ent-BaseWall.desc }
ent-WallMiningDiagonal = стена
    .desc = { ent-WallShuttleDiagonal.desc }
    .suffix = Диагональная
ent-WallCobblebrick = булыжниковая кладка
    .desc = Камешек к камешку, идеально сложенная стена
ent-WallBasaltCobblebrick = базальтовая кладка
    .desc = { ent-WallCobblebrick.desc }
ent-WallSnowCobblebrick = морозная кладка
    .desc = Холодная и не такая уж и монолитная стена.
ent-WallAsteroidCobblebrick = астероидная кладка
    .desc = { ent-WallCobblebrick.desc }
ent-WallSandCobblebrick = песчанниковая кладка
    .desc = { ent-WallCobblebrick.desc }
ent-WallChromiteCobblebrick = хромитовая кладка
    .desc = { ent-WallCobblebrick.desc }
