...
ent-AirlockCentralCommand = { ent-Airlock }
    .desc = { ent-Airlock.desc }
    .suffix = Центком
ent-AirlockCentralCommandGlass = { ent-Airlock }
    .desc = { ent-Airlock.desc }
    .suffix = Стеклянный, Центком
...
ent-AirlockExternalShuttleNukeopLocked = { ent-AirlockShuttle }
    ...
    .suffix = Внешний, Стыковочный, Ядерный оперативник, Закрыт
ent-AirlockExternalGlassNukeopLocked = { ent-AirlockExternalGlass }
    .desc = { ent-AirlockExternalGlass.desc }
    .suffix = Внешний, Стеклянный, Ядерный оперативник, Закрыт
