...
ent-LockerClown = шкаф клоуна
    .desc = Я знаю одну смешную шутку!
ent-LockerMime = шкаф мима
    .desc = ...
ent-LockerRepresentative = шкаф представителя НаноТразен
    .desc = Властью, данною мне комитетом управления активами центрального командования, я опечатываю этот шкафчик. Любое его открытие должно быть санкционировано исключительно с предварительного разрешения высшего состава центрального... КТО ЕГО ВЗЛОМАЛ?!
