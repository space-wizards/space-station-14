...
ent-DrinkDrGibbCan = банка доктора Гибба
    ...
    .suffix = { "" }
ent-DrinkNukieCan = крепкий напиток нюкера
    .desc = Ободряющий напиток... очень ободряющий. Он наполнен зеленой жидкостью, после употребления рекомендуется обратиться к врачу.
    .suffix = { "" }
