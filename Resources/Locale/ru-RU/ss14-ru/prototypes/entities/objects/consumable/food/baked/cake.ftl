...
ent-FoodCakeLemoon = лунно-лимонный торт
    .desc = Торт символизирующий луну Земли.
ent-FoodCakeLemoonSlice = лунно-лимонный ломтик
    .desc = Осколок земной луны с молочным запахом.
ent-MobCatCake = Чизкейк
    .desc = Это - торт. Это - кот. Это - Чизкейк.
