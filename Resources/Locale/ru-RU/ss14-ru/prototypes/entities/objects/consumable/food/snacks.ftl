...
ent-FoodSnackEnergyBar = энергетический батончик
    .desc = Энергетический батончик с большим запасом энергии.
ent-FoodSnackCnDs = Ш&Д
    .desc = Бюрократия запрещает нам обещать, что они не расплавятся в ваших руках.
ent-FoodSnackPistachios = сладостины фисташки
    .desc = Сладостины брендовые фисташки. Скорее всего, не содержат болезней. Скорее всего.
ent-FoodSnackSemki = семки от сани
    .desc = Гордо выращиваемые корпорацией здорового питания Саши Сандерса. В самый раз для любителей плеваться в людей.
ent-FoodPacketCnDsTrash = пачка Ш&Д
