...
ent-CigPackGreen = пачка сигарет Spessman's Smokes
    .desc = Надпись на упаковке гласит: "Не изменит ли медленная смерть ситуацию?"
...
ent-CigPackBlack = пачка сигарет Nomads
    .desc = "Nomads's extra strong" для тех случаев, когда ваша жизнь становится экстра-тяжёлой.
