...
ent-FoodDoughTortilla = кусок тесто тортильи
    .desc = Большой кусок теста тортильи.
ent-FoodDoughTortillaSlice = тесто тортильи
    .desc = Кусок теста тортильи.
ent-FoodDoughTortillaFlat = плоское тесто тортильи
    .desc = Раскатанное тесто тортильи. Почти готово для тако.
...
ent-FoodCocoaPod = коробочка какао
    .desc = Шоколада много не бывает!
ent-FoodCannabisButter = брусок каннабисового масла
    .desc = Добавьте к любимой выпечке в тяжелые времена.
