...
ent-MindShieldImplant = имплант Защита сознания
    .desc = Этот имплант обеспечивает повиновение НаноТразен и предотвращает работу любых иных средств контроля разума.
ent-DeathAcidifierImplant = имплант Разжижение
    .desc = Этот имплант полностью растворяет вас и ваше оборудование после смерти.
