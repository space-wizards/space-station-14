...
ent-FloorTileItemGratingMaint = решётчатый технический пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemSteelCheckerDark = тёмный стальной шахматный пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemSteelCheckerLight = светлый стальной шахматный пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemWeb = паутинный пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemConcrete = бетонный пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemGrayConcrete = серый бетонный пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemOldConcrete = старый бетонный пол
    .desc = { ent-FloorTileItemBase.desc }
