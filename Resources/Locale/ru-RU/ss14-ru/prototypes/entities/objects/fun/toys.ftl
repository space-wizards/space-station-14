...
ent-BeachBall = пляжный мяч
    .desc = Простой пляжный мяч - один из самых популярных продуктов компании НаноТразен. 'Почему мы делаем пляжные мячи? Потому что мы можем! (TM)' - НаноТразен.
...
ent-PlushieArachind = плюшевый арахнид
    .desc = Милая плюшевая игрушка, напоминающая арахнида. Шёлковая наощупь.
ent-PlushieHuman = плюшевый человек
    .desc = Предположительно, плюшевая игрушка человека. Изделие низкого качества. Оно голо. Оно плачет. Оно кричит.
