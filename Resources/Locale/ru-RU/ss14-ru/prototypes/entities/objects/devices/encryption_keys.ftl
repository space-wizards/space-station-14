...
ent-EncryptionKeySyndie = ключ шифрования синдиката
    .desc = Ключ шифрования, используемый агентами Синдиката не только для доступа к радиоканалам станции, но и для безопасной связи с другими агентами на местах.
    .suffix = { "" }
ent-EncryptionKeyNukie = ключ шифрования ядерного оперативника
    .desc = Ключ шифрования, используемый ядерными оперативниками для безопасной связи друг с другом во время операций.
    .suffix = { "" }
