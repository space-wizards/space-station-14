...
ent-DawInstrumentMachineCircuitboard = цифровая звуковая рабочая станция (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
ent-PortableGeneratorPacmanMachineCircuitboard = генератор (П.А.К.М.А.Н.) (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
...
ent-GyroscopeMachineCircuitboard = гироскоп (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
ent-PortableGeneratorSuperPacmanMachineCircuitboard = генератор (С.У.П.Е.Р.П.А.К.М.А.Н.) (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
ent-PortableGeneratorJrPacmanMachineCircuitboard = генератор (Е.Р.П.А.К.М.А.Н.) (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
...
ent-ElectricGrillMachineCircuitboard = электрический гриль (машинная плата)
    .desc = Печатная плата для электрического гриля.
