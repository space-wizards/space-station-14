...
ent-VendingMachineRestockChefvend = набор пополнения ШефВенд
    .desc = Пополните ШефВенд. Не замесите ещё большей каши.
ent-VendingMachineRestockCondimentStation = набор пополнения Островок cоусов
    .desc = Пополните Островок соусов. Мммм, астротем.
