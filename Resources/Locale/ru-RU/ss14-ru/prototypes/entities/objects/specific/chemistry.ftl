...
ent-BorgDropper = механическая пипетка
    .desc = Используется для перемещения небольших объемов реагентов между емкостями. Доработана для использования киборгами.
