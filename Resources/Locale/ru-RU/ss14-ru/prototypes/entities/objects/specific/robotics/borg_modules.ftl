...
ent-BorgModuleAdvancedTopical = продвинутый модуль первой помощи киборга
    .desc = Модуль содержащий гипоспрей. Теперь ваши киборги могут успокаивать хулиганов при помощи хлоральгидрата ещё быстрее!
ent-BorgModuleArtistry = модуль артиста
    .desc = Делай исскуство и разукрашивай станцию, пока она ещё не погрязла в огне!
ent-MothershipModule = модуль материнского корабля
    .desc = Модуль, который помогает материнскому кораблю создавать ксеноборгов.
ent-BorgModulePrying = модуль вскрытия дверей
    .desc = Модуль, который позволяет вскрывать двери на вашем пути.
