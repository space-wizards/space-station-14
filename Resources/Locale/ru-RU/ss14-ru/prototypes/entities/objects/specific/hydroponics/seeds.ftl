...
ent-TomatoSeeds = пакет семян томата
    .desc = { ent-SeedBase.desc }
ent-BlueTomatoSeeds = пакет семян голубого томата
    .desc = { ent-SeedBase.desc }
ent-BloodTomatoSeeds = пакет семян кровавого томата
    .desc = { ent-SeedBase.desc }
...
ent-DeathNettleSeeds = пакет семян смертокрапивы
    .desc = Работать только в самых толстых перчатках.
ent-ChiliSeeds = пакет семян чили
    .desc = Острые.
ent-ChillySeeds = пакет семян хладоперца
...
ent-SoybeanSeeds = пакет семян сои
    .desc = { ent-SeedBase.desc }
ent-KoibeanSeeds = пакет семян карпосои
    .desc = { ent-SeedBase.desc }
...
ent-BerrySeeds = пакет семян ягод
    .desc = { ent-SeedBase.desc }
ent-BungoSeeds = пакет семян мбунго
    .desc = "Косточки не ешьте."
