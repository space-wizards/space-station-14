...
ent-TomatoSeeds = пакет семян (томат)
    .desc = { ent-SeedBase.desc }
ent-BlueTomatoSeeds = пакет семян (голубой томат)
    .desc = { ent-SeedBase.desc }
ent-BloodTomatoSeeds = пакет семян (кровавыйы томат)
    .desc = { ent-SeedBase.desc }
...
ent-ChiliSeeds = пакет семян (чили)
    .desc = Острые.
ent-ChillySeeds = пакет семян (хладоперец)
...
ent-SoybeanSeeds = пакет семян (соя)
    .desc = { ent-SeedBase.desc }
ent-KoibeanSeeds = пакет семян (карпосоя)
    .desc = { ent-SeedBase.desc }
