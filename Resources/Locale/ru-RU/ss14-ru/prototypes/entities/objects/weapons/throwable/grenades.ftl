...
ent-SupermatterGrenade = суперматериальная граната
    .desc = Граната, симулирующая расслоение суперматериального двигателя, притягивающая вещи скопом и взрываясь через небольшой промежуток времени.
ent-WhiteholeGrenade = граната белой дыры
    .desc = Граната, отталкивающая все вокруг себя на некоторое время.
