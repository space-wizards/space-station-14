...
air-alarm-ui-window-resync-devices-label = Ресинхронизировать
...
air-alarm-ui-thresholds-pressure-title = Давление (кПа)
air-alarm-ui-thresholds-temperature-title = Температура (K)
air-alarm-ui-thresholds-gas-title = { $gas } (%)
air-alarm-ui-thresholds-upper-bound = Верхняя граница
air-alarm-ui-thresholds-lower-bound = Нижняя граница
air-alarm-ui-thresholds-upper-warning-bound = Верхняя аварийная граница
air-alarm-ui-thresholds-lower-warning-bound = Нижняя аварийная граница
