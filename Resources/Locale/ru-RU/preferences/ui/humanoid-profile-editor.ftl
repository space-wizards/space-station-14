...
humanoid-profile-editor-jobs-amount-in-department-tooltip = Должности в { $departmentName }
humanoid-profile-editor-department-jobs-label = { $departmentName } должности
