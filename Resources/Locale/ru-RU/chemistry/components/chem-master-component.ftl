...
chem-master-component-cannot-put-entity-message = Вы не можете поместить это в ChemMaster!
...
chem-master-window-buffer-low-text = Недостаточное раствора в буфере
