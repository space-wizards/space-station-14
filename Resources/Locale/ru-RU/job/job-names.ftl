...
job-name-technical-assistant = техник-стажёр
...
job-name-senior-physician = заведующий медблоком
...
JobSeniorPhysician = заведующий медблоком
JobSeniorResearcher = старший научный сотрудник
JobStationEngineer = инженер
JobTechnicalAssistant = техник-стажёр
