role-timer-department-insufficient = Требуется ещё [color=yellow]{TOSTRING($time, "0")}[/color] минут игры за [color={$departmentColor}]{$department}[/color] отдел.
role-timer-department-too-high = Требуется на [color=yellow]{TOSTRING($time, "0")}[/color] меньше минут игры за [color={$departmentColor}]{$department}[/color] отдел. (Вы пытаетесь играть за роль для новичков?)
