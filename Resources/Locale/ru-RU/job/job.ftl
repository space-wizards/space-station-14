job-greet-introduce-job-name = Вы {$jobName}.
job-greet-important-disconnect-admin-notify = Вы играете важную роль для Игрового Прогресса. Если вы вынуждены отключиться, пожалуйста, сообщите об этом администраторам через "Помощь админа".
