...
mind-component-no-mind-and-alive-text = { CAPITALIZE(POSS-ADJ($ent)) } полный кататоник.  Жизненные потрясения в грубоком космосе, должно быть повергли его в это состояние. Восстановление маловероятно.
