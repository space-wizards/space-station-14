...
mind-component-no-mind-and-alive-text = { CAPITALIZE(POSS-ADJ($ent)) } полный кататоник.  Жизненные потрясения в глубоком космосе, должно быть повергли его в это состояние. Восстановление маловероятно.
mind-component-no-mind-and-dead-text = Душа { CAPITALIZE(POSS-ADJ($ent)) } покинула тело и отправилась дальше. Восстановление маловероятно.
mind-component-mind-and-no-session-text = У { CAPITALIZE(POSS-ADJ($ent)) } { CONJUGATE-HAVE($ent) }  пустой, рассеянный взгляд, который, кажется, ни на что не реагирует. { CAPITALIZE(POSS-ADJ($ent)) } может скоро опомниться.
