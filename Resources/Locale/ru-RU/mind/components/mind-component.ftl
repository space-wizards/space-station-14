...
mind-component-no-mind-and-dead-text = Душа { CAPITALIZE(POSS-ADJ($ent)) } покинула тело.
mind-component-mind-and-no-session-text = { CAPITALIZE(POSS-ADJ($ent)) } { CONJUGATE-HAVE($ent) } рассеяно смотрит в пустоту и ни на что не реагирует. { CAPITALIZE(POSS-ADJ($ent)) } может скоро придти в себя.
