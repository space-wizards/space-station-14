...
reagent-desc-espresso-martini = Чтобы взбодрить и охладить. Украшено кофейными зёрнами и ледяной свежестью.
...
reagent-desc-moscow-mule = Коктейль из США. Почему Московский? Потому что водка. Водка Московская? Нет. Так почему Московский? ВОДКА!
