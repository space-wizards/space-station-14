...
reagent-name-kahlua = калуа
reagent-desc-kahlua = Широко известный мексиканский кофейный ликер.
...
reagent-name-erika-suprise = сюрприз Эрики
reagent-desc-erika-suprise = Сюрприз в том, что он зеленый!
