...
reagent-desc-soap = Мыло может быть использовано ради мыльного раствора.
reagent-name-soapy-water = мыльный раствор
reagent-desc-soapy-water = Всего лишь вода да мыло. Идеально подходит для счищения грязи с поверхностей, а также для поскальзывания прохожих.
