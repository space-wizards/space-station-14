...
public sealed class Solution_Tests : ContentUnitTest
{
    ...
    public void TotalVolumeIsCorrect()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(3000));
    }
    ...
    public void CloningSolutionIsCorrect()
    {
        ...
        Assert.That(newSolution.CurrentVolume.Int(), Is.EqualTo(3000));
    }
    ...
    public void RemoveSolutionRecalculatesProperly()
    {
        ...
        Assert.That(solution.GetReagentQuantity("fire").Int(), Is.EqualTo(2000));
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(2500));
    }
    ...
    public void RemoveLessThanOneQuantityDoesNothing()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(100));
    }
    ...
    public void RemoveMoreThanTotalRemovesAllReagent()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(0));
    }
    ...
    public void RemoveSolution()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(200));
    }
    ...
    public void RemoveSolutionRatioPreserved()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(1500));
    }
    ...
    public void RemoveSolutionLessThanOneDoesNothing()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(800));
    }
    ...
    public void SplitSolution()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(2250));
        ...
        Assert.That(splitSolution.CurrentVolume.Int(), Is.EqualTo(750));
    }
    ...
    public void SplitSolutionFractional()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(2));
        ...
        Assert.That(splitSolution.CurrentVolume.Int(), Is.EqualTo(1));
    }
    ...
    public void SplitSolutionFractionalOpposite()
    {
        ...
        Assert.That(solution.CurrentVolume.Int(), Is.EqualTo(1));
        ...
        Assert.That(splitSolution.CurrentVolume.Int(), Is.EqualTo(2));
    }
    ...
    public void SplitSolutionTinyFractionalBigSmall(float initial, float reduce, float remainder)
    {
        ...
        Assert.That(solution.CurrentVolume.Float(), Is.EqualTo(remainder));

        Assert.That(splitSolution.GetReagentQuantity("water").Float(), Is.EqualTo(reduce));
        Assert.That(splitSolution.CurrentVolume.Float(), Is.EqualTo(reduce));
    }
    ...
    public void SplitRounding(int amount)
    {
        ...
        Assert.That(split.CurrentVolume, Is.EqualTo(splitAmount));
    }
    ...
    public void SplitSolutionMoreThanTotalRemovesAll()
    {
        ...
        Assert.That(splitSolution.CurrentVolume.Int(), Is.EqualTo(800));
    }
    ...
    public void SplitSolutionLessThanOneDoesNothing()
    {
        ...
        Assert.That(splitSolution.CurrentVolume.Int(), Is.EqualTo(0));
    }
    ...
    public void AddSolution()
    {
        ...
        Assert.That(solutionOne.CurrentVolume.Int(), Is.EqualTo(4500));
    }
