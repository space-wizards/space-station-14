...
- type: alert
  ...
  maxSeverity: 6";
        ...
        {
            Assert.That(new AlertKey("HumanHealth", null), Is.Not.EqualTo(AlertKey.ForCategory(AlertCategory.Health)));
            Assert.That((new AlertKey(null, AlertCategory.Health)), Is.EqualTo(AlertKey.ForCategory(AlertCategory.Health)));
            Assert.That((new AlertKey("Buckled", AlertCategory.Health)), Is.EqualTo(AlertKey.ForCategory(AlertCategory.Health)));
        }
