...
using Content.Tests.Tests;
using Content.Tests.Tests.Destructible;
using Content.Tests.Tests.DeviceNetwork;
using Content.Tests.Tests.Interaction.Click;
using Content.Tests.Tests.Networking;
using Robust.Client;
using Robust.Server;
using Robust.Shared;
...
public static class PoolManager
{
    ...
    {
        return testContext.Test.FullName.Replace("Content.Tests.Tests.", "");
    }
