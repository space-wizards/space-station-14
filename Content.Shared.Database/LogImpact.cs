...
public enum LogImpact : sbyte
{
    ...
    Extreme = 2, // Irreversible round-impacting logs admins should always be notified of.
    Admin = 3 // Any and all admin actions, including smites, debug actions and similiar. Will not pop up as admin alerts.
}
