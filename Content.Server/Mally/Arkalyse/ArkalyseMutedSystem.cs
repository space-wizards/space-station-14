...
public sealed class ArkalyseMutedSystem : EntitySystem
{
    ...
    {
        _actionSystem.AddAction(uid, ref component.ActionMutedAttackEntity, component.ActionMutedAttack, uid);
    }
    private void OnComponentShutdown(EntityUid uid, ArkalyseMutedComponent component, ComponentShutdown args)
    {
        _actionSystem.RemoveAction(uid, component.ActionMutedAttackEntity);
    }
