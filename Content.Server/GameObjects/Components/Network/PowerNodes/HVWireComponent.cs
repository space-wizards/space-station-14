...
{
    [RegisterComponent]
    public class HVWireComponent : BaseNodeComponent
    {
        public override string Name => "HVWire";
        ...
        protected override IEnumerable<BaseNodeComponent> GetReachableNodes()
        {
            return Owner.GetComponent<SnapGridComponent>()
                ...
                .Select(entity => entity.TryGetComponent<HVWireComponent>(out var node) ? node : null)
