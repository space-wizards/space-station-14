...
namespace Content.Server.Popups
{
    public sealed class PopupSystem : SharedPopupSystem
    {
        ...
        {
            RaiseNetworkEvent(new PopupCoordinatesEvent(message, type, ToNetCoordinates(coordinates)), filter, replayRecord);
        }
        ...
        public override void PopupCoordinates(string message, EntityCoordinates coordinates, PopupType type = PopupType.Small)
        {
            ...
            RaiseNetworkEvent(new PopupCoordinatesEvent(message, type, ToNetCoordinates(coordinates)), filter);
        }
        ...
        {
            RaiseNetworkEvent(new PopupCoordinatesEvent(message, type, ToNetCoordinates(coordinates)), recipient);
        }
        ...
        {
            if (TryComp(recipient, out ActorComponent? actor))
                RaiseNetworkEvent(new PopupCoordinatesEvent(message, type, ToNetCoordinates(coordinates)), actor.PlayerSession);
        }

        public override void PopupEntity(string message, EntityUid uid, PopupType type = PopupType.Small)
        {
            var filter = Filter.Empty().AddPlayersByPvs(uid, entityManager:EntityManager, playerMan: _player, cfgMan: _cfg);
            RaiseNetworkEvent(new PopupEntityEvent(message, type, ToNetEntity(uid)), filter);
        }

        public override void PopupEntity(string message, EntityUid uid, EntityUid recipient, PopupType type=PopupType.Small)
        {
            if (TryComp(recipient, out ActorComponent? actor))
                RaiseNetworkEvent(new PopupEntityEvent(message, type, ToNetEntity(uid)), actor.PlayerSession);
        }
        ...
        {
            RaiseNetworkEvent(new PopupEntityEvent(message, type, ToNetEntity(uid)), recipient);
        }

        public override void PopupEntity(string message, EntityUid uid, Filter filter, bool recordReplay, PopupType type = PopupType.Small)
        {
            RaiseNetworkEvent(new PopupEntityEvent(message, type, ToNetEntity(uid)), filter, recordReplay);
        }
    }
}
