...
namespace Content.Server.Kitchen.EntitySystems
{
    internal sealed class KitchenSpikeSystem : EntitySystem
    {
            ...
            KitchenSpikeComponent? component = null, SharedButcherableComponent? butcherable = null)
        {
            ...
            {
                _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-butcher", ("victim", Identity.Name(victimUid, EntityManager)), ("this", uid)), victimUid, Filter.Entities(userUid));
                return false;
            }
            ...
            switch (butcherable.Type)
            {
                ...
                case ButcheringType.Knife:
                    _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-butcher-knife", ("victim", Identity.Name(victimUid, EntityManager)), ("this", uid)), victimUid, Filter.Entities(userUid));
                    return false;
                default:
                    _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-butcher", ("victim", Identity.Name(victimUid, EntityManager)), ("this", uid)), victimUid, Filter.Entities(userUid));
                    return false;
            ...
            SharedButcherableComponent? butcherable = null, MobStateComponent? mobState = null)
        {
            ...
            if (Resolve(victimUid, ref mobState, false) &&
                !mobState.IsDead())
            {
                _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-deny-not-dead", ("victim", Identity.Name(victimUid, EntityManager))),
            ...
            {
                _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-begin-hook-victim", ("user", Identity.Name(userUid, EntityManager)), ("this", uid)), victimUid,
