...
public sealed partial class ShuttleSystem
{
    ...
    private readonly SoundSpecifier _startupSound = new SoundCollectionSpecifier("HyperspaceEnterSound")
    {
        Params = AudioParams.Default.WithVolume(-5f),
    };

    private readonly SoundSpecifier _arrivalSound = new SoundCollectionSpecifier("HyperspaceExitSound")
    {
        Params = AudioParams.Default.WithVolume(-5f),
    };
