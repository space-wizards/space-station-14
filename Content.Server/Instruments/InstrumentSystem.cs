...
public sealed partial class InstrumentSystem : SharedInstrumentSystem
{
    ...
    private void OnMidiSetTracks(InstrumentSetTracksEvent msg, EntitySessionEventArgs args)
    {
        ...
        _admingLogSystem.Add(
            LogType.Instrument,
            LogImpact.Low,
            // @Simyon264 has specified this string must remain referring to channels for the sake of consistent searchability of old admin logs.
            // TODO: Once the above is not a concern, change the word "channels" to "tracks".
