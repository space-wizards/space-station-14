...
namespace Content.Server.Spawners.EntitySystems
{
    ...
    public sealed class ConditionalSpawnerSystem : EntitySystem
    {
        ...
        private void Spawn(EntityUid uid, ConditionalSpawnerComponent component)
        {
            ...
            if (!Deleted(uid))
                SpawnAtPosition(_robustRandom.Pick(component.Prototypes), Transform(uid).Coordinates);
        }
        ...
        private void Spawn(EntityUid uid, RandomSpawnerComponent component)
        {
            ...
            {
                SpawnAtPosition(_robustRandom.Pick(component.RarePrototypes), Transform(uid).Coordinates);
                return;
            }
            ...
            SpawnAtPosition(_robustRandom.Pick(component.Prototypes), coordinates);
        }
