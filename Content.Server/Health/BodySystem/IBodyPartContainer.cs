...
namespace Content.Server.BodySystem
{
    ...
    /// <summary>
    ///     Making a class inherit from this interface allows you to do many things with it in the <see cref="ISurgeryData">ISurgeryData</see> class. This includes passing
