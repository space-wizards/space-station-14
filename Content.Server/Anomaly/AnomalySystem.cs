...
public sealed partial class AnomalySystem : SharedAnomalySystem
{
    ...
    private void OnStartCollide(EntityUid uid, AnomalyComponent component, ref StartCollideEvent args)
    {
        ...
        else if (particle.ParticleType == component.SeverityParticleType || particle.SeverityOverride)
        {
            ChangeAnomalySeverity(uid, VaryValue(particle.SeverityPerSeverityHit), component);
        }
        else if (particle.ParticleType == component.WeakeningParticleType || particle.WeakeningOverride)
        {
