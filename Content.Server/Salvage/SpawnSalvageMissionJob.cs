...
public sealed class SpawnSalvageMissionJob : Job<bool>
{
    ...
    protected override async Task<bool> Process()
    {
        ...
        _metaData.SetEntityName(mapUid, _entManager.System<SharedSalvageSystem>().GetFTLName(_prototypeManager.Index<LocalizedDatasetPrototype>("names_borer"), _missionParams.Seed));
