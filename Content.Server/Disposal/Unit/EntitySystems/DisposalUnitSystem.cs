...
public sealed class DisposalUnitSystem : SharedDisposalUnitSystem
{
    ...
    private void OnActivate(EntityUid uid, DisposalUnitComponent component, ActivateInWorldEvent args)
    {
        ...
        args.Handled = true;
        _ui.TryOpen(uid, DisposalUnitComponent.DisposalUnitUiKey.Key, actor.PlayerSession);
    }
    ...
    /// </summary>
    private void OnThrowCollide(EntityUid uid, DisposalUnitComponent component, ThrowHitByEvent args)
    {
    ...
    public void AfterInsert(EntityUid uid, DisposalUnitComponent component, EntityUid inserted, EntityUid? user = null)
    {
        ...
        {
            _ui.TryClose(uid, DisposalUnitComponent.DisposalUnitUiKey.Key, actor.PlayerSession);
        }
