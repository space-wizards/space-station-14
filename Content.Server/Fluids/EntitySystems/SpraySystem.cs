...
public sealed class SpraySystem : EntitySystem
{
    ...
    private void OnAfterInteract(Entity<SprayComponent> entity, ref AfterInteractEvent args)
    {
        ...
        for (var i = 0; i < amount; i++)
        {
            ...
            var diff = (target.Position - userMapPos.Position);
            if (diff.IsLongerThan(entity.Comp.SprayDistance))
            ...
            var vaporPos = userMapPos.Offset(diff.IsShorterThan(1) ? quarter : threeQuarters);
