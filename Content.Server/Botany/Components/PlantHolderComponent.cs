namespace Content.Server.Botany.Components
{
    ...
    {
        [ViewVariables] public int _lastProduce;

        [ViewVariables(VVAccess.ReadWrite)] public int MissingGas;

        public readonly TimeSpan _cycleDelay = TimeSpan.FromSeconds(15f);

        [ViewVariables] public TimeSpan LastCycle = TimeSpan.Zero;

        [ViewVariables(VVAccess.ReadWrite)] public bool _updateSpriteAfterUpdate;

        [ViewVariables(VVAccess.ReadWrite)] [DataField("drawWarnings")]
        public bool DrawWarnings = false;

        [ViewVariables(VVAccess.ReadWrite)] public float WaterLevel = 100f;

        [ViewVariables(VVAccess.ReadWrite)] public float NutritionLevel = 100f;
        ...
        [ViewVariables(VVAccess.ReadWrite)] public SeedData? Seed { get; set; }
        ...
        [DataField("solution")] public string SoilSolutionName { get; set; } = "soil";
    }
}
