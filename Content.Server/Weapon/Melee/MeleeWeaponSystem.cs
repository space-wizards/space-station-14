                    ...
                    if (damageResult != null)
                    {
                        if (args.Used == args.User)
                            _logSystem.Add(LogType.MeleeHit,
                                $"{args.User} melee attacked {args.Target} using their hands and dealt {damageResult.Total} damage");
                        else
                            _logSystem.Add(LogType.MeleeHit,
                                $"{args.User} melee attacked {args.Target} using {args.Used} and dealt {damageResult.Total} damage");
                    }
