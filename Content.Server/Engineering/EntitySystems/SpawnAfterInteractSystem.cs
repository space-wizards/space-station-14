...
namespace Content.Server.Engineering.EntitySystems
{
    ...
    public sealed class SpawnAfterInteractSystem : EntitySystem
    {
        ...
        private async void HandleAfterInteract(EntityUid uid, SpawnAfterInteractComponent component, AfterInteractEvent args)
        {
            ...
            if (component.RemoveOnInteract && stackComp == null && !((!EntityManager.EntityExists(uid) ? EntityLifeStage.Deleted : EntityManager.GetComponent<MetaDataComponent>(uid).EntityLifeStage) >= EntityLifeStage.Deleted))
