...
namespace Content.Server.Database
{
    ...
    public sealed class ServerDbSqlite : ServerDbBase
    {
        ...
        public override async Task<ServerUsernameRuleDef?> GetServerUsernameRuleAsync(int id)
        {
            ...
            var queryRule = await GetServerRestrictedUsernamesInternal(db.SqliteDbContext, true);

            return ConvertUsernameRule(queryRule
                .Where(r => r.Id == id)
                .FirstOrDefault());
        }
        ...
        public override async Task<List<ServerUsernameRuleDef>> GetServerUsernameRulesAsync(bool includeRetired)
        {
            ...
            var queryRule = await GetServerRestrictedUsernamesInternal(db.SqliteDbContext, includeRetired);
