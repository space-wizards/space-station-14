...
public sealed partial class ChangelingSystem : EntitySystem
{
    ...
    private void UpdateBiomass(EntityUid uid, ChangelingComponent comp, float? amount = null)
    {
        ...
        if (comp.Biomass <= 0)
            // game over, man
            _damage.TryChangeDamage(uid, new DamageSpecifier(_proto.Index(SecondaryAbsorbedDamageGroup), 50), true); // Harmony - Name changed
    ...
    public bool TryStealDNA(EntityUid uid, EntityUid target, ChangelingComponent comp, bool countObjective = false)
    {
        ...
        var data = new TransformData
        {
            ...
            // Harmony - Was previously "DNA = dna.DNA" which vs won't compile for possible null reasons.
            // I've added what goob does to fix this. I'm not sure how it ended up being the way it is on funky codebase.
