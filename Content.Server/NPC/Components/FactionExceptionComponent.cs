...
/// </summary>
[RegisterComponent, Access(typeof(NpcFactionSystem), typeof(NPCImprintingOnSpawnBehaviourSystem))] // TO DO (Metalgearsloth): If we start adding a billion access overrides they should be going through a system as then there's no reason to have access, but I'll fix this when I rework npcs.
