...
public sealed class NPCBlackboardSerializer : ITypeSerializer<NPCBlackboard, MappingDataNode>
{
    ...
    public DataNode Write(ISerializationManager serializationManager, NPCBlackboard value, bool alwaysWrite = false,
        ISerializationContext? context = null)
    {
        throw new NotImplementedException();
    }

    public NPCBlackboard Copy(ISerializationManager serializationManager, NPCBlackboard source, NPCBlackboard target,
