...
namespace Content.Server.Atmos.Piping.Unary.EntitySystems
{
    ...
    public sealed partial class GasVentScrubberSystem : EntitySystem
    {
        ...
        {
            if (outlet.PipeNet == null)
                return;

            Scrub(timeDelta, scrubber.TransferRate * _atmosphereSystem.PumpSpeedup(), scrubber.PumpDirection, scrubber.FilterGases, tile, outlet.PipeNet.Value.Comp.Air);
        }
