...
///     Optimized implementation that uses ChargedElectrovaeManager for batched processing.
/// </summary>
[UsedImplicitly]
public sealed partial class ChargedElectrovaeEmpReaction : IGasReactionEffect
{
    // Track the last reaction time for each tile to prevent spamming
    ...
    public ReactionResult React(GasMixture mixture, IGasMixtureHolder? holder, AtmosphereSystem atmosphereSystem, float heatScale)
    {
        ...
        // Only process for tile atmospheres (not canisters/pipes)
        ...
        // If this tile has reacted recently, don't trigger another reaction
        ...
        // Random chance to react based on concentration (2%-10%)
        ...
        // Gas consumption will be handled by the manager when the EMP actually triggers
