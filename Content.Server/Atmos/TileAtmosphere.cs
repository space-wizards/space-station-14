...
namespace Content.Server.Atmos
{
    public class TileAtmosphere : IGasMixtureHolder
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void HighPressureMovements(float frameTime)
        {
            ...
            foreach (var entity in _gridTileLookupSystem.GetEntitiesIntersecting(GridIndex, GridIndices))
            {
                ...
                {
                    pressureMovements.ExperiencePressureDifference(_gridAtmosphereComponent.UpdateCounter, PressureDifference, _pressureDirection, PressureSpecificTarget?.GridIndices.ToEntityCoordinates(GridIndex, _mapManager) ?? EntityCoordinates.Invalid, frameTime);
                }
