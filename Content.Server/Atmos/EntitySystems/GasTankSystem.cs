...
public sealed class GasTankSystem : SharedGasTankSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GasTankComponent, BoundUIOpenedEvent>(OnUIOpened);
        Subs.CVar(_cfg, CCVars.AtmosTankFragment, UpdateMaxRange, true);
    }

    private void OnUIOpened(Entity<GasTankComponent> ent, ref BoundUIOpenedEvent args)
    {
    ...
    {
        var pressure = ent.Comp.OutputPressure;
        var internalsConnected = ent.Comp.IsConnected;
