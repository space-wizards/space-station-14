...
namespace Content.Server.Nutrition.Components
{
    ...
    public sealed class ThirstComponent : SharedThirstComponent
    {
        ...
        private void UpdateCurrentThreshold()
        {
            ...
            {
                if (_currentThirstThreshold == ThirstThreshold.Dead)
                    EntitySystem.Get<AdminLogSystem>().Add(LogType.Damaged, $"{Owner} has stopped taking dehydration damage");
                else if (calculatedThirstThreshold == ThirstThreshold.Dead)
                    EntitySystem.Get<AdminLogSystem>().Add(LogType.Damaged, $"{Owner} has started taking dehydration damage");
