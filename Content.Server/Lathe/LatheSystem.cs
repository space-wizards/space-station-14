...
namespace Content.Server.Lathe
{
    ...
    public sealed class LatheSystem : SharedLatheSystem
    {
        ...
        public bool TryStartProducing(Entity<LatheComponent?> entity)
        {
            ...
            var recipeProto = entity.Comp.Queue.Dequeue();
            var recipe = Proto.Index(recipeProto);
        ...
        public void UpdateUserInterfaceState(Entity<LatheComponent?> entity)
        {
            ...
            if (producing == null && entity.Comp.Queue.TryPeek(out var next))
                producing = next;
        ...
        private void OnPowerChanged(Entity<LatheComponent> entity, ref PowerChangedEvent args)
        {
            ...
            else if (entity.Comp.CurrentRecipe != null)
            {
                EnsureComp<LatheProducingComponent>(entity);
