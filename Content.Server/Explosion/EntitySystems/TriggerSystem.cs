...
namespace Content.Server.Explosion.EntitySystems
{
    ...
    public sealed partial class TriggerSystem : EntitySystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<TriggerWhenEmptyComponent, EmptyEvent>(OnEmptyTriggered);
        ...
        private void OnEmptyTriggered(EntityUid uid, TriggerWhenEmptyComponent component, ref EmptyEvent args)
        {
