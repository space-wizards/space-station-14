...
public sealed partial class ExplosionSystem : EntitySystem
{
    ...
    private (int, List<float>, SpaceExplosionTileFlood?, Dictionary<GridId, GridExplosionTileFlood>, Matrix3)? GetExplosionTiles(
        ...
        float maxIntensity)
    {
        ...
        Dictionary<GridId, GridExplosionTileFlood> gridData = new();
        SpaceExplosionTileFlood? spaceData = null;
        ...
        if (epicentreGrid != null)
        {
            ...
            var initialGridData = new GridExplosionTileFlood(
        ...
        else
        {
            ...
            spaceData = new SpaceExplosionTileFlood(this, epicenter, referenceGrid, localGrids, maxDistance);
        ...
        while (remainingIntensity > 0 && iteration <= MaxIterations && totalTiles < MaxArea)
        {
            ...
            foreach (var grid in encounteredGrids)
            {
                ...
                if (!gridData.TryGetValue(grid, out var data))
                {
                    ...
                    data = new GridExplosionTileFlood(
