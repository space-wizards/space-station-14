...
public sealed class FragmentingGrenadeSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FragmentingGrenadeComponent, ComponentInit>(OnFragInit);
        SubscribeLocalEvent<FragmentingGrenadeComponent, ComponentStartup>(OnFragStartup);
        SubscribeLocalEvent<FragmentingGrenadeComponent, TriggerEvent>(OnFragTrigger);
    }

    private void OnFragInit(Entity<FragmentingGrenadeComponent> entity, ref ComponentInit args)
    {
    ...
    /// </summary>
    private void OnFragStartup(Entity<FragmentingGrenadeComponent> entity, ref ComponentStartup args)
    {
    ...
    /// </summary>
    private void OnFragTrigger(Entity<FragmentingGrenadeComponent> entity, ref TriggerEvent args)
    {
    ...
    /// </summary>
    private void FragmentIntoProjectiles(EntityUid uid, FragmentingGrenadeComponent component)
    {
    ...
    /// </summary>
    private bool TrySpawnContents(MapCoordinates spawnCoordinates, FragmentingGrenadeComponent component, out EntityUid contentUid)
    {
        contentUid = default;
