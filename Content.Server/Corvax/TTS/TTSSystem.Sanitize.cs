...
public sealed partial class TTSSystem
{
    ...
    private static readonly IReadOnlyDictionary<string, string> WordReplacement =
        new Dictionary<string, string>()
        {
            ...
            {"stations", "стэйшенс"},
            {"engineer", "эн женир"},
            {"engineers", "эн женьирс"},
            {"doctor", "дактор"},
            {"doctors", "дакторс"},
            {"scientist", "сайн тист"},
            {"scientists", "сайн тистс"},
            {"officer", "оффисэр"},
            {"cargo", "карго"},
            {"messenger", "мэссенджэр"},
            {"stupid", "стю пит"},
            {"finally", "файнали"},
            {"maybe", "мэйби"},
            {"suck", "сак"},
            ...
            {"hole", "хоул"},
            {"light", "лайт"},
            {"unitology", "юнитолоджи"},
            {"uni", "юни"},
            {"necro", "некро"},
            {"necromorph", "нэкроморф"},
            {"necromorphs", "нэкроморфс"},
            {"artifact", "артифакт"},
            {"artifacts", "артифактс"},
            {"quiet", "ку ает"},
            {"boring", "боринъ"},
            {"singularity", "сингюларити"},
            {"bullet", "булэт"},
            {"bullets", "булэтс"},
            {"round", "раунд"},
            {"ammo", "аъмо"},
            ...
            {"out", "аут"},
            {"damn", "дэйм"},
            {"nanotrasen", "нанотрэйзэн"},
            {"cqc", "Си Кью Си"},
            {"artery", "ар тэри"},
            {"division", "ди вижен"},
            {"redline", "рэдлайн"},
            {"cybernetics", "сайбернэтикс"}, // English-end
            {"mobilisaatio", "мобилисатио"}, // Finnish-start
            {"singulariteetti", "сингуларитээтти"},
            {"artefakti", "артэ факти"},
            {"terve", "тэрве"},
            {"hyvää päivää", "хюваа паиваа"},
            {"kapteeni", "кап тэни"},
            {"kapteenille", "кап тэнилле"},
            {"kapteenit", "кап тэнит"},
            {"ei", "ээи"},
            {"tyhmä", "тюхмма"},
            {"ääliö", "аалийо"},
            {"huoranpenikka", "хуоранпениккка"},
            {"paholainen", "пахолаээнен"},
            {"paholaiset", "пахо лаэ сет"},
            {"demonit", "дэмонит"}, // Finnish-end
            {"ja", "Я"}, // Deutsche-start
            {"mein", "Майн"},
            {"gott", "Готх"},
            {"nein", "Найнъ"},
