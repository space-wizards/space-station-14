...
public sealed class BatterySystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out var comp, out var batt))
        {
            ...
            SetCharge(uid, batt.Charge + comp.AutoRechargeRate * frameTime, batt);
        }
    }
    ...
    {
        args.Price += component.Charge * component.PricePerJoule;
    }
    ...
    {
        if (value <= 0 ||  !Resolve(uid, ref battery) || battery.Charge == 0)
            return 0;

        var newValue = Math.Clamp(0, battery.Charge - value, battery.MaxCharge);
        var delta = newValue - battery.Charge;
        battery.Charge = newValue;
        var ev = new ChargeChangedEvent(battery.Charge, battery.MaxCharge);
    ...
    public void SetMaxCharge(EntityUid uid, float value, BatteryComponent? battery = null)
    {
        ...
        battery.Charge = Math.Min(battery.Charge, battery.MaxCharge);
    ...
    public void SetCharge(EntityUid uid, float value, BatteryComponent? battery = null)
    {
        ...
        battery.Charge = MathHelper.Clamp(value, 0, battery.MaxCharge);
