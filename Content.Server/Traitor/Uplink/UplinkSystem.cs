...
public sealed class UplinkSystem : EntitySystem
{
    ...
    public readonly EntProtoId TraitorUplinkStore = "StorePresetRemoteUplink";
    public readonly ProtoId<CurrencyPrototype> TelecrystalCurrencyPrototype = "Telecrystal";
