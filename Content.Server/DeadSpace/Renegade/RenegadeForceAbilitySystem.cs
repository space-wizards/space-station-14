...
public sealed class RenegadeForceAbilitySystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<RenegadeForceAbilityComponent, RenegadeForceEvent>(OnRenegadeForce);
        SubscribeLocalEvent<RenegadeForceAbilityComponent, RenegadeForceOneEvent>(OnRenegadeForceOne);
        SubscribeLocalEvent<RenegadeForceAbilityComponent, ComponentInit>(OnComponentInit);
        SubscribeLocalEvent<RenegadeForceAbilityComponent, ComponentShutdown>(OnComponentShutdown);
        SubscribeLocalEvent<RenegadeForceAbilityComponent, GetVerbsEvent<Verb>>(OnSetVerbs);
        SubscribeLocalEvent<RenegadeForceAbilityComponent, ChangeForcePowerAlertEvent>(OnChangeForcePowerAlert);
    }
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<RenegadeForceAbilityComponent, TransformComponent>();
    ...
    private void OnChangeForcePowerAlert(Entity<RenegadeForceAbilityComponent> ent, ref ChangeForcePowerAlertEvent args)
    {
    ...
    private void OnSetVerbs(EntityUid uid, RenegadeForceAbilityComponent component, GetVerbsEvent<Verb> args)
    {
        if (uid != args.User)
            return;
    ...
    private void OnComponentInit(EntityUid uid, RenegadeForceAbilityComponent component, ComponentInit args)
    {
        _actionsSystem.AddAction(uid, ref component.ActionRenegadeForceEntity, component.ActionRenegadeForce, uid);
        _actionsSystem.AddAction(uid, ref component.ActionRenegadeForceOneEntity, component.ActionRenegadeForceOnce, uid);
    ...
    private void OnComponentShutdown(EntityUid uid, RenegadeForceAbilityComponent component, ComponentShutdown args)
    {
        _actionsSystem.RemoveAction(uid, component.ActionRenegadeForceEntity);
        _actionsSystem.RemoveAction(uid, component.ActionRenegadeForceOneEntity);
    }
    private void OnRenegadeForceOne(EntityUid uid, RenegadeForceAbilityComponent component, RenegadeForceOneEvent args)
    {
        if (args.Handled)
            return;
    ...
    private void OnRenegadeForce(EntityUid uid, RenegadeForceAbilityComponent component, RenegadeForceEvent args)
    {
        if (!_gameTiming.IsFirstTimePredicted)
            return;
    ...
    private void Force(EntityUid uid, RenegadeForceAbilityComponent component, TransformComponent? xform = null)
    {
    ...
    public void SetForce(EntityUid uid, RenegadeForceAbilityComponent? component = null)
    {
    ...
    public void UpdateForceAlert(EntityUid uid, RenegadeForceAbilityComponent? component = null)
    {
        if (!Resolve(uid, ref component))
            return;
