...
public sealed class OwoifyCommand : IConsoleCommand
{
    ...
    public void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        metaDataSys.SetEntityName(eUid.Value, owoSys.Accentuate(null, meta.EntityName), meta);
        metaDataSys.SetEntityDescription(eUid.Value, owoSys.Accentuate(null, meta.EntityDescription), meta);
    }
}
