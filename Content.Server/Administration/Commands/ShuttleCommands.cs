...
namespace Content.Server.Administration.Commands
{
    ...
    public sealed class CallShuttleCommand : IConsoleCommand
    {
        ...
        public void Execute(IConsoleShell shell, string argStr, string[] args)
        {
            ...
            {
                _esMan.GetEntitySystem<RoundEndSystem>().RequestRoundEnd(timeSpan, shell.Player?.AttachedEntity, false);
            }
            ...
            {
                _esMan.GetEntitySystem<RoundEndSystem>().RequestRoundEnd(shell.Player?.AttachedEntity, false);
            }
        }
    }
    ...
    public sealed class RecallShuttleCommand : IConsoleCommand
    {
        ...
        public void Execute(IConsoleShell shell, string argStr, string[] args)
        {
            _esMan.GetEntitySystem<RoundEndSystem>().CancelRoundEndCountdown(shell.Player?.AttachedEntity, false);
        }
    }
}
