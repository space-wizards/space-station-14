...
{
    public abstract class OtherTraitorAliveCondition : IObjectiveCondition
    {
        ...
        {
            return other is OtherTraitorAliveCondition kpc && Equals(Target, kpc.Target);
        }
        ...
        public override bool Equals(object? obj)
        {
            ...
            return Equals((OtherTraitorAliveCondition) obj);
        }
