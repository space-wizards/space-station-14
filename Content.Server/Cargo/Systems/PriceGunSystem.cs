...
public sealed class PriceGunSystem : EntitySystem
{
    ...
    private void OnAfterInteract(EntityUid uid, PriceGunComponent component, AfterInteractEvent args)
    {
        ...
        _popupSystem.PopupEntity(Loc.GetString("price-gun-pricing-result", ("object", Identity.Name(args.Target.Value, EntityManager)), ("price", $"{price:F2}")), args.User, Filter.Entities(args.User));
