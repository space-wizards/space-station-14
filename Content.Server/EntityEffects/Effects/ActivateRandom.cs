...
namespace Content.Server.Chemistry.ReagentEffects
{
    ...
    /// </summary>
    [UsedImplicitly]
    public sealed partial class ActivateRandom : ReagentEffect {
        /// <summary>
        ...
        public override void Effect(ReagentEffectArgs args)
        {
            ...
            // Setting reagent to null can be problematic, but it's not obvious which reagent to pass
            // when multiple reagents are consumed.
            ReagentEffectArgs newArgs = new ReagentEffectArgs(args.SolutionEntity, args.OrganEntity, args.Source, null, consumed, args.EntityManager, args.Method, args.Scale);
            foreach (var effect in Cases[index].Effects) {
                ...
                if (effect.ShouldLog)
                {
                    ...
                    _adminLogger.Add(
                        ...
                        + $" applied on entity {args.SolutionEntity:entity}"
                        + $" at {args.EntityManager.GetComponent<TransformComponent>(args.SolutionEntity).Coordinates:coordinates}"
                    );
                }
