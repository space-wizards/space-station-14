...
/// <summary>
/// A component for signalable timers.
/// Uses a UI to set a label and timer value, and can be started with a signal.
...
{
    /// <summary>
    /// The current timer delay, used to populate the UI.
    /// </summary>
    [DataField]
    ...
    /// <summary>
    /// A port that can be signaled to start the timer.
    /// </summary>
    [DataField]
