...
public sealed partial class GatewayComponent : Component
{
    ...
    public SoundSpecifier OpenSound = new SoundCollectionSpecifier("PortalOpenSound");

    /// <summary>
    /// Sound to play when closing the portal.
    /// </summary>
    [DataField]
    public SoundSpecifier CloseSound = new SoundCollectionSpecifier("PortalCloseSound");
