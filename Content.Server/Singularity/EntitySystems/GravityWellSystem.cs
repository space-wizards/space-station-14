...
#region Dependencies
    ...
    public void GravPulse(EntityUid uid, out Vector2 appliedImpulse, float maxRange, float minRange, in Matrix3 baseMatrixDeltaV, TransformComponent? xform = null, float? staticImpulse = null)
    {
    ...
    /// <param name="minRange">The minimum distance at which entities can be affected by the gravity pulse.</param>
    /// <param name="baseMatrixDeltaV">The base velocity added to any entities within affected by the gravity pulse scaled by the displacement of those entities from the epicenter.</param>
    public void GravPulse(EntityUid uid, out Vector2 appliedImpulse, EntityCoordinates entityPos, float maxRange, float minRange, in Matrix3 baseMatrixDeltaV, float? staticImpulse = null)
        => GravPulse(uid, out appliedImpulse, entityPos.ToMap(EntityManager), maxRange, minRange, in baseMatrixDeltaV, staticImpulse);
    ...
    public void GravPulse(EntityUid uid, out Vector2 appliedImpulse, EntityCoordinates entityPos, float maxRange, float minRange, float baseRadialDeltaV = 0.0f, float baseTangentialDeltaV = 0.0f, float? staticImpulse = null)
        => GravPulse(uid, out appliedImpulse, entityPos.ToMap(EntityManager), maxRange, minRange, baseRadialDeltaV, baseTangentialDeltaV, staticImpulse);
    ...
    /// <param name="baseMatrixDeltaV">The base velocity added to any entities within affected by the gravity pulse scaled by the displacement of those entities from the epicenter.</param>
    public void GravPulse(EntityUid uid, out Vector2 appliedImpulse, MapCoordinates mapPos, float maxRange, float minRange, in Matrix3 baseMatrixDeltaV, float? staticImpulse = null)
    {
        appliedImpulse = new Vector2(0f, 0f);
    ...
    public void GravPulse(EntityUid uid, out Vector2 appliedImpulse, MapCoordinates mapPos, float maxRange, float minRange = 0.0f, float baseRadialDeltaV = 0.0f, float baseTangentialDeltaV = 0.0f, float? staticImpulse = null)
        => GravPulse(uid, out appliedImpulse, mapPos, maxRange, minRange, new Matrix3(
