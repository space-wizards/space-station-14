...
#region Dependencies
    ...
    public void GravPulse(EntityUid uid, GravityWellComponent gravWell, float maxRange, float minRange, in Matrix3 baseMatrixDeltaV, TransformComponent? xform = null)
    {
        if (Resolve(uid, ref xform))
            GravPulse(uid, gravWell, xform.Coordinates, maxRange, minRange, in baseMatrixDeltaV);
    }
    ...
    /// <param name="xform">(optional) The transform of the entity at the epicenter of the gravitational pulse.</param>
    public void GravPulse(EntityUid uid, GravityWellComponent gravWell, float maxRange, float minRange, float baseRadialDeltaV = 0.0f, float baseTangentialDeltaV = 0.0f, TransformComponent? xform = null)
    {
        if (Resolve(uid, ref xform))
            GravPulse(uid, gravWell, xform.Coordinates, maxRange, minRange, baseRadialDeltaV, baseTangentialDeltaV);
    }
    ...
    /// <param name="minRange">The minimum distance at which entities can be affected by the gravity pulse.</param>
    /// <param name="baseMatrixDeltaV">The base velocity added to any entities within affected by the gravity pulse scaled by the displacement of those entities from the epicenter.</param>
    public void GravPulse(EntityUid uid, GravityWellComponent gravWell, EntityCoordinates entityPos, float maxRange, float minRange, in Matrix3 baseMatrixDeltaV)
        => GravPulse(uid, gravWell, entityPos.ToMap(EntityManager), maxRange, minRange, in baseMatrixDeltaV);
    ...
    /// <param name="baseRadialDeltaV">The base radial velocity that will be added to entities within range towards the center of the gravitational pulse.</param>
    /// <param name="baseTangentialDeltaV">The base tangential velocity that will be added to entities within countrclockwise around the center of the gravitational pulse.</param>
    public void GravPulse(EntityUid uid, GravityWellComponent gravWell, EntityCoordinates entityPos, float maxRange, float minRange, float baseRadialDeltaV = 0.0f, float baseTangentialDeltaV = 0.0f)
        => GravPulse(uid, gravWell, entityPos.ToMap(EntityManager), maxRange, minRange, baseRadialDeltaV, baseTangentialDeltaV);
    ...
    /// <param name="baseMatrixDeltaV">The base velocity added to any entities within affected by the gravity pulse scaled by the displacement of those entities from the epicenter.</param>
    public void GravPulse(EntityUid uid, GravityWellComponent gravWell, MapCoordinates mapPos, float maxRange, float minRange, in Matrix3 baseMatrixDeltaV, PhysicsComponent? thisPhysics = null)
    {
        ...
        if (applyCounterforce && TryComp<PhysicsComponent>(uid, out var ownPhysics))
            _physics.ApplyLinearImpulse(uid, counterforce, body: ownPhysics);
    }
    ...
    public void GravPulse(EntityUid uid, GravityWellComponent gravWell, MapCoordinates mapPos, float maxRange, float minRange = 0.0f, float baseRadialDeltaV = 0.0f, float baseTangentialDeltaV = 0.0f)
        => GravPulse(uid, gravWell, mapPos, maxRange, minRange, new Matrix3(
