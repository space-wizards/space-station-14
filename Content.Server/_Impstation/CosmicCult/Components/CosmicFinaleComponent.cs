...
public sealed partial class CosmicFinaleComponent : Component
{
    ...
    [DataField, AutoNetworkedField] public TimeSpan FinaleRemainingTime = TimeSpan.FromSeconds(150); //TODO: Change this timer when new composed music files are sent
