...
[RegisterComponent]
internal sealed partial class DualEnergySwordComponent : Component
{
    ...
    [DataField("isSharp")] public bool IsSharp = true;
    ...
    /// </summary>
    [DataField("cycleRate")] public float CycleRate = 1f;
    ...
    [DataField("colorOptions")] public List<Color> ColorOptions = new()
    {
        Color.Tomato,
        Color.DodgerBlue,
        Color.Aqua,
    ...
    [DataField("litDamageBonus")] public DamageSpecifier LitDamageBonus = new();

    [DataField("litDisarmMalus")] public float LitDisarmMalus = 0.6f;
}

[ByRefEvent]
public readonly record struct DualEnergySwordActivatedEvent();

[ByRefEvent]
public readonly record struct DualEnergySwordDeactivatedEvent();
