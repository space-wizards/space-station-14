    ...
    public abstract class StationEvent
    {
        ...
        public virtual void Announce()
        {
            ...
            if (AnnounceEvent && StartAnnouncement != null)
            {
                ...
                chatSystem.DispatchGlobalAnnouncement(StartAnnouncement, playSound: false, colorOverride: Color.Gold);
            }
        ...
        public virtual void Shutdown()
        {
            ...
            {
                var chatSystem = IoCManager.Resolve<IEntitySystemManager>().GetEntitySystem<ChatSystem>();
                chatSystem.DispatchGlobalAnnouncement(EndAnnouncement, playSound: false, colorOverride: Color.Gold);
            }
