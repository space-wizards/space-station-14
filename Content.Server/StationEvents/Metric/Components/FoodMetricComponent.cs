...
public sealed class FoodMetricComponent : Component
{
    [DataField("thirstScore"), ViewVariables(VVAccess.ReadWrite)]
    public readonly FixedPoint2 ThirstScore = 2.0f;

    [DataField("parchedScore"), ViewVariables(VVAccess.ReadWrite)]
    public readonly FixedPoint2 ParchedScore = 5.0f;

    [DataField("peckishScore"), ViewVariables(VVAccess.ReadWrite)]
    public readonly FixedPoint2 PeckishScore = 2.0f;

    [DataField("starvingScore"), ViewVariables(VVAccess.ReadWrite)]
    public readonly FixedPoint2 StarvingScore = 5.0f;
}
