...
public sealed class CrewManifestSystem : EntitySystem
{
    ...
    private void BuildCrewManifest(EntityUid station)
    {
        ...
        foreach (var recordObject in iter)
        {
            ...
            var entry = new CrewManifestEntry(RandomAccentuator.MaybeAccentuate(record.Name, reaccentuationChance: 0.05f), RandomAccentuator.MaybeAccentuate(record.JobTitle, reaccentuationChance: 0.2f), record.JobIcon, record.JobPrototype);
