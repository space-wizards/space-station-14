...
public sealed class NukeSystem : EntitySystem
{
    ...
    {
        _audio.PlayPvs(component.KeypadPressSound, uid, AudioFun.FunAudioParams());
        ...
        switch (component.Status)
        {
            ...
            case NukeStatus.AWAIT_CODE:
                ...
                if (component.EnteredCode == component.Code)
                {
                    ...
                    component.RemainingTime = component.Timer;
                    _audio.PlayPvs(component.AccessGrantedSound, uid, AudioFun.FunAudioParams());
                }
                else
                {
                    component.EnteredCode = "";
                    _audio.PlayPvs(component.AccessDeniedSound, uid, AudioFun.FunAudioParams());
                }
    ...
    private void PlayNukeKeypadSound(EntityUid uid, int number, NukeComponent? component = null)
    {
        ...
        _audio.PlayPvs(component.KeypadPressSound, uid, AudioFun.FunAudioParams(opts));
    }
