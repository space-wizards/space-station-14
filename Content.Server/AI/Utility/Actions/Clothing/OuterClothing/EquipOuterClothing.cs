...
using Content.Server.AI.Utility.Considerations.Clothing.OuterClothing;
...
namespace Content.Server.AI.Utility.Actions.Clothing.OuterClothing
{
    public sealed class EquipOuterClothing : UtilityAction
    {
        ...
        public EquipOuterClothing(IEntity owner, IEntity entity, BonusWeight weight) : base(owner)
        {
            _entity = entity;
            Bonus = weight;
        }
