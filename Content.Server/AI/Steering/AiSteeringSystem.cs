    ...
    public sealed class AiSteeringSystem : EntitySystem
    {
        ...
        private SteeringStatus Steer(EntityUid entity, IAiSteeringRequest steeringRequest, float frameTime)
        {
            ...
            if (Deleted(entity) ||
                ...
                !controller.CanMove ||
                !EntityManager.GetComponent<TransformComponent>(entity).GridUid.IsValid())
            {
            ...
            if (_mapManager.IsGridPaused(EntityManager.GetComponent<TransformComponent>(entity).GridUid))
            {
                controller.VelocityDir = Vector2.Zero;
            ...
            if (EntityManager.GetComponent<TransformComponent>(entity).GridUid != steeringRequest.TargetGrid.GetGridUid(EntityManager))
            {
                controller.VelocityDir = Vector2.Zero;
                return SteeringStatus.NoPath;
            }
        ...
        private void RequestPath(EntityUid entity, IAiSteeringRequest steeringRequest)
        {
            ...
            var gridManager = _mapManager.GetGrid(EntityManager.GetComponent<TransformComponent>(entity).GridUid);
        ...
        private void UpdatePath(EntityUid entity, Queue<TileRef> path)
        {
            ...
            var entityTile = _mapManager.GetGrid(EntityManager.GetComponent<TransformComponent>(entity).GridUid).GetTileRef(EntityManager.GetComponent<TransformComponent>(entity).Coordinates);
        ...
        private void UpdateGridCache(EntityUid entity, bool dequeue = true)
        {
            ...
            var nextGrid = _mapManager.GetGrid(EntityManager.GetComponent<TransformComponent>(entity).GridUid).GridTileToLocal(nextTile.GridIndices);
        ...
        private Vector2 CollisionAvoidance(EntityUid entity, Vector2 direction, ICollection<EntityUid> ignoredTargets)
        {
            ...
            var grid = _mapManager.GetGrid(EntityManager.GetComponent<TransformComponent>(entity).GridUid);
