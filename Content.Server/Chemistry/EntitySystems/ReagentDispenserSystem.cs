...
namespace Content.Server.Chemistry.EntitySystems
{
    ...
    public class ReagentDispenserSystem : EntitySystem
    {
        ...
        {
            SubscribeLocalEvent<ReagentDispenserComponent, AssembleVerbsEvent>(AddBeakerVerbs);
        }
        ...
        private void AddBeakerVerbs(EntityUid uid, ReagentDispenserComponent component, AssembleVerbsEvent args)
        {
