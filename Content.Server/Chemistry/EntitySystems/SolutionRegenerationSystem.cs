...
public sealed class SolutionRegenerationSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<SolutionRegenerationComponent, SolutionContainerComponent>();
        while (query.MoveNext(out var uid, out var regen, out var manager))
        {
            ...
            if (_solutionContainer.TryGetSolution((uid, manager), regen.Solution, out var soln, out var solution))
            {
                ...
                _solution.TryAddSolution(soln, generated);
            }
        }
    }
