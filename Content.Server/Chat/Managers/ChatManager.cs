...
namespace Content.Server.Chat.Managers
{
    ...
    internal sealed class ChatManager : IChatManager
    {
        ...
        public void DispatchServerMessage(IPlayerSession player, string message)
        {
            ...
            _adminLogs.Add(LogType.Chat, LogImpact.Low, $"Server message to {player:Player}: {message}");
        }
        ...
        private void SendAdminChat(IPlayerSession player, string message)
        {
            if (!_adminManager.IsAdmin(player))
            {
                _adminLogs.Add(LogType.Chat, LogImpact.Extreme, $"{player:Player} attempted to send admin message but was not admin");
                return;
            }
