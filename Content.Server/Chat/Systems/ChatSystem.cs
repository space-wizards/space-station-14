...
public sealed partial class ChatSystem : SharedChatSystem
{
        ...
        )
    {
        ...
        if (playSound)
        {
            _audio.PlayGlobal(announcementSound == null ? DefaultAnnouncementSound : _audio.ResolveSound(announcementSound), Filter.Broadcast(), true, AudioParams.Default.AddVolume(-2f));
        }
        ...
        Color? colorOverride = null)
    {
        ...
        if (playSound)
        {
            _audio.PlayGlobal(announcementSound?.ToString() ?? DefaultAnnouncementSound, filter, true, AudioParams.Default.AddVolume(-2f));
        }
