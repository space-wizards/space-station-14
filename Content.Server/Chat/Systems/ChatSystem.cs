...
public sealed partial class ChatSystem : SharedChatSystem
{
        ...
        )
    {
        ...
        if (playSound)
        {
            _audio.PlayGlobal(announcementSound == null ? DefaultAnnouncementSound : _audio.ResolveSound(announcementSound), Filter.Broadcast(), true, FunAudioParams.WithUniformPitch(AudioParams.Default.WithVolume(-2f)));
        }
        ...
        Color? colorOverride = null)
    {
        ...
        if (playSound)
        {
            _audio.PlayGlobal(announcementSound?.ToString() ?? DefaultAnnouncementSound, filter, true, FunAudioParams.WithUniformPitch(AudioParams.Default.WithVolume(-2f)));
        }
