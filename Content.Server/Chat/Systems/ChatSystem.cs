...
public sealed partial class ChatSystem : SharedChatSystem
{
        ...
        )
    {
        ...
        if (playSound)
        {
            _audio.PlayGlobal(announcementSound == null ? DefaultAnnouncementSound : _audio.GetSound(announcementSound), Filter.Broadcast(), true, AudioFun.FunAudioParams(AudioParams.Default.WithVolume(-2f)));
        }
        ...
        Color? colorOverride = null)
    {
        ...
        if (playSound)
        {
            _audio.PlayGlobal(announcementSound?.ToString() ?? DefaultAnnouncementSound, filter, true, AudioFun.FunAudioParams(AudioParams.Default.WithVolume(-2f)));
        }
